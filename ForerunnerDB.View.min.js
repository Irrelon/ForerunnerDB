...
this._onUpdate(m,[]);k.length&&this._onRemove(k,[]);this.emit("change",{data:e})}else k=c.find(),k.length&&this._onRemove(k),h=d.find(),h.length&&this._onInsert(h);return this};b.prototype.count=function(){return this._data&&this._data._data?this._data._data.length:0};b.prototype.find=function(){return this._data?this._data.find.apply(this._data,arguments):[]};b.prototype.insert=function(){return this._from?this._from.insert.apply(this._from,arguments):[]};b.prototype.update=function(){return this._from?
this._from.update.apply(this._from,arguments):[]};b.prototype.remove=function(){return this._from?this._from.remove.apply(this._from,arguments):[]};b.prototype._onInsert=function(a,b){this.emit("insert",a,b)};b.prototype._onUpdate=function(a,b){this.emit("update",a,b)};b.prototype._onRemove=function(a,b){this.emit("remove",a,b)};ForerunnerDB.prototype.view=function(a){this._views[a]||this._debug&&console.log("Creating view "+a);this._views[a]=this._views[a]||(new b(a)).db(this);return this._views[a]};
ForerunnerDB.prototype.viewExists=function(a){return Boolean(this._views[a])};ForerunnerDB.prototype.views=function(){var a=[],b;for(b in this._views)this._views.hasOwnProperty(b)&&a.push({name:b,count:this._views[b].count()});return a};ForerunnerDB.classes.View=b})();
