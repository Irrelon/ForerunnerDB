...
function(a,c){for(var b=0;b<this._collectionArr.length;b++)this._collectionArr[b].insert(a,c)};b.prototype.update=function(a,c){for(var b=0;b<this._collectionArr.length;b++)this._collectionArr[b].update(a,c)};b.prototype.updateById=function(a,c){for(var b=0;b<this._collectionArr.length;b++)this._collectionArr[b].updateById(a,c)};b.prototype.remove=function(a){for(var c=0;c<this._collectionArr.length;c++)this._collectionArr[c].remove(a)};b.prototype.removeById=function(a){for(var c=0;c<this._collectionArr.length;c++)this._collectionArr[c].removeById(a)};
b.prototype._addView=function(a){void 0!==a&&(this._views[a._name]=a);return this};b.prototype._removeView=function(a){void 0!==a&&delete this._views[a._name];return this};b.prototype._onInsert=function(a,c){this.emit("insert",a,c)};b.prototype._onUpdate=function(a,c){this.emit("update",a,c)};b.prototype._onRemove=function(a,c){this.emit("remove",a,c)};b.prototype.subset=function(a,c){var b=this.find(a,c);return(new g)._subsetOf(this).primaryKey(this._primaryKey).setData(b)};b.prototype.drop=function(){var a,
b=[].concat(this._collectionArr),e=[].concat(this._views);this._debug&&console.log("Dropping collection group "+this._name);for(a=0;a<b.length;a++)this.removeCollection(b[a]);for(a=0;a<e.length;a++)this._removeView(e[a]);this.emit("drop");return!0};h.prototype.init=function(){this._collectionGroup={};k.apply(this,arguments)};h.prototype.collectionGroup=function(a){return a?(this._collectionGroup[a]=this._collectionGroup[a]||(new b(a)).db(this),this._collectionGroup[a]):this._collectionGroup};ForerunnerDB.classes.CollectionGroup=
b})();
