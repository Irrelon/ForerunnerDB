	...
	var init = (function (ForerunnerDB) {
		...
		OldView.prototype.init = function (viewName) {
			...
			this._onFromChange = function () {
				if (this._debug || (this._db && this._db._debug)) { console.log('ForerunnerDB.OldView: Received change'); }
		...
		OldView.prototype.refresh = function (force) {
			if (this._from) {
				...
				if (this._debug || (this._db && this._db._debug)) { console.log('ForerunnerDB.OldView: Emitting change'); }
				this.emit('change');
			}
		...
		OldView.prototype._onChange = function () {
			if (this._debug || (this._db && this._db._debug)) { console.log('ForerunnerDB.OldView: Refreshing data'); }
			this.refresh();
		};
