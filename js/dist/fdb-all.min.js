...
0;h<a[l].length;h++)q[n]===a[l][h]&&(this._updatePull(g[l],n),n--,e=!0);if(0>n)break}}else throw"Cannot pullAll without being given an array of values to pull! ("+l+")";break;case "$addToSet":void 0===g[l]&&(g[l]=[]);if(g[l]instanceof Array){p=g[l];var m;q=p.length;var E;n=!0;m=f&&f.$addToSet;var ba;m&&m.key?(h=!1,ba=new b(m.key),E=ba.value(a[l])[0]):(E=JSON.stringify(a[l]),h=!0);for(m=0;m<q;m++)if(h){if(JSON.stringify(p[m])===E){n=!1;break}}else if(E===ba.value(p[m])[0]){n=!1;break}n&&(this._updatePush(g[l],
a[l]),e=!0)}else throw"Cannot addToSet on a key that is not an array! (undefined)!";break;case "$splicePush":void 0===g[l]&&(g[l]=[]);if(g[l]instanceof Array)if(h=a.$index,void 0!==h)delete a.$index,this._updateSplicePush(g[l],h,a[l]),e=!0;else throw"Cannot splicePush without a $index integer value!";else throw"Cannot splicePush with a key that is not an array! ("+l+")";break;case "$move":if(g[l]instanceof Array)for(p=0;p<g[l].length;p++){if(this._match(g[l][p],a[l])){e=a[l].$index;if(void 0!==e)this._updateSpliceMove(g[l],
p,e),e=!0;else throw"Cannot move without a $index integer value!";break}}else throw"Cannot move on a key that is not an array! ("+l+")";break;case "$mul":this._updateMultiply(g,l,a[l]);e=!0;break;case "$rename":this._updateRename(g,l,a[l]);e=!0;break;case "$unset":this._updateUnset(g,l);e=!0;break;case "$pop":if(g[l]instanceof Array)this._updatePop(g[l],a[l])&&(e=!0);else throw"Cannot pop from a key that is not an array! ("+l+")";break;default:g[l]!==a[l]&&(this._updateProperty(g,l,a[l]),e=!0)}else if(null!==
g[l]&&"object"===typeof g[l])if(p=g[l]instanceof Array,q=a[l]instanceof Array,p||q)if(!q&&p)for(p=0;p<g[l].length;p++)(h=this._updateObject(g[l][p],a[l],d,f,c+"."+l,k))&&(e=!0);else g[l]!==a[l]&&(this._updateProperty(g,l,a[l]),e=!0);else(h=this._updateObject(g[l],a[l],d,f,c+"."+l,k))&&(e=!0);else g[l]!==a[l]&&(this._updateProperty(g,l,a[l]),e=!0)}return e};d.prototype._isPositionalKey=function(g){return".$"===g.substr(g.length-2,2)};d.prototype._updateProperty=function(g,b,a){this._linked?(jQuery.observable(g).setProperty(b,
a),this.debug()&&console.log('ForerunnerDB.Collection: Setting data-bound document property "'+b+'" for collection "'+this.name()+'"')):(g[b]=a,this.debug()&&console.log('ForerunnerDB.Collection: Setting non-data-bound document property "'+b+'" for collection "'+this.name()+'"'))};d.prototype._updateIncrement=function(g,b,a){this._linked?jQuery.observable(g).setProperty(b,g[b]+a):g[b]+=a};d.prototype._updateSpliceMove=function(g,b,a){this._linked?(jQuery.observable(g).move(b,a),this.debug()&&console.log('ForerunnerDB.Collection: Moving data-bound document array index from "'+
b+'" to "'+a+'" for collection "'+this.name()+'"')):(g.splice(a,0,g.splice(b,1)[0]),this.debug()&&console.log('ForerunnerDB.Collection: Moving non-data-bound document array index from "'+b+'" to "'+a+'" for collection "'+this.name()+'"'))};d.prototype._updateSplicePush=function(g,b,a){g.length>b?this._linked?jQuery.observable(g).insert(b,a):g.splice(b,0,a):this._linked?jQuery.observable(g).insert(a):g.push(a)};d.prototype._updatePush=function(g,b){this._linked?jQuery.observable(g).insert(b):g.push(b)};
d.prototype._updatePull=function(g,b){this._linked?jQuery.observable(g).remove(b):g.splice(b,1)};d.prototype._updateMultiply=function(g,b,a){this._linked?jQuery.observable(g).setProperty(b,g[b]*a):g[b]*=a};d.prototype._updateRename=function(g,b,a){var d=g[b];this._linked?(jQuery.observable(g).setProperty(a,d),jQuery.observable(g).removeProperty(b)):(g[a]=d,delete g[b])};d.prototype._updateUnset=function(g,b){this._linked?jQuery.observable(g).removeProperty(b):delete g[b]};d.prototype._updatePop=function(g,
b){var a,d=!1;0<g.length&&(this._linked?(1===b?a=g.length-1:-1===b&&(a=0),-1<a&&(jQuery.observable(arr).remove(a),d=!0)):1===b?(g.pop(),d=!0):-1===b&&(g.shift(),d=!0));return d};d.prototype.remove=function(g,b,a){var d,f;if(g instanceof Array){f=[];for(a=0;a<g.length;a++)f.push(this.remove(g[a],{noEmit:!0}));(!b||b&&!b.noEmit)&&this._onRemove(f);return f}a=this.find(g,{$decouple:!1});if(a.length){for(f=0;f<a.length;f++)d=a[f],this._removeIndex(d),d=this._data.indexOf(d),this._linked?jQuery.observable(this._data).remove(d):
this._data.splice(d,1);this.chainSend("remove",{query:g},b);(!b||b&&!b.noEmit)&&this._onRemove(a);this.deferEmit("change",{type:"remove",data:a})}return a};d.prototype.removeById=function(g){var b={};b[this._primaryKey]=g;return this.remove(b)};d.prototype.deferEmit=function(){var g=this,b;this._noEmitDefer||this._db&&(!this._db||this._db._noEmitDefer)?this.emit.apply(this,arguments):(b=arguments,this._changeTimeout&&clearTimeout(this._changeTimeout),this._changeTimeout=setTimeout(function(){g.debug()&&
console.log("ForerunnerDB.Collection: Emitting "+b[0]);g.emit.apply(g,b)},100))};d.prototype.processQueue=function(g,b){var a=this._deferQueue[g],d=this._deferThreshold[g],f=this._deferTime[g];if(a.length){var c=this;a.length&&(a=a.length>d?a.splice(0,d):a.splice(0,a.length),this[g](a));setTimeout(function(){c.processQueue(g,b)},f)}else b&&b()};d.prototype.insert=function(g,b,a){"function"===typeof b?(a=b,b=this._data.length):void 0===b&&(b=this._data.length);g=this.transformIn(g);return this._insertHandle(g,
b,a)};d.prototype._insertHandle=function(g,b,a){var d=this._deferQueue.insert,f=this._deferThreshold.insert,c=[],k=[];if(g instanceof Array){if(g.length>f){this._deferQueue.insert=d.concat(g);this.processQueue("insert",a);return}for(f=0;f<g.length;f++)d=this._insert(g[f],b+f),!0===d?c.push(g[f]):k.push({doc:g[f],reason:d})}else d=this._insert(g,b),!0===d?c.push(g):k.push({doc:g,reason:d});this.chainSend("insert",g,{index:b});this._onInsert(c,k);a&&a();this.deferEmit("change",{type:"insert",data:c});
return{inserted:c,failed:k}};d.prototype._insert=function(g,b){if(g){var a;this._ensurePrimaryKey(g);if(a=this.insertIndexViolation(g))return"Index violation in index: "+a;this._insertIndex(g);b>this._data.length&&(b=this._data.length);this._linked?jQuery.observable(this._data).insert(b,g):this._data.splice(b,0,g);return!0}return"No document passed to insert"};d.prototype._insertIndex=function(g){var b=this._indexByName,a,d=JSON.stringify(g);this._primaryIndex.uniqueSet(g[this._primaryKey],g);this._primaryCrc.uniqueSet(g[this._primaryKey],
d);this._crcLookup.uniqueSet(d,g);for(a in b)b.hasOwnProperty(a)&&b[a].insert(g)};d.prototype._removeIndex=function(g){var b=this._indexByName,a,d=JSON.stringify(g);this._primaryIndex.unSet(g[this._primaryKey]);this._primaryCrc.unSet(g[this._primaryKey]);this._crcLookup.unSet(d);for(a in b)b.hasOwnProperty(a)&&b[a].remove(g)};d.prototype.subset=function(g,b){var a=this.find(g,b);return(new d)._subsetOf(this).primaryKey(this._primaryKey).setData(a)};d.prototype.subsetOf=function(){return this.__subsetOf};
d.prototype._subsetOf=function(g){this.__subsetOf=g;return this};d.prototype.distinct=function(g,a,d){a=this.find(a,d);g=new b(g);d={};var f=[],c,k;for(k=0;k<a.length;k++)(c=g.value(a[k])[0])&&!d[c]&&(d[c]=!0,f.push(c));return f};d.prototype.decouple=e.common.decouple;d.prototype.findById=function(g,b){var a={};a[this._primaryKey]=g;return this.find(a,b)[0]};d.prototype.peek=function(g,b){var a=this._data,f=a.length,c,k,e=new d;if("string"===typeof g){for(c=0;c<f;c++)k=JSON.stringify(a[c]),-1<k.indexOf(g)&&
e.insert(a[c]);return e.find({},b)}return this.find(g,b)};d.prototype.explain=function(b,a){return this.find(b,a).__fdbOp._data};d.prototype.find=function(g,a){g=g||{};a=a||{};a.$decouple=void 0!==a.$decouple?a.$decouple:!0;var d=this._metrics.create("find"),f=this,c,k=!0,e,h,n,q,p,l,m,E,ba,ma=[];h=function(a){return f._match(a,g,"and")};d.start();if(g){d.time("analyseQuery");c=this._analyseQuery(g,a,d);d.time("analyseQuery");d.data("analysis",c);if(c.hasJoin&&c.queriesJoin){d.time("joinReferences");
for(n=0;n<c.joinsOn.length;n++)p=c.joinsOn[n],q=new b(c.joinQueries[p]),q=q.value(g)[0],this._db.collection(c.joinsOn[n]).subset(q);d.time("joinReferences")}c.indexMatch.length&&(!a||a&&!a.$skipIndex)?(d.data("index.potential",c.indexMatch),d.data("index.used",c.indexMatch[0].index),d.time("indexLookup"),e=c.indexMatch[0].lookup,d.time("indexLookup"),c.indexMatch[0].keyData.totalKeyCount===c.indexMatch[0].keyData.matchedKeyCount&&(k=!1)):d.flag("usedIndex",!1);k&&(e&&e.length?(c=e.length,d.time("tableScan: "+
c),e=e.filter(h)):(c=this._data.length,d.time("tableScan: "+c),e=this._data.filter(h)),a.$orderBy&&(d.time("sort"),e=this.sort(a.$orderBy,e),d.time("sort")),d.time("tableScan: "+c));a.limit&&e&&e.length>a.limit&&(e.length=a.limit,d.data("limit",a.limit));a.$decouple&&(d.time("decouple"),e=this.decouple(e),d.time("decouple"),d.data("flag.decouple",!0));if(a.join){for(h=0;h<a.join.length;h++)for(p in a.join[h])if(a.join[h].hasOwnProperty(p))for(E=p,c=this._db.collection(p),k=a.join[h][p],ba=0;ba<e.length;ba++){m=
{};q=n=!1;for(l in k)if(k.hasOwnProperty(l))if("$"===l.substr(0,1))switch(l){case "$as":E=k[l];break;case "$multi":n=k[l];break;case "$require":q=k[l];break;default:l.substr(0,3)}else m[l]=(new b(k[l])).value(e[ba])[0];m=c.find(m);!q||q&&m[0]?e[ba][E]=!1===n?m[0]:m:ma.push(e[ba])}d.data("flag.join",!0)}if(ma.length){d.time("removalQueue");for(l=0;l<ma.length;l++)p=e.indexOf(ma[l]),-1<p&&e.splice(p,1);d.time("removalQueue")}if(a.transform){d.time("transform");for(l=0;l<e.length;l++)e.splice(l,1,a.transform(e[l]));
d.time("transform");d.data("flag.transform",!0)}this._transformEnabled&&this._transformOut&&(d.time("transformOut"),e=this.transformOut(e),d.time("transformOut"));d.data("results",e.length);d.stop()}else d.stop(),e=[];e.__fdbOp=d;return e};d.prototype.indexOf=function(a){if(a=this.find(a,{$decouple:!1})[0])return this._data.indexOf(a)};d.prototype.transform=function(a){return void 0!==a?("object"===typeof a?(void 0!==a.enabled&&(this._transformEnabled=a.enabled),void 0!==a.dataIn&&(this._transformIn=
a.dataIn),void 0!==a.dataOut&&(this._transformOut=a.dataOut)):this._transformEnabled=!1===a?!1:!0,this):{enabled:this._transformEnabled,dataIn:this._transformIn,dataOut:this._transformOut}};d.prototype.transformIn=function(a){if(this._transformEnabled&&this._transformIn){if(a instanceof Array){var b=[],d;for(d=0;d<a.length;d++)b[d]=this._transformIn(a[d]);return b}return this._transformIn(a)}return a};d.prototype.transformOut=function(a){if(this._transformEnabled&&this._transformOut){if(a instanceof
Array){var b=[],d;for(d=0;d<a.length;d++)b[d]=this._transformOut(a[d]);return b}return this._transformOut(a)}return a};d.prototype.sort=function(a,b){b=b||[];var d=[],f,c;for(f in a)a.hasOwnProperty(f)&&(c={},c[f]=a[f],c.___fdbKey=f,d.push(c));return 2>d.length?this._sort(a,b):this._bucketSort(d,b)};d.prototype._bucketSort=function(a,b){var d=a.shift(),f,c,k=[];if(0<a.length){b=this._sort(d,b);f=this.bucket(d.___fdbKey,b);for(c in f)f.hasOwnProperty(c)&&(d=[].concat(a),k=k.concat(this._bucketSort(d,
f[c])));return k}return this._sort(d,b)};d.prototype._sort=function(a,d){var f=new b,c=f.parse(a,!0)[0];f.path(c.path);return d.sort(1===c.value?function(a,b){var g=f.value(a)[0],d=f.value(b)[0];return"string"===typeof g&&"string"===typeof d?g.localeCompare(d):g>d?1:g<d?-1:0}:function(a,b){var g=f.value(a)[0],d=f.value(b)[0];return"string"===typeof g&&"string"===typeof d?1===g.localeCompare(d)?-1:1:g>d?-1:g<d?1:0})};d.prototype.bucket=function(a,b){var d,f={};for(d=0;d<b.length;d++)f[b[d][a]]=f[b[d][a]]||
[],f[b[d][a]].push(b[d]);return f};d.prototype._analyseQuery=function(a,d,f){var c={queriesOn:[this._name],indexMatch:[],hasJoin:!1,queriesJoin:!1,joinQueries:{},query:a,options:d},k,e=[],h=[],m,n,q,p,l;f.time("checkIndexes");void 0!==a[this._primaryKey]&&(f.time("checkIndexMatch: Primary Key"),m=new b,c.indexMatch.push({lookup:this._primaryIndex.lookup(a,d),keyData:{matchedKeys:[this._primaryKey],matchedKeyCount:1,totalKeyCount:m.countKeys(a)},index:this._primaryIndex}),f.time("checkIndexMatch: Primary Key"));
for(l in this._indexById)if(this._indexById.hasOwnProperty(l)&&(n=this._indexById[l],q=n.name(),f.time("checkIndexMatch: "+q),m=n.match(a,d),p=n.lookup(a,d),0<m.matchedKeyCount&&c.indexMatch.push({lookup:p,keyData:m,index:n}),f.time("checkIndexMatch: "+q),m.totalKeyCount===m.matchedKeyCount))break;f.time("checkIndexes");1<c.indexMatch.length&&(f.time("findOptimalIndex"),c.indexMatch.sort(function(a,b){return a.keyData.totalKeyCount===a.keyData.matchedKeyCount?-1:b.keyData.totalKeyCount===b.keyData.matchedKeyCount?
1:a.keyData.matchedKeyCount===b.keyData.matchedKeyCount?a.lookup.length-b.lookup.length:b.keyData.matchedKeyCount-a.keyData.matchedKeyCount}),f.time("findOptimalIndex"));if(d.join){c.hasJoin=!0;for(f=0;f<d.join.length;f++)for(k in d.join[f])d.join[f].hasOwnProperty(k)&&(e.push(k),"$as"in d.join[f][k]?h.push(d.join[f][k].$as):h.push(k));for(k=0;k<h.length;k++)if(d=this._queryReferencesCollection(a,h[k],""))c.joinQueries[e[k]]=d,c.queriesJoin=!0;c.joinsOn=e;c.queriesOn=c.queriesOn.concat(e)}return c};
d.prototype._queryReferencesCollection=function(a,b,d){for(var f in a)if(a.hasOwnProperty(f)){if(f===b)return d&&(d+="."),d+f;if("object"===typeof a[f])return d&&(d+="."),d+=f,this._queryReferencesCollection(a[f],b,d)}return!1};d.prototype._match=function(a,b,d){var f,c;f=typeof a;c=typeof b;var k=!0,e;if(!("string"!==f&&"number"!==f||"string"!==c&&"number"!==c))a!==b&&(k=!1);else for(e in b)if(b.hasOwnProperty(e)){f=!1;if("$"===e.substr(0,1))switch(e){case "$gt":if(a>b[e]){if("or"===d)return!0}else k=
!1;f=!0;break;case "$gte":if(a>=b[e]){if("or"===d)return!0}else k=!1;f=!0;break;case "$lt":if(a<b[e]){if("or"===d)return!0}else k=!1;f=!0;break;case "$lte":if(a<=b[e]){if("or"===d)return!0}else k=!1;f=!0;break;case "$exists":if(void 0===a!==b[e]){if("or"===d)return!0}else k=!1;f=!0;break;case "$or":f=!0;for(c=0;c<b[e].length;c++){if(this._match(a,b[e][c],"and"))return!0;k=!1}break;case "$and":f=!0;for(c=0;c<b[e].length;c++)if(!this._match(a,b[e][c],"and"))return!1;break;case "$in":if(b[e]instanceof
Array){f=b[e];c=f.length;var h,m=!1;for(h=0;h<c;h++)if(f[h]===a){m=!0;break}if(m){if("or"===d)return!0}else k=!1}else throw"Cannot use a $nin operator on a non-array key: "+e;f=!0;break;case "$nin":if(b[e]instanceof Array){f=b[e];c=f.length;m=!0;for(h=0;h<c;h++)if(f[h]===a){m=!1;break}if(m){if("or"===d)return!0}else k=!1}else throw"Cannot use a $nin operator on a non-array key: "+e;f=!0;break;case "$ne":if(a!=b[e]){if("or"===d)return!0}else k=!1;f=!0}if(!f&&b[e]instanceof RegExp)if(f=!0,"object"===
typeof a&&void 0!==a[e]&&b[e].test(a[e])){if("or"===d)return!0}else k=!1;if(!f)if("object"===typeof b[e])if(void 0!==a[e]){if(a[e]instanceof Array&&!(b[e]instanceof Array))for(f=!1,c=0;c<a[e].length&&!(f=this._match(a[e][c],b[e],void 0));c++);else if(!(a[e]instanceof Array)&&b[e]instanceof Array)for(f=!1,c=0;c<b[e].length&&!(f=this._match(a[e],b[e][c],void 0));c++);else f="object"===typeof a?this._match(a[e],b[e],void 0):this._match(void 0,b[e],void 0);if(f){if("or"===d)return!0}else k=!1}else if(b[e]&&
void 0!==b[e].$exists)if(f=this._match(void 0,b[e],void 0)){if("or"===d)return!0}else k=!1;else k=!1;else if(a&&a[e]===b[e]){if("or"===d)return!0}else if(a&&a[e]&&a[e]instanceof Array&&b[e]&&"object"!==typeof b[e]){f=!1;for(c=0;c<a[e].length&&!(f=this._match(a[e][c],b[e],void 0));c++);if(f){if("or"===d)return!0}else k=!1}else k=!1;if("and"===d&&!k)return!1}return k};d.prototype.count=function(a,b){return a?this.find(a,b).length:this._data.length};d.prototype.link=function(a,b){if(window.jQuery){this._links=
...
delete this._links[d],this._linked--,this.debug()&&console.log('ForerunnerDB.Collection: Removed binding collection "'+this.name()+'" to output target: '+a),this;console.log("Cannot remove link, one does not exist to the target: "+a+" with the template: "+b)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";};d.prototype.findSub=function(a,d,f,c){var e=new b(d);a=this.find(a);var k=a.length,h,m,n=this._db.collection("__FDB_temp_"+this.objectId()),q={parents:k,subDocTotal:0,
subDocs:[],pathFound:!1,err:""};for(h=0;h<k;h++)if(m=e.value(a[h])[0]){n.setData(m);m=n.find(f,c);if(c.returnFirst&&m.length)return m[0];q.subDocs.push(m);q.subDocTotal+=m.length;q.pathFound=!0}n.drop();if(c.noStats)return q.subDocs;q.pathFound||(q.err="No objects found in the parent documents with a matching path of: "+d);return q};d.prototype.insertIndexViolation=function(a){var b,d=this._indexByName,f,c;if(this._primaryIndex.get(a[this._primaryKey]))b=this._primaryIndex;else for(f in d)if(d.hasOwnProperty(f)&&
(c=d[f],c.unique()&&c.violation(a))){b=c;break}return b?b.name():!1};d.prototype.ensureIndex=function(b,d){this._indexByName=this._indexByName||{};this._indexById=this._indexById||{};var f=new a(b,d,this),c={start:(new Date).getTime()};if(this._indexByName[f.name()])return{err:"Index with that name already exists"};if(this._indexById[f.id()])return{err:"Index with those keys already exists"};f.rebuild();this._indexByName[f.name()]=f;this._indexById[f.id()]=f;c.end=(new Date).getTime();c.total=c.end-
c.start;this._lastOp={type:"ensureIndex",stats:{time:c}};return{index:f,id:f.id(),name:f.name(),state:f.state()}};d.prototype.index=function(a){if(this._indexByName)return this._indexByName[a]};d.prototype.lastOp=function(){return this._metrics.list()};d.prototype.objectId=e.common.objectId;d.prototype.diff=function(a){var b={insert:[],update:[],remove:[]},d=this.primaryKey(),f,c,e,k;if(d===a.primaryKey()){for(f=a._data;f&&!(f instanceof Array);)a=f,f=a._data;k=f.length;for(c=0;c<k;c++)e=f[c],this._primaryIndex.get(e[d])?
...
this._collection[a];throw"Cannot get collection with undefined name!";};h.prototype.collectionExists=function(a){return Boolean(this._collection[a])};h.prototype.collections=function(){var a=[],b;for(b in this._collection)this._collection.hasOwnProperty(b)&&a.push({name:b,count:this._collection[b].count()});return a};m.exports=d},{"./Crc":6,"./Index":9,"./KeyValueStore":10,"./Metrics":11,"./Path":14,"./Shared":17}],4:[function(h,m,e){var k,c;e=h("./Shared");var b=function(){this.init.apply(this,arguments)};
b.prototype.init=function(a){this._name=a;this._data=new c("__FDB__cg_data_"+this._name);this._collections=[];this._views=[]};e.addModule("CollectionGroup",b);e.inherit(b.prototype,e.chainReactor);c=h("./Collection");h=e.modules.Core;k=e.modules.Core.prototype.init;b.prototype.debug=e.common.debug;b.prototype.on=function(){this._data.on.apply(this._data,arguments)};b.prototype.off=function(){this._data.off.apply(this._data,arguments)};b.prototype.emit=function(){this._data.emit.apply(this._data,arguments)};
b.prototype.primaryKey=function(a){return void 0!==a?(this._primaryKey=a,this):this._primaryKey};e.synthesize(b.prototype,"db");b.prototype.addCollection=function(a){if(a&&-1===this._collections.indexOf(a)){if(this._collections.length){if(this._primaryKey!==a.primaryKey())throw"All collections in a collection group must have the same primary key!";}else this.primaryKey(a.primaryKey());this._collections.push(a);a._groups.push(this);a.chain(this);this._data.insert(a.find())}return this};b.prototype.removeCollection=
function(a){if(a){var b=this._collections.indexOf(a);-1!==b&&(a.unChain(this),this._collections.splice(b,1),b=a._groups.indexOf(this),-1!==b&&a._groups.splice(b,1));0===this._collections.length&&delete this._primaryKey}return this};b.prototype.decouple=e.common.decouple;b.prototype._chainHandler=function(a){switch(a.type){case "setData":a.data=this.decouple(a.data);this._data.remove(a.options.oldData);this._data.insert(a.data);break;case "insert":a.data=this.decouple(a.data);this._data.insert(a.data);
break;case "update":this._data.update(a.data.query,a.data.update,a.options);break;case "remove":this._data.remove(a.data.query,a.options)}};b.prototype.insert=function(){this._collectionsRun("insert",arguments)};b.prototype.update=function(){this._collectionsRun("update",arguments)};b.prototype.updateById=function(){this._collectionsRun("updateById",arguments)};b.prototype.remove=function(){this._collectionsRun("remove",arguments)};b.prototype._collectionsRun=function(a,b){for(var d=0;d<this._collections.length;d++)this._collections[d][a].apply(this._collections[d],
b)};b.prototype.find=function(a,b){return this._data.find(a,b)};b.prototype.removeById=function(a){for(var b=0;b<this._collections.length;b++)this._collections[b].removeById(a)};b.prototype.subset=function(a,b){var d=this.find(a,b);return(new c)._subsetOf(this).primaryKey(this._primaryKey).setData(d)};b.prototype.drop=function(){var a,b=[].concat(this._collections),d=[].concat(this._views);this._debug&&console.log("Dropping collection group "+this._name);for(a=0;a<b.length;a++)this.removeCollection(b[a]);
for(a=0;a<d.length;a++)this._removeView(d[a]);this.emit("drop");return!0};h.prototype.init=function(){this._collectionGroup={};k.apply(this,arguments)};h.prototype.collectionGroup=function(a){return a?(this._collectionGroup[a]=this._collectionGroup[a]||(new b(a)).db(this),this._collectionGroup[a]):this._collectionGroup};m.exports=b},{"./Collection":3,"./Shared":17}],5:[function(h,m,e){var k,c;k=h("./Shared.js");e=function(){this.init.apply(this,arguments)};e.prototype.init=function(){this._collection=
{};this._debug={};this._version="1.2.7"};e.prototype.moduleLoaded=k.overload({string:function(b){if(void 0!==b){b=b.replace(/ /g,"");var a=b.split(","),f;for(f=0;f<a.length;f++)if(!k.modules[b])return!1;return!0}return!1},"string, function":function(b,a){if(void 0!==b){b=b.replace(/ /g,"");var f=b.split(","),d;for(d=0;d<f.length;d++)if(!k.modules[b])return!1;a()}},"string, function, function":function(b,a,f){if(void 0!==b){b=b.replace(/ /g,"");var d=b.split(","),c;for(c=0;c<d.length;c++)if(!k.modules[b])return f(),
!1;a()}}});e.moduleLoaded=e.prototype.moduleLoaded;e.shared=k;e.prototype.shared=k;k.addModule("Core",e);k.inherit(e.prototype,k.chainReactor);c=h("./Collection.js");h("./Metrics.js");h=h("./Crc.js");e.prototype._isServer=!1;e.prototype.isClient=function(){return!this._isServer};e.prototype.isServer=function(){return this._isServer};e.prototype.crc=h;e.prototype.isClient=function(){return!this._isServer};e.prototype.isServer=function(){return this._isServer};e.prototype.decouple=k.common.decouple;
e.prototype.debug=k.common.debug;e.prototype.arrayToCollection=function(b){return(new c).setData(b)};e.prototype.on=function(b,a){this._listeners=this._listeners||{};this._listeners[b]=this._listeners[b]||[];this._listeners[b].push(a);return this};e.prototype.off=function(b,a){if(b in this._listeners){var f=this._listeners[b],d=f.indexOf(a);-1<d&&f.splice(d,1)}return this};e.prototype.emit=function(b,a){this._listeners=this._listeners||{};if(b in this._listeners){var f=this._listeners[b],d=f.length,
c;for(c=0;c<d;c++)f[c].apply(this,Array.prototype.slice.call(arguments,1))}return this};e.prototype.objectId=k.common.objectId;e.prototype.peek=function(b){var a,f,d=[],c=typeof b;for(a in this._collection)this._collection.hasOwnProperty(a)&&(f=this._collection[a],d="string"===c?d.concat(f.peek(b)):d.concat(f.find(b)));return d};e.prototype.peekCat=function(b){var a,f,d={},c,e=typeof b;for(a in this._collection)this._collection.hasOwnProperty(a)&&(f=this._collection[a],(c="string"===e?f.peek(b):f.find(b))&&
c.length&&(d[f.name()]=c));return d};m.exports=e},{"./Collection.js":3,"./Crc.js":6,"./Metrics.js":11,"./Shared.js":17}],6:[function(h,m,e){var k=function(){var c=[],b,a,f;for(a=0;256>a;a++){b=a;for(f=0;8>f;f++)b=b&1?3988292384^b>>>1:b>>>1;c[a]=b}return c}();m.exports=function(c){var b=-1,a;for(a=0;a<c.length;a++)b=b>>>8^k[(b^c.charCodeAt(a))&255];return(b^-1)>>>0}},{}],7:[function(h,m,e){var k,c;e=h("./Shared");var b=function(){this.init.apply(this,arguments)};b.prototype.init=function(a){this._name=
a;this._data={}};e.addModule("Document",b);e.inherit(b.prototype,e.chainReactor);h=h("./Collection");k=e.modules.Core;c=e.modules.Core.prototype.init;e.synthesize(b.prototype,"db");e.synthesize(b.prototype,"name");b.prototype.setData=function(a){var b,d;if(a)if(a=this.decouple(a),this._linked){d={};for(b in this._data)"jQuery"!==b.substr(0,6)&&this._data.hasOwnProperty(b)&&void 0===a[b]&&(d[b]=1);a.$unset=d;this._updateObject(this._data,a,{})}else this._data=a;return this};b.prototype.decouple=e.common.decouple;
b.prototype.objectId=e.common.objectId;b.prototype.on=e.common.on;b.prototype.off=e.common.off;b.prototype.emit=e.common.emit;b.prototype.debug=e.common.debug;b.prototype.update=function(a,b,d){this._updateObject(this._data,b,a,d)};b.prototype._updateObject=h.prototype._updateObject;b.prototype._isPositionalKey=function(a){return".$"===a.substr(a.length-2,2)};b.prototype._updateProperty=function(a,b,d){this._linked?(jQuery.observable(a).setProperty(b,d),this.debug()&&console.log('ForerunnerDB.Document: Setting data-bound document property "'+
b+'" for collection "'+this.name()+'"')):(a[b]=d,this.debug()&&console.log('ForerunnerDB.Document: Setting non-data-bound document property "'+b+'" for collection "'+this.name()+'"'))};b.prototype._updateIncrement=function(a,b,d){this._linked?jQuery.observable(a).setProperty(b,a[b]+d):a[b]+=d};b.prototype._updateSpliceMove=function(b,f,d){this._linked?(jQuery.observable(b).move(f,d),this.debug()&&console.log('ForerunnerDB.Document: Moving data-bound document array index from "'+f+'" to "'+d+'" for collection "'+
this.name()+'"')):(b.splice(d,0,b.splice(f,1)[0]),this.debug()&&console.log('ForerunnerDB.Document: Moving non-data-bound document array index from "'+f+'" to "'+d+'" for collection "'+this.name()+'"'))};b.prototype._updateSplicePush=function(b,f,d){b.length>f?this._linked?jQuery.observable(b).insert(f,d):b.splice(f,0,d):this._linked?jQuery.observable(b).insert(d):b.push(d)};b.prototype._updatePush=function(b,f){this._linked?jQuery.observable(b).insert(f):b.push(f)};b.prototype._updatePull=function(b,
f){this._linked?jQuery.observable(b).remove(f):b.splice(f,1)};b.prototype._updateMultiply=function(b,f,d){this._linked?jQuery.observable(b).setProperty(f,b[f]*d):b[f]*=d};b.prototype._updateRename=function(b,f,d){var c=b[f];this._linked?(jQuery.observable(b).setProperty(d,c),jQuery.observable(b).removeProperty(f)):(b[d]=c,delete b[f])};b.prototype._updateUnset=function(b,f){this._linked?jQuery.observable(b).removeProperty(f):delete b[f]};b.prototype._updatePop=function(b,f){var d,c=!1;0<b.length&&
(this._linked?(1===f?d=b.length-1:-1===f&&(d=0),-1<d&&(jQuery.observable(arr).remove(d),c=!0)):1===f?(b.pop(),c=!0):-1===f&&(b.shift(),c=!0));return c};b.prototype.link=function(b,f){if(window.jQuery){this._links=this._links||{};this._linked||(this._linked=0);var d,c;f&&"object"===typeof f?f.template&&"string"===typeof f.template&&(d=this.objectId(f.template),c=f.template):d=f;if(!this._links[d]){if(jQuery(b).length){if(!jQuery.templates[d]){if(!c)if(c=jQuery(f),c.length)c=jQuery(c[0]).html();else throw"Unable to bind document to target because template does not exist: "+
...
delete this._chart;delete this._options;delete this._collection;return this};h.prototype.init=function(){this._highcharts={};k.apply(this,arguments)};h.prototype.chart=function(b){this._highcharts[b.selector]||(this._highcharts[b.selector]=new c(this,b));return this._highcharts[b.selector]};h.prototype.dropChart=function(b){this._highcharts[b]&&this._highcharts[b].drop()};m.exports=c},{"./Shared":17}],9:[function(h,m,e){e=h("./Shared");var k=h("./Path");h=function(){this.init.apply(this,arguments)};
h.prototype.init=function(c,b,a){this._crossRef={};this._size=0;this._id=this._itemKeyHash(c,c);this.data({});this.unique(b&&b.unique?b.unique:!1);void 0!==c&&this.keys(c);void 0!==a&&this.collection(a);this.name(b&&b.name?b.name:this._id)};e.addModule("Index",h);e.inherit(h.prototype,e.chainReactor);h.prototype.id=function(){return this._id};h.prototype.state=function(){return this._state};h.prototype.size=function(){return this._size};h.prototype.data=function(c){return void 0!==c?(this._data=c,
this):this._data};e.synthesize(h.prototype,"name");h.prototype.collection=function(c){return void 0!==c?(this._collection=c,this):this._collection};h.prototype.keys=function(c){return void 0!==c?(this._keys=c,this._keyCount=(new k).parse(this._keys).length,this):this._keys};h.prototype.type=function(c){return void 0!==c?(this._type=c,this):this._type};h.prototype.unique=function(c){return void 0!==c?(this._unique=c,this):this._unique};h.prototype.rebuild=function(){if(this._collection){var c=this._collection.subset({},
{$decouple:!1,$orderBy:this._keys}).find(),b,a=c.length;this._data={};this._unique&&(this._uniqueLookup={});for(b=0;b<a;b++)this.insert(c[b])}this._state={name:this._name,keys:this._keys,indexSize:this._size,built:new Date,updated:new Date,ok:!0}};h.prototype.insert=function(c,b){var a,f;this._unique&&(a=this._itemHash(c,this._keys),this._uniqueLookup[a]=c);a=this._itemHashArr(c,this._keys);for(f=0;f<a.length;f++)this.pushToPathValue(a[f],c)};h.prototype.remove=function(c,b){var a,f;this._unique&&
(a=this._itemHash(c,this._keys),delete this._uniqueLookup[a]);a=this._itemHashArr(c,this._keys);for(f=0;f<a.length;f++)this.pullFromPathValue(a[f],c)};h.prototype.violation=function(c){c=this._itemHash(c,this._keys);return Boolean(this._uniqueLookup[c])};h.prototype.hashViolation=function(c){return Boolean(this._uniqueLookup[c])};h.prototype.pushToPathValue=function(c,b){var a=this._data[c]=this._data[c]||[];-1===a.indexOf(b)&&(a.push(b),this._size++,this.pushToCrossRef(b,a))};h.prototype.pullFromPathValue=
function(c,b){var a=this._data[c],f;f=a.indexOf(b);-1<f&&(a.splice(f,1),this._size--,this.pullFromCrossRef(b,a));a.length||delete this._data[c]};h.prototype.pull=function(c){var b=c[this._collection.primaryKey()],a=this._crossRef[b],f,d=a.length,g;for(f=0;f<d;f++)g=a[f],this._pullFromArray(g,c);this._size--;delete this._crossRef[b]};h.prototype._pullFromArray=function(c,b){for(var a=c.length;a--;)c[a]===b&&c.splice(a,1)};h.prototype.pushToCrossRef=function(c,b){var a=c[this._collection.primaryKey()];
this._crossRef[a]=this._crossRef[a]||[];a=this._crossRef[a];-1===a.indexOf(b)&&a.push(b)};h.prototype.pullFromCrossRef=function(c,b){var a=c[this._collection.primaryKey()];delete this._crossRef[a]};h.prototype.lookup=function(c){return this._data[this._itemHash(c,this._keys)]||[]};h.prototype.match=function(c,b){return(new k).countObjectPaths(this._keys,c)};h.prototype._itemHash=function(c,b){var a=new k,f,d="",g;f=a.parse(b);for(g=0;g<f.length;g++)d&&(d+="_"),d+=a.value(c,f[g].path).join(":");return d};
h.prototype._itemKeyHash=function(c,b){var a=new k,f,d="",g;f=a.parse(b);for(g=0;g<f.length;g++)d&&(d+="_"),d+=a.keyValue(c,f[g].path);return d};h.prototype._itemHashArr=function(c,b){var a=new k,f,d=[],g,e,h,m;f=a.parse(b);for(h=0;h<f.length;h++)for(g=a.value(c,f[h].path),e=0;e<g.length;e++)if(0===h)d.push(g[e]);else for(m=0;m<d.length;m++)d[m]=d[m]+"_"+g[e];return d};m.exports=h},{"./Path":14,"./Shared":17}],10:[function(h,m,e){h=h("./Shared");e=function(e){this.init.apply(this,arguments)};e.prototype.init=
function(e){this._name=e;this._data={};this._primaryKey="_id"};h.addModule("KeyValueStore",e);h.inherit(e.prototype,h.chainReactor);h.synthesize(e.prototype,"name");e.prototype.primaryKey=function(e){return void 0!==e?(this._primaryKey=e,this):this._primaryKey};e.prototype.truncate=function(){this._data={};return this};e.prototype.set=function(e,c){this._data[e]=c?c:!0;return this};e.prototype.get=function(e){return this._data[e]};e.prototype.lookup=function(e){e=e[this._primaryKey];var c,b,a,f;if(e instanceof
Array){b=e.length;f=[];for(c=0;c<b;c++)(a=this._data[e[c]])&&f.push(a);return f}if(e instanceof RegExp){f=[];for(c in this._data)this._data.hasOwnProperty(c)&&e.test(c)&&f.push(this._data[c]);return f}if("object"===typeof e){if(e.$ne){f=[];for(c in this._data)this._data.hasOwnProperty(c)&&c!==e.$ne&&f.push(this._data[c]);return f}if(e.$in&&e.$in instanceof Array){f=[];for(c in this._data)this._data.hasOwnProperty(c)&&-1<e.$in.indexOf(c)&&f.push(this._data[c]);return f}if(e.$nin&&e.$nin instanceof
Array){f=[];for(c in this._data)this._data.hasOwnProperty(c)&&-1===e.$nin.indexOf(c)&&f.push(this._data[c]);return f}if(e.$or&&e.$or instanceof Array){f=[];for(c=0;c<e.$or.length;c++)f=f.concat(this.lookup(e.$or[c]));return f}}else return a=this._data[e],void 0!==a?[a]:[]};e.prototype.unSet=function(e){delete this._data[e];return this};e.prototype.uniqueSet=function(e,c){return void 0===this._data[e]?(this._data[e]=c,!0):!1};m.exports=e},{"./Shared":17}],11:[function(h,m,e){e=h("./Shared");var k=
...
var b=[],a;for(a=0;a<this._collections.length;a++)b=b.concat(this._collections[a].find(this._query,this._queryOptions));this._collData.setData(b)}this._reduce&&(b=this._reduce(),this._data.setData(b))};a.prototype._chainHandler=function(b){switch(b.type){case "setData":case "insert":case "update":case "remove":this._refresh()}};a.prototype.link=function(b,a){this._data.link.apply(this._data,arguments);this._refresh()};a.prototype.unlink=function(b,a){this._data.unlink.apply(this._data,arguments);
this._refresh()};h.prototype.init=function(){this._overview={};k.apply(this,arguments)};h.prototype.overview=function(b){return b?(this._overview[b]=this._overview[b]||(new a(b)).db(this),this._overview[b]):this._overview};m.exports=a},{"./Collection":3,"./Document":7,"./Shared":17}],14:[function(h,m,e){h=h("./Shared");e=function(e){this.init.apply(this,arguments)};e.prototype.init=function(e){e&&this.path(e)};h.addModule("Path",e);h.inherit(e.prototype,h.chainReactor);e.prototype.path=function(e){return void 0!==
e?(this._path=this.clean(e),this._pathParts=this._path.split("."),this):this._path};e.prototype.hasObjectPaths=function(e,c){var b=!0,a;for(a in e)if(e.hasOwnProperty(a)&&(void 0===c[a]||"object"===typeof e[a]&&(b=this.hasObjectPaths(e[a],c[a]),!b)))return!1;return b};e.prototype.countKeys=function(e){var c=0,b;for(b in e)e.hasOwnProperty(b)&&void 0!==e[b]&&("object"!==typeof e[b]?c++:c+=this.countKeys(e[b]));return c};e.prototype.countObjectPaths=function(e,c){var b,a={},f=0,d=0,g;for(g in c)c.hasOwnProperty(g)&&
("object"===typeof c[g]?(b=this.countObjectPaths(e[g],c[g]),a[g]=b.matchedKeys,d+=b.totalKeyCount,f+=b.matchedKeyCount):(d++,e&&e[g]&&"object"!==typeof e[g]?(a[g]=!0,f++):a[g]=!1));return{matchedKeys:a,matchedKeyCount:f,totalKeyCount:d}};e.prototype.parse=function(e,c){var b=[],a="",f,d,g;for(d in e)if(e.hasOwnProperty(d))if(a=d,"object"===typeof e[d])if(c)for(f=this.parse(e[d],c),g=0;g<f.length;g++)b.push({path:a+"."+f[g].path,value:f[g].value});else for(f=this.parse(e[d]),g=0;g<f.length;g++)b.push({path:a+
"."+f[g].path});else c?b.push({path:a,value:e[d]}):b.push({path:a});return b};e.prototype.parseArr=function(e,c){c=c||{};return this._parseArr(e,"",[],c)};e.prototype._parseArr=function(e,c,b,a){var f,d="";c=c||"";b=b||[];for(f in e)e.hasOwnProperty(f)&&(!a.ignore||a.ignore&&!a.ignore.test(f))&&(d=c?c+"."+f:f,"object"===typeof e[f]?this._parseArr(e[f],d,b,a):b.push(d));return b};e.prototype.value=function(e,c){if(void 0!==e&&"object"===typeof e){var b,a,f,d,g=[],h;void 0!==c&&(c=this.clean(c),b=c.split("."));
b=b||this._pathParts;a=b.length;f=e;for(h=0;h<a;h++){f=f[b[h]];if(d instanceof Array){for(a=0;a<d.length;a++)g=g.concat(this.value(d,a+"."+b[h]));return g}if(!f||"object"!==typeof f)break;d=f}return[f]}return[]};e.prototype.set=function(e,c,b){if(void 0!==e&&void 0!==c){var a;c=this.clean(c);c=c.split(".");a=c.shift();c.length?(e[a]=e[a]||{},this.set(e[a],c.join("."),b)):e[a]=b}return e};e.prototype.get=function(e,c){return this.value(e,c)[0]};e.prototype.push=function(e,c,b){if(void 0!==e&&void 0!==
c){var a;c=this.clean(c);c=c.split(".");a=c.shift();if(c.length)e[a]=e[a]||{},this.set(e[a],c.join("."),b);else if(e[a]=e[a]||[],e[a]instanceof Array)e[a].push(b);else throw"Cannot push to a path whose endpoint is not an array!";}return e};e.prototype.keyValue=function(e,c){var b,a,f,d,g;void 0!==c&&(c=this.clean(c),b=c.split("."));b=b||this._pathParts;a=b.length;f=e;for(g=0;g<a;g++)if(f=f[b[g]],!f||"object"!==typeof f){d=b[g]+":"+f;break}return d};e.prototype.clean=function(e){"."===e.substr(0,1)&&
(e=e.substr(1,e.length-1));return e};m.exports=e},{"./Shared":17}],15:[function(h,m,e){e=h("./Shared");var k,c,b,a;a=function(){this.init.apply(this,arguments)};a.prototype.init=function(b){b.isClient()&&void 0!==Storage&&this.mode("localStorage")};e.addModule("Persist",a);e.inherit(a.prototype,e.chainReactor);e=e.modules.Core;k=h("./Collection");c=k.prototype.drop;h("./CollectionGroup");b=e.prototype.init;a.prototype.mode=function(b){return void 0!==b?(this._mode=b,this):this._mode};a.prototype.save=
function(b,a,c){switch(this.mode()){case "localStorage":a="object"===typeof a?"json::fdb::"+JSON.stringify(a):"raw::fdb::"+a;try{localStorage.setItem(b,a)}catch(e){if(c)c(e);else throw e;break}if(c)c(!1);else return!1;break;default:if(c)c("No data handler.");else throw"No data handler.";}};a.prototype.load=function(b,a){var c,e;switch(this.mode()){case "localStorage":try{c=localStorage.getItem(b)}catch(h){a(h,null)}if(c){c=c.split("::fdb::");switch(c[0]){case "json":e=JSON.parse(c[1]);break;case "raw":e=
c[1]}if(a)a(!1,e);else return e}break;default:if(a)a("No data handler or unrecognised data type.");else throw"No data handler or unrecognised data type.";}};a.prototype.drop=function(b,a){switch(this.mode()){case "localStorage":try{localStorage.removeItem(b)}catch(c){a&&a(c)}a&&a(!1);break;default:a&&a("No data handler or unrecognised data type.")}};k.prototype.drop=function(b){if(b)if(this._name)if(this._db)this._db.persist.drop(this._name);else return callback&&callback("Cannot drop a collection's persistent storage when the collection is not attached to a database!"),
"Cannot drop a collection's persistent storage when the collection is not attached to a database!";else return callback&&callback("Cannot drop a collection's persistent storage when no name assigned to collection!"),"Cannot drop a collection's persistent storage when no name assigned to collection!";c.apply(this)};k.prototype.save=function(b){if(this._name)if(this._db)this._db.persist.save(this._name,this._data,b);else return b&&b("Cannot save a collection that is not attached to a database!"),"Cannot save a collection that is not attached to a database!";
else return b&&b("Cannot save a collection with no assigned name!"),"Cannot save a collection with no assigned name!"};k.prototype.load=function(b){var a=this;if(this._name)if(this._db)this._db.persist.load(this._name,function(c,e){if(c)return b&&b(c),c;e&&a.setData(e);b&&b(!1)});else return b&&b("Cannot load a collection that is not attached to a database!"),"Cannot load a collection that is not attached to a database!";else return b&&b("Cannot load a collection with no assigned name!"),"Cannot load a collection with no assigned name!"};
e.prototype.init=function(){this.persist=new a(this);b.apply(this,arguments)};m.exports=a},{"./Collection":3,"./CollectionGroup":4,"./Shared":17}],16:[function(h,m,e){h=h("./Shared");e=function(e,c,b){if(e&&c&&b){this._reactorIn=e;this._reactorOut=c;this._chainHandler=b;if(!e.chain||!c.chainReceive)throw"ReactorIO requires passed in and out objects to implement the ChainReactor mixin!";e.chain(this);this.chain(c)}else throw"ReactorIO requires an in, out and process argument to instantiate!";};e.prototype.drop=
function(){this._reactorIn.unChain(this);this.unChain(this._reactorOut);delete this._reactorIn;delete this._reactorOut;delete this._chainHandler};h.addModule("ReactorIO",e);h.inherit(e.prototype,h.chainReactor);m.exports=e},{"./Shared":17}],17:[function(h,m,e){var k=0,c=function(b){var a=[],f,d=["string","object","number","function","undefined"],e;if(-1<b.indexOf("*"))for(e=0;e<d.length;e++)f=b.replace("*",d[e]),a=a.concat(c(f));else a.push(b);return a};e=function(b){if(b){var a,f,d,e,h;if(!(b instanceof
Array)){d={};for(a in b)if(b.hasOwnProperty(a))if(e=a.replace(/ /g,""),-1===e.indexOf("*"))d[e]=b[a];else for(h=c(e),e=0;e<h.length;e++)d[h[e]]||(d[h[e]]=b[a]);b=d}return function(){if(b instanceof Array)for(f=b.length,a=0;a<f;a++){if(b[a].length===arguments.length)return b[a].apply(this,arguments)}else{var d=[],c;for(a=0;a<arguments.length;a++)d.push(typeof arguments[a]);c=d.join(",");if(b[c])return b[c].apply(this,arguments);for(a=d.length;0<=a;a--)if(c=d.slice(0,a).join(","),b[c+",..."])return b[c+
",..."].apply(this,arguments)}throw"Overloaded method does not have a matching signature for the passed arguments!";}}return function(){}};h={modules:{},common:{decouple:function(b){if(void 0!==b)return JSON.parse(JSON.stringify(b))},objectId:function(b){var a=Math.pow(10,17);if(b){var c=0,d=b.length,e;for(e=0;e<d;e++)c+=b.charCodeAt(e)*a;b=c.toString(16)}else k++,b=(k+(Math.random()*a+Math.random()*a+Math.random()*a+Math.random()*a)).toString(16);return b},debug:new e([function(){return this._debug&&
this._debug.all},function(b){return void 0!==b?"boolean"===typeof b?(this._debug=this._debug||{},this._debug.all=b,this.chainSend("debug",this._debug),this):this._debug&&this._debug[b]||this._db&&this._db._debug&&this._db._debug[b]||this._debug&&this._debug.all:this._debug&&this._debug.all},function(b,a){return void 0!==b?void 0!==a?(this._debug=this._debug||{},this._debug[b]=a,this.chainSend("debug",this._debug),this):this._debug&&this._debug[a]||this._db&&this._db._debug&&this._db._debug[b]:this._debug&&
this._debug.all}]),on:new e({"string, function":function(b,a){this._listeners=this._listeners||{};this._listeners[b]=this._listeners[b]||{};this._listeners[b]["*"]=this._listeners[b]["*"]||[];this._listeners[b]["*"].push(a);return this},"string, *, function":function(b,a,c){this._listeners=this._listeners||{};this._listeners[b]=this._listeners[b]||{};this._listeners[b][a]=this._listeners[b][a]||[];this._listeners[b][a].push(c);return this}}),off:new e({string:function(b){this._listeners&&this._listeners[b]&&
b in this._listeners&&delete this._listeners[b];return this},"string, function":function(b,a){var c,d;"string"===typeof a?this._listeners&&this._listeners[b]&&this._listeners[b][a]&&delete this._listeners[b][a]:b in this._listeners&&(c=this._listeners[b]["*"],d=c.indexOf(a),-1<d&&c.splice(d,1));return this},"string, *, function":function(b,a,c){this._listeners&&b in this._listeners&&a in this.listeners[b]&&(b=this._listeners[b][a],c=b.indexOf(c),-1<c&&b.splice(c,1))},"string, *":function(b,a){this._listeners&&
b in this._listeners&&a in this._listeners[b]&&delete this._listeners[b][a]}}),emit:function(b,a){this._listeners=this._listeners||{};if(b in this._listeners){if(this._listeners[b]["*"]){var c=this._listeners[b]["*"],d=c.length,e;for(e=0;e<d;e++)c[e].apply(this,Array.prototype.slice.call(arguments,1))}if(a instanceof Array&&a[0]&&a[0][this._primaryKey]){var c=this._listeners[b],h,k,d=a.length;for(e=0;e<d;e++)if(c[a[e][this._primaryKey]])for(h=c[a[e][this._primaryKey]].length,k=0;k<h;k++)c[a[e][this._primaryKey]][k].apply(this,
Array.prototype.slice.call(arguments,1))}}return this}},_synth:{},addModule:function(b,a){this.modules[b]=a},inherit:function(b,a){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c])},synthesize:function(b,a,c){this._synth[a]=this._synth[a]||function(b){return void 0!==b?(this["_"+a]=b,this):this["_"+a]};if(c){var d=this;b[a]=function(){var b=this.$super,e;this.$super=d._synth[a];e=c.apply(this,arguments);this.$super=b;return e}}else b[a]=this._synth[a]},overload:e,chainReactor:h("./ChainReactor")};m.exports=
h},{"./ChainReactor":2}],18:[function(h,m,e){var k,c,b,a;e=h("./Shared");var f=function(b,a,c){this.init.apply(this,arguments)};f.prototype.init=function(b,a,c){this._name=b;this._groups=[];this._listeners={};this._querySettings={query:a,options:c};this._debug={};this._privateData=new k("__FDB__view_privateData_"+this._name)};e.addModule("View",f);e.inherit(f.prototype,e.chainReactor);k=h("./Collection");CollectionGroup=h("./CollectionGroup");a=h("./ReactorIO");c=k.prototype.init;h=e.modules.Core;
b=h.prototype.init;e.synthesize(f.prototype,"name");f.prototype.debug=e.common.debug;f.prototype.insert=function(){this._from.insert.apply(this._from,arguments)};f.prototype.update=function(){this._from.update.apply(this._from,arguments)};f.prototype.updateById=function(){this._from.updateById.apply(this._from,arguments)};f.prototype.remove=function(){this._from.remove.apply(this._from,arguments)};f.prototype.find=function(b,a){return this.publicData().find(b,a)};f.prototype.link=function(b,a){var c=
this.publicData();this.debug()&&console.log('ForerunnerDB.View: Setting up data binding on view "'+this.name()+'" in underlying (internal) view collection "'+c.name()+'" for output target: '+b);return c.link(b,a)};f.prototype.unlink=function(b,a){var c=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Removing data binding on view "'+this.name()+'" in underlying (internal) view collection "'+c.name()+'" for output target: '+b);return c.unlink(b,a)};f.prototype.decouple=e.common.decouple;
f.prototype.from=function(b){var c=this;if(void 0!==b){"string"===typeof b&&(b=this._db.collection(b));this._from=b;this._io=new a(b,this,function(b){var a,d,e;if("insert"===b.type){if(c._querySettings.query){a=b.data;if(a instanceof Array)for(d=[],b=0;b<a.length;b++)c._privateData._match(a[b],c._querySettings.query,"and")&&(d.push(a[b]),e=!0);else c._privateData._match(a,c._querySettings.query,"and")&&(d=a,e=!0);e&&this.chainSend("insert",d);return!0}return!1}if("update"===b.type){if(c._querySettings.query&&
(d=c._privateData.diff(c._from.subset(c._querySettings.query,c._querySettings.options)),d.insert.length||d.remove.length)){d.insert.length&&this.chainSend("insert",d.insert);if(d.update.length)for(a=c._privateData.primaryKey(),b=0;b<d.update.length;b++)e={},e[a]=d.update[b][a],this.chainSend("update",{query:e,update:d.update[b]});d.remove.length&&this.chainSend("remove",d.remove);return!0}return!1}});var e=b.find(this._querySettings.query,this._querySettings.options);this._transformPrimaryKey(b.primaryKey());
this._transformInsert(e);this._privateData.primaryKey(b.primaryKey());this._privateData.insert(e)}return this};f.prototype._chainHandler=function(b){var a,c,e,f;switch(b.type){case "setData":this.debug()&&console.log('ForerunnerDB.View: Setting data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');b.data=this.decouple(b.data);this._transformSetData(b.data);this._privateData.setData(b.data);break;case "insert":this.debug()&&console.log('ForerunnerDB.View: Inserting some data on view "'+
this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');b.data=this.decouple(b.data);b.data instanceof Array||(b.data=[b.data]);a=this._privateData._data.length;this._transformInsert(b.data,a);this._privateData._insertHandle(b.data,a);this._refreshOrder(b.data);break;case "update":this.debug()&&console.log('ForerunnerDB.View: Updating some data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');this._privateData.primaryKey();
b=this._privateData.update(b.data.query,b.data.update,b.data.options);this._refreshOrder(b);if(this._transformEnabled&&this._transformIn)for(a=this._publicData.primaryKey(),f=0;f<b.length;f++)c={},e=b[f],c[a]=e[a],this._transformUpdate(c,e);break;case "remove":this.debug()&&console.log('ForerunnerDB.View: Removing some data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"'),this._transformRemove(b.data.query,b.options),this._privateData.remove(b.data.query,
b.options)}};f.prototype._refreshOrder=function(b){if(this._querySettings.options&&this._querySettings.options.$orderBy){var a,c,e,f;b||(b=this._privateData._data);a=[].concat(this._privateData._data);a=this._privateData.sort(this._querySettings.options.$orderBy,a);b.sort(function(b,c){return a.indexOf(b)-a.indexOf(c)});for(f=0;f<b.length;f++)c=this._privateData._data.indexOf(b[f]),e=a.indexOf(b[f]),this._privateData._updateSpliceMove(this._privateData._data,c,e)}};f.prototype.on=function(){this._privateData.on.apply(this._privateData,
...
f.prototype.primaryKey=function(){return this._privateData.primaryKey()};f.prototype.queryData=function(b,a,c){void 0!==b&&(this._querySettings.query=b);void 0!==a&&(this._querySettings.options=a);return void 0!==b||void 0!==a?(void 0!==c&&!0!==c||this.refresh(),this):this._querySettings};f.prototype.queryAdd=function(b,a,c){var e=this._querySettings.query,f;if(void 0!==b)for(f in b)b.hasOwnProperty(f)&&(void 0===e[f]||void 0!==e[f]&&a)&&(e[f]=b[f]);void 0!==c&&!0!==c||this.refresh()};f.prototype.queryRemove=
function(b,a){var c=this._querySettings.query,e;if(void 0!==b)for(e in b)b.hasOwnProperty(e)&&delete c[e];void 0!==a&&!0!==a||this.refresh()};f.prototype.query=function(b,a){return void 0!==b?(this._querySettings.query=b,void 0!==a&&!0!==a||this.refresh(),this):this._querySettings.query};f.prototype.queryOptions=function(b,a){return void 0!==b?(this._querySettings.options=b,void 0===b.$decouple&&(b.$decouple=!0),void 0!==a&&!0!==a||this.refresh(),this):this._querySettings.options};f.prototype.refresh=
function(){var b=this.publicData();this._privateData.remove();b.remove();this._privateData.insert(this._from.find(this._querySettings.query,this._querySettings.options));if(b._linked){var a=this._privateData.find();jQuery.observable(b._data).refresh(a)}return this};f.prototype.count=function(){return this._privateData&&this._privateData._data?this._privateData._data.length:0};f.prototype.transform=function(b){return void 0!==b?("object"===typeof b?(void 0!==b.enabled&&(this._transformEnabled=b.enabled),
void 0!==b.dataIn&&(this._transformIn=b.dataIn),void 0!==b.dataOut&&(this._transformOut=b.dataOut)):this._transformEnabled=!1===b?!1:!0,this._transformPrimaryKey(this.privateData().primaryKey()),this._transformSetData(this.privateData().find()),this):{enabled:this._transformEnabled,dataIn:this._transformIn,dataOut:this._transformOut}};f.prototype.privateData=function(){return this._privateData};f.prototype.publicData=function(){return this._transformEnabled?this._publicData:this._privateData};f.prototype._transformSetData=
function(b){this._transformEnabled&&(this._publicData=new k("__FDB__view_publicData_"+this._name),this._publicData.db(this._privateData._db),this._publicData.transform({enabled:!0,dataIn:this._transformIn,dataOut:this._transformOut}),this._publicData.setData(b))};f.prototype._transformInsert=function(b,a){this._transformEnabled&&this._publicData&&this._publicData.insert(b,a)};f.prototype._transformUpdate=function(b,a,c){this._transformEnabled&&this._publicData&&this._publicData.update(b,a,c)};f.prototype._transformRemove=
function(b,a){this._transformEnabled&&this._publicData&&this._publicData.remove(b,a)};f.prototype._transformPrimaryKey=function(b){this._transformEnabled&&this._publicData&&this._publicData.primaryKey(b)};k.prototype.init=function(){this._views=[];c.apply(this,arguments)};k.prototype.view=function(b,a,c){if(this._db&&this._db._views){if(this._db._views[b])throw"Cannot create a view using this collection because one with this name already exists: "+b;b=(new f(b,a,c)).db(this._db)._addCollection(this);
this._views=this._views||[];this._views.push(b);return b}};k.prototype._addView=CollectionGroup.prototype._addView=function(b){void 0!==b&&this._views.push(b);return this};k.prototype._removeView=CollectionGroup.prototype._removeView=function(b){void 0!==b&&(b=this._views.indexOf(b),-1<b&&this._views.splice(b,1));return this};h.prototype.init=function(){this._views={};b.apply(this,arguments)};h.prototype.view=function(b){this._views[b]||(this.debug()||this._db&&this._db.debug())&&console.log("Core.View: Creating view "+
b);this._views[b]=this._views[b]||(new f(b)).db(this);return this._views[b]};h.prototype.viewExists=function(b){return Boolean(this._views[b])};h.prototype.views=function(){var b=[],a;for(a in this._views)this._views.hasOwnProperty(a)&&b.push({name:a,count:this._views[a].count()});return b};m.exports=f},{"./Collection":3,"./CollectionGroup":4,"./ReactorIO":16,"./Shared":17}],19:[function(h,m,e){window.jQuery&&(this.jQuery=window.jQuery,function(){(function(e,c,b){function a(b){return b}function f(b){debugger;
return b}function d(b){ca=(xa._dbgMode=b)?"Unavailable (nested view): use #getIndex()":"";Ba("dbg",Ha.dbg=na.dbg=b?f:a)}function g(b){this.name=(s.link?"JsViews":"JsRender")+" Error";this.message=b||this.name}function h(b,a){for(var c in a)b[c]=a[c];return b}function m(b){return"function"===typeof b}function sa(b,a,c){if(!P.rTag||b)x=b?b.charAt(0):x,T=b?b.charAt(1):T,M=a?a.charAt(0):M,I=a?a.charAt(1):I,N=c||N,b="\\"+x+"(\\"+N+")?\\"+T,a="\\"+M+"\\"+I,C="(?:(?:(\\w+(?=[\\/\\s\\"+M+"]))|(?:(\\w+)?(:)|(>)|!--((?:[^-]|-(?!-))*)--|(\\*)))\\s*((?:[^\\"+
M+"]|\\"+M+"(?!\\"+I+"))*?)",P.rTag=C+")",C=RegExp(b+C+"(\\/)?|(?:\\/(\\w+)))"+a,"g"),pa=RegExp("<.*>|([^\\\\]|^)[{}]|"+b+".*"+a);return[x,T,M,I,N]}function Ja(a,c){c||(c=a,a=b);var e,d,f,g;f=this;e=!c||"root"===c;if(a){if(g=f.type===c?f:b,!g)if(e=f.views,f._.useKey)for(d in e){if(g=e[d].get(a,c))break}else for(d=0,f=e.length;!g&&d<f;d++)g=e[d].get(a,c)}else if(e)for(;f.parent.parent;)g=f=f.parent;else for(;f&&!g;)g=f.type===c?f:b,f=f.parent;return g}function S(){var a=this.get("item");return a?a.index:
b}function Y(){return this.index}function Z(a){var c,d=this,f=d.linkCtx,g=(d.ctx||{})[a];g===b&&f&&f.ctx&&(g=f.ctx[a]);g===b&&(g=Ha[a]);g&&m(g)&&!g._wrp&&(c=function(){return g.apply(this&&this!==e?this:d,arguments)},c._wrp=1,h(c,g));return c||g}function n(a,c,e){var d,f,g=+e===e&&e,h=c.linkCtx;g&&(e=(g=c.tmpl.bnds[g-1])(c.data,c,F));d=e.args[0];if(a||g){d=h&&h.tag;d||(d={_:{inline:!h,bnd:g},tagName:":",cvt:a,flow:!0,tagCtx:e,_is:"tag"},h&&(h.tag=d,d.linkCtx=h,e.ctx=K(e.ctx,h.view.ctx)),P._lnk(d));
for(f in e.props)Na.test(f)&&(d[f]=e.props[f]);e.view=c;d.ctx=e.ctx||{};delete e.ctx;c._.tag=d;d=q(d,d.convert||"true"!==a&&a)[0];d=g&&c._.onRender?c._.onRender(d,c,g):d;c._.tag=b}return d!=b?d:""}function q(b,a){var c=b.tagCtx,e=c.view,d=c.args;a=a&&(""+a===a?e.getRsc("converters",a)||la("Unknown converter: '"+a+"'"):a);d=d.length||c.index?a?d.slice():d:[e.data];a&&(a.depends&&(b.depends=P.getDeps(b.depends,b,a.depends,a)),d[0]=a.apply(b,d));return d}function p(a,c){for(var e,d=this;e===b&&d;)e=
(e=d.tmpl[a])&&e[c],d=d.parent;return e||F[a][c]}function l(a,c,e,d,f){var g,k,r,l,D,m,u,t,s,p,z,G="",n=+d===d&&d,C=c.linkCtx||0,w=c.ctx,x=e||c.tmpl;"tag"===a._is&&(g=a,a=g.tagName,d=g.tagCtxs);g=g||C.tag;n&&(d=(t=x.bnds[n-1])(c.data,c,F));m=d.length;for(D=0;D<m;D++){D||e&&g||(s=c.getRsc("tags",a)||la("Unknown tag: {{"+a+"}}"));k=d[D];C.tag||(u=k.tmpl,u=k.content=u&&x.tmpls[u-1],h(k,{tmpl:(g?g:s).template||u,render:V,index:D,view:c,ctx:K(k.ctx,w)}));if(e=k.props.tmpl)e=""+e===e?c.getRsc("templates",
e)||Da(e):e,k.tmpl=e;g||(s._ctr?(g=new s._ctr,p=!!g.init,g.attr=g.attr||s.attr||b):P._lnk(g={render:s.render}),g._={inline:!C},C&&(C.attr=g.attr=C.attr||g.attr,C.tag=g,g.linkCtx=C),(g._.bnd=t||C.fn)?g._.arrVws={}:g.dataBoundOnly&&la("{^{"+a+"}} tag must be data-bound"),g.tagName=a,g.parent=l=w&&w.tag,g._is="tag",g._def=s,g.tagCtxs=d);if(!D)for(z in u=k.props)Na.test(z)&&(g[z]=u[z]);k.tag=g;g.dataMap&&g.tagCtxs&&(k.map=g.tagCtxs[D].map);g.flow||(u=k.ctx=k.ctx||{},k=g.parents=u.parentTags=w&&K(u.parentTags,
w.parentTags)||{},l&&(k[l.tagName]=l),u.tag=g)}c._.tag=g;g.rendering={};for(D=0;D<m;D++){k=g.tagCtx=g.tagCtxs[D];u=k.props;a=q(g,g.convert);if(d=u.dataMap||g.dataMap)if(a.length||u.dataMap){l=k.map;if(!l||l.src!==a[0]||f)l&&l.src&&l.unmap(),l=k.map=d.map(a[0],u);a=[l.tgt]}g.ctx=k.ctx;!D&&p&&(d=g.template,g.init(k,C,g.ctx),p=b,g.template!==d&&(g._.tmpl=g.template));l=b;if(d=g.render)l=d.apply(g,a);a=a.length?a:[c];l=l!==b?l:k.render(a[0],!0)||(f?b:"");G=G?G+(l||""):l}delete g.rendering;g.tagCtx=g.tagCtxs[0];
g.ctx=g.tagCtx.ctx;g._.inline&&(r=g.attr)&&r!==L&&(G="text"===r?na.html(G):"");return n&&c._.onRender?c._.onRender(G,c,n):G}function aa(b,a,c,e,d,f,g,h){var k="array"===a,r={key:0,useKey:k?0:1,id:""+La++,onRender:h,bnds:{}};this.data=e;this.tmpl=d;this.content=g;this.views=k?[]:{};this.parent=c;this.type=a;this._=r;this.linked=!!h;c?(a=c.views,e=c._,e.useKey?(a[r.key="_"+e.useKey++]=this,this.index=ca,this.getIndex=S,f=e.tag,r.bnd=k&&(!f||!!f._.bnd&&f)):a.splice(r.key=this.index=f,0,this),this.ctx=
b||c.ctx):this.ctx=b}function E(b){var a,c,e,d,f,g;for(a in O)if(d=O[a],(f=d.compile)&&(c=b[a+"s"]))for(e in c)(d=c[e]=f(e,c[e],b))&&(g=P.onStore[a])&&g(e,d,f)}function ba(a,c,e){m(c)?c={depends:c.depends,render:c}:(c.baseTag&&(c.flow=!!c.flow,c=h(h({},c.baseTag),c)),(a=c.template)!==b&&(c.template=""+a===a?Da[a]||Da(a):a),!1!==c.init&&(a=c._ctr=function(){},(a.prototype=c).constructor=a));e&&(c._parentTmpl=e);return c}function ma(a,d,f,g){function h(d){if(""+d===d||0<d.nodeType){try{l=0<d.nodeType?
d:!pa.test(d)&&c&&c(e.document).find(d)[0]}catch(r){}l&&(d=Da[a=a||l.getAttribute(Q)],d||(a=a||"_"+X++,l.setAttribute(Q,a),d=Da[a]=ma(a,l.innerHTML,f,g)),l=b);return d}}var r,l;d=d||"";r=h(d);g=g||(d.markup?d:{});g.tmplName=a;f&&(g._parentTmpl=f);!r&&d.markup&&(r=h(d.markup))&&r.fn&&(r.debug!==d.debug||r.allowCode!==d.allowCode)&&(r=r.markup);if(r!==b)return a&&!f&&(w[a]=function(){return d.render.apply(d,arguments)}),r.fn||d.fn?r.fn&&(d=a&&a!==r.tmplName?K(g,r):r):(d=Ma(r,g),Fa(r.replace(y,"\\$&"),
d)),E(g),d}function oa(b){function a(c,d){this.tgt=b.getTgt(c,d)}m(b)&&(b={getTgt:b});b.baseMap&&(b=h(h({},b.baseMap),b));b.map=function(b,c){return new a(b,c)};return b}function Ma(b,a){var c,d=xa.wrapMap||{},e=h({markup:b,tmpls:[],links:{},tags:{},bnds:[],_is:"template",render:ta},a);a.htmlTag||(c=da.exec(b),e.htmlTag=c?c[1].toLowerCase():"");(c=d[e.htmlTag])&&c!==d.div&&(e.markup=s.trim(e.markup));return e}function qa(a,c){function d(f,g,h){var k,r,l;if(f&&"object"===typeof f&&!f.nodeType&&!f.markup&&
!f.getTgt){for(r in f)d(r,f[r],g);return F}g===b&&(g=f,f=b);f&&""+f!==f&&(h=g,g=f,f=b);l=h?h[e]=h[e]||{}:d;r=c.compile;null===g?f&&delete l[f]:(g=r?g=r(f,g,h):g,f&&(l[f]=g));r&&g&&(g._is=a);g&&(k=P.onStore[a])&&k(f,g,r);return g}var e=a+"s";F[e]=d;O[a]=c}function ra(b,a){var c=this.jquery&&(this[0]||la('Unknown template: "'+this.selector+'"')),d=c.getAttribute(Q);return ta.call(d?Da[d]:Da(c),b,a)}function ya(b,a,c){if(xa._dbgMode)try{return b.fn(a,c,F)}catch(d){return la(d,c)}return b.fn(a,c,F)}function ta(b,
a,c,d,e,f){return d||!this.fn._nvw||s.isArray(b)?V.call(this,b,a,c,d,e,f):ya(this,b,{tmpl:this})}function V(a,c,d,e,f,g){var h,k,r,l,D,u,m,t,p;r=this;var z="";!!c===c&&(d=c,c=b);!0===f&&(h=!0,f=0);r.tag?(u=r,r=r.tag,k=r._,D=r.tagName,t=k.tmpl||u.tmpl,p=r.attr&&r.attr!==L,c=K(c,r.ctx),m=u.content,!1===u.props.link&&(c=c||{},c.link=!1),e=e||u.view,a=arguments.length?a:e):t=r;if(t&&(!e&&a&&"view"===a._is&&(e=a),e&&(m=m||e.content,g=g||e._.onRender,a===e&&(a=e.data),c=K(c,e.ctx)),e&&e.data!==b||((c=c||
{}).root=a),t.fn||(t=Da[t]||Da(t)),t)){u=g=!1!==(c&&c.link)&&!p&&g;!0===g&&(u=b,g=e._.onRender);c=t.helpers?K(t.helpers,c):c;if(s.isArray(a)&&!d)for(l=h?e:f!==b&&e||new aa(c,"array",e,a,t,f,m,g),h=0,k=a.length;h<k;h++)r=a[h],D=new aa(c,"item",l,r,t,(f||0)+h,m,g),r=ya(t,r,D),z+=l._.onRender?l._.onRender(r,D):r;else{if(e||!t.fn._nvw)l=h?e:new aa(c,D||"data",e,a,t,f,m,g),k&&!r.flow&&(l.tag=r);z+=ya(t,a,l)}return u?u(z,l):z}return""}function la(b,a,c){c=xa.onError(b,a,c);if(""+b===b)throw new P.Err(c);
return!a.linkCtx&&a.linked?na.html(c):c}function ga(b){la("Syntax error\n"+b)}function Fa(b,a,c,d){function e(a){(a-=m)&&t.push(b.substr(m,a).replace(ja,"\\n"))}function f(a){a&&ga('Unmatched or missing tag: "{{/'+a+'}}" in template:\n'+b)}var g,h,k,l=a&&a.allowCode,u=[],m=0,K=[],t=u,s=[,,u];c&&(b=x+b+I);f(K[0]&&K[0][2].pop()[0]);b.replace(C,function(g,D,u,p,z,G,n,q,C,w,x,F){G&&(z=":",p=L);w=w||c;D=(D||c)&&[];var y="",A="",ha="",ua="",ka="",Ka="",Oa="",Xa="";n=!w&&!z&&!n;u=u||(C=C||"#data",z);e(F);
m=F+g.length;q?l&&t.push(["*","\n"+C.replace(ia,"$1")+"\n"]):u?("else"===u&&(R.test(C)&&ga('for "{{else if expr}}" use "{{else expr}}"'),D=s[7],s[8]=b.substring(s[8],F),s=K.pop(),t=s[2],n=!0),C&&r(C.replace(ja," "),D,a).replace(H,function(b,a,c,d,e,f,g,h){g?(A+=f+",",ua+="'"+h+"',"):c?(ha+=d+f+",",Ka+=d+"'"+h+"',"):a?Oa+=f:("trigger"===e&&(Xa+=f),y+=d+f+",",ka+=d+"'"+h+"',",k=k||Na.test(e));return""}).slice(0,-1),h=[u,p||!!d||k||"",n&&[],[ua.slice(0,-1),ka.slice(0,-1),Ka.slice(0,-1)],[A.slice(0,-1),
y.slice(0,-1),ha.slice(0,-1)],Oa,Xa,D||0],t.push(h),n&&(K.push(s),s=h,s[8]=m)):x&&(f(x!==s[0]&&"else"!==s[0]&&x),s[8]=b.substring(s[8],F),s=K.pop());f(!s&&x);t=s[2]});e(b.length);(m=u[u.length-1])&&f(""+m!==m&&+m[8]===m[8]&&m[0]);c?(g=D(u,b,c),g.paths=u[0][7]):g=D(u,a);g._nvw&&(g._nvw=!/[~#]/.test(b));return g}function Ia(b,a){return"\n\t"+(a?a+":{":"")+"args:["+b[0]+"]"+(b[1]||!a?",\n\tprops:{"+b[1]+"}":"")+(b[2]?",\n\tctx:{"+b[2]+"}":"")}function r(b,a,c){var d,e,f,g,h,r=0,k=c?c.links:a&&(a.links=
a.links||{}),l={},D={0:-1},u=0;return(b+(c?" ":"")).replace(/\)\^/g,").").replace(Ga,function(m,K,t,s,z,p,G,n,C,q,w,x,F,y,E,A,ha,ua,ka,Ka){function Oa(b,c,g,A,ha,h,ua,ka){return g&&(a&&("linkTo"===d&&(e=a._jsvto=a._jsvto||[],e.push(z)),d&&!f||a.push(z.slice(c.length))),"."!==g)?(b=(A?'view.hlp("'+A+'")':ha?"view":"data")+(ka?(h?"."+h:A?"":ha?"":"."+g)+(ua||""):(ka=A?"":ha?h||"":g,"")),b+=ka?"."+ka:"",c+("view.data"===b.slice(0,9)?b.slice(5):b)):b}p=p||"";t=t||K||x;z=z||C;q=q||ha||"";if(!G||h||g)return!a||
!A||h||g||d&&!f&&!e||(A=D[u],Ka.length-1>ka-A&&(A=Ka.slice(A,ka+1),A=T+":"+A+M,G=k[A],G||(k[A]=1,k[A]=G=Fa(A,c||a,!0),G.paths.push({_jsvOb:G})),1!==G&&(e||a).push({_jsvOb:G}))),h?(h=!F,h?m:'"'):g?(g=!y,g?m:'"'):(t?(u++,D[u]=ka++,t):"")+(ua?u?"":(r=Ka.slice(r,ka),d?(d=f=e=!1,"\b"):"\b,")+r+(r=ka+m.length,"\b"):n?(u&&ga(b),d=z,f=s,r=ka+m.length,z+":"):z?z.split("^").join(".").replace(W,Oa)+(q?(l[++u]=!0,"."!==z.charAt(0)&&(D[u]=ka),q):p):p?p:E?(l[u--]=!1,E)+(q?(l[++u]=!0,q):""):w?(l[u]||ga(b),","):
K?"":(h=F,g=y,'"'));ga(b)})}function D(b,a,d){var e,f,g,h,r,k,l,u,m,K,t,s,z,p,G,n,q,C,w,x,F,y,E,M,I=0,A="",ha={},ua=b.length;""+a===a?(G=d?'data-link="'+a.replace(ja," ").slice(1,-1)+'"':a,a=0):(G=a.tmplName||"unnamed",a.allowCode&&(ha.allowCode=!0),a.debug&&(ha.debug=!0),t=a.bnds,p=a.tmpls);for(e=0;e<ua;e++)if(f=b[e],""+f===f)A+='\n+"'+f+'"';else if(g=f[0],"*"===g)A+=";\n"+f[1]+"\nret=ret";else{h=f[1];C=f[2];r=Ia(f[3],"params")+"},"+Ia(z=f[4]);E=f[5];M=f[6];w=f[8];(F="else"===g)||(I=0,t&&(s=f[7])&&
(I=t.push(s)));(f=":"===g)?h&&(g=h===L?">":h+g):(C&&(n=Ma(w,ha),n.tmplName=G+"/"+g,D(C,n),p.push(n)),F||(q=g,x=A,A=""),n=(n=b[e+1])&&"else"===n[0]);F=E?";\ntry{\nret+=":"\n+";if(f&&(s||M||h&&h!==L)){y="return {"+r+"};";E&&(y="try {\n"+y+"\n}catch(e){return {error: j._err(e,view,"+E+")}}\n");y=new Function("data,view,j,u"," // "+G+" "+I+" "+g+"\n"+y);y.paths=s;y._tag=g;if(d)return y;K=1}A+=f?(d?(E?"\ntry{\n":"")+"return ":F)+(K?(K=0,m=u=!0,'c("'+h+'",view,'+(s?(t[I-1]=y,I):"{"+r+"}")+")"):">"===g?
(l=!0,"h("+z[0]+")"):"((v="+z[0]+')!=null?v:"")'):(m=k=!0,"\n{view:view,tmpl:"+(C?p.length:"0")+","+r+"},");if(q&&!n){A="["+A.slice(0,-1)+"]";if(d||s)if(A=new Function("data,view,j,u"," // "+G+" "+I+" "+q+"\nreturn "+A+";"),s&&((t[I-1]=A).paths=s),A._tag=g,d)return A;A=x+F+'t("'+q+'",view,this,'+(I||A)+")";q=s=0}E&&(m=!0,A+=";\n}catch(e){ret"+(d?"urn ":"+=")+"j._err(e,view,"+E+");}\n"+(d?"":"ret=ret"))}A="// "+G+"\nj=j||"+(c?"jQuery.":"jsviews.")+"views;var v"+(k?",t=j._tag":"")+(u?",c=j._cnvt":"")+
(l?",h=j.converters.html":"")+(d?";\n":',ret=""\n')+(ha.debug?"debugger;":"")+A+(d?"\n":";\nreturn ret;");try{A=new Function("data,view,j,u",A)}catch(ka){ga("Compiled template code:\n\n"+A+'\n: "'+ka.message+'"')}a&&(a.fn=A);m||(A._nvw=!0);return A}function K(b,a){return b&&b!==a?a?h(h({},a),b):b:a&&h({},a)}function u(b){return ea[b]||(ea[b]="&#"+b.charCodeAt(0)+";")}function z(b){var a,c,d=[];if("object"===typeof b)for(a in b)(c=b[a])&&c.toJSON&&!c.toJSON()||m(c)||d.push({key:a,prop:c});return d}
function G(b){return null!=b?fa.test(b)&&(""+b).replace(va,u)||b:""}if(!(c&&c.render||e.jsviews)){var s,t,C,pa,ca,x="{",T="{",M="}",I="}",N="^",W=/^(!*?)(?:null|true|false|\d[\d.]*|([\w$]+|\.|~([\w$]+)|#(view|([\w$]+))?)([\w$.^]*?)(?:[.[^]([\w$]+)\]?)?)$/g,Ga=/(\()(?=\s*\()|(?:([([])\s*)?(?:(\^?)(!*?[#~]?[\w$.^]+)?\s*((\+\+|--)|\+|-|&&|\|\||===|!==|==|!=|<=|>=|[<>%*:?\/]|(=))\s*|(!*?[#~]?[\w$.^]+)([([])?)|(,\s*)|(\(?)\\?(?:(')|("))|(?:\s*(([)\]])(?=\s*\.|\s*\^|\s*$)|[)\]])([([]?))|(\s+)/g,ja=/[ \t]*(\r\n|\n|\r)/g,
ia=/\\(['"])/g,y=/['"\\]/g,H=/(?:\x08|^)(onerror:)?(?:(~?)(([\w$]+):)?([^\x08]+))\x08(,)?([^\x08]+)/gi,R=/^if\s/,da=/<(\w+)[>\s]/,fa=/[\x00`><\"'&]/,Na=/^on[A-Z]|^convert(Back)?$/,va=/[\x00`><"'&]/g,X=0,La=0,ea={"&":"&amp;","<":"&lt;",">":"&gt;","\x00":"&#0;","'":"&#39;",'"':"&#34;","`":"&#96;"},L="html",Q="data-jsv-tmpl",w={},O={template:{compile:ma},tag:{compile:ba},helper:{},converter:{}},F={jsviews:"v1.0.0-beta",settings:function(b){h(xa,b);d(xa._dbgMode);xa.jsv&&xa.jsv()},sub:{View:aa,Err:g,
tmplFn:Fa,cvt:q,parse:r,extend:h,syntaxErr:ga,onStore:{},_lnk:a},map:oa,_cnvt:n,_tag:l,_err:la};(g.prototype=Error()).constructor=g;S.depends=function(){return[this.get("item"),"index"]};Y.depends=function(){return["index"]};aa.prototype={get:Ja,getIndex:Y,getRsc:p,hlp:Z,_is:"view"};for(t in O)qa(t,O[t]);var Da=F.templates,na=F.converters,Ha=F.helpers,Ba=F.tags,P=F.sub,xa=F.settings;c?(s=c,s.fn.render=ra,s.observable&&(h(P,s.views.sub),F.map=s.views.map)):(s=e.jsviews={},s.isArray=Array&&Array.isArray||
function(b){return"[object Array]"===Object.prototype.toString.call(b)});s.render=w;s.views=F;s.templates=Da=F.templates;xa({debugMode:d,delimiters:sa,onError:function(a,c,d){c&&(a=d===b?"{Error: "+a+"}":m(d)?d(a,c):d);return a==b?"":a},_dbgMode:!0});Ba({"else":function(){},"if":{render:function(b){return this.rendering.done||!b&&(arguments.length||!this.tagCtx.index)?"":(this.rendering.done=!0,this.selected=this.tagCtx.index,this.tagCtx.render(this.tagCtx.view,!0))},onUpdate:function(b,a,c){var d;
for(b=0;(d=this.tagCtxs[b])&&d.args.length;b++)if(d=d.args[0],a=!d!==!c[b].args[0],!this.convert&&d||a)return a;return!1},flow:!0},"for":{render:function(a){var c,d=this.tagCtx,e="",f=0;if(!this.rendering.done){if(c=!arguments.length)a=d.view.data;a!==b&&(e+=d.render(a,c),f+=s.isArray(a)?a.length:1);if(this.rendering.done=f)this.selected=d.index}return e},flow:!0},include:{flow:!0},"*":{render:a,flow:!0}});Ba("props",{baseTag:Ba["for"],dataMap:oa(z)});na({html:G,attr:G,url:function(a){return a!=b?
encodeURI(""+a):null===a?a:""}});sa()}})(this,this.jQuery);(function(e,c,b){function a(b){return E(b)?new d(b):new f(b)}function f(b){this._data=b;return this}function d(b){this._data=b;return this}function g(b,a){b=E(b)?b:[b];var c,d,e=a,f=e,h=b.length,k=[];for(c=0;c<h;c++)d=b[c],V(d)?k=k.concat(g(d.call(a,a),a)):""+d!==d?(a=f=d,f!==e&&k.push(e=f)):(f!==e&&k.push(e=f),k.push(d));return k}function h(b,a){var c,d;for(c in b){d=!0;break}d||delete ya[a]}function m(a,c){if(!a.data||!a.data.off){var d,
...
(this.obs&&c.observable(this.src).unobserveAll(this.obs,this.srcFlt),this.obt&&c.observable(this.tgt).unobserveAll(this.obt,this.tgtFlt),this.src=b)},map:e,_def:d}).constructor=e;V(d)&&(d={getTgt:d});d.baseMap&&(d=c.extend({},d.baseMap,d));d.map=function(b,a,c){return new e(b,a,c)};return d}}})(this,this.jQuery);(function(e,c,b){function a(a,d,e){var f,g,h,k,l,p,n,q,r,B=a.target,s=B._jsvBnd,v=/&(\d+)\+?/g;if(s)for(;h=v.exec(s);)if(h=Ca[h[1]])if(d=h.to){h=h.linkCtx;n=h.view;r=h.tag;p=c(B);l=n.hlp(O);
q=n.hlp(F);g=m(B);f=Ra[g];e===b&&(e=fa(g)?g(B):f?p[f]():p.attr(g));f=d[1];d=d[0];f&&(k=fa(f)?f:n.getRsc("converters",f));k&&(e=k.call(r,e));f=n.linkCtx;n.linkCtx=h;g={change:"change",oldValue:h._val,value:e};if(!(l&&!1===l.call(h,a,g)||r&&r.onBeforeChange&&!1===r.onBeforeChange(a,g)||e===b)&&(l=d[0],e!==b&&l)){l=l._jsvOb?l._ob:l;r&&(r._.chging=!0);X(l).setProperty(d[2]||d[1],e);q&&q.call(h,a,g);if(r){if(r.onAfterChange)r.onAfterChange(a,g);delete r._.chging}h._val=e}n.linkCtx=f}}function f(a,e,f){var g,
h,k,l=this.data,p=this.elem,n=this.convert;h=p.parentNode;var r=this.view,q=r.linkCtx,s=r.hlp(O);r.linkCtx=this;if(h&&!(s&&e&&!1===s.call(this,a,e)||e&&"*"!==a.data.prop&&a.data.prop!==e.path)){e&&(this.eventArgs=e);if(e||this._initVal){delete this._initVal;h=f.call(r.tmpl,l,r,y);a:{var B=h,t=k=this.tag;g=this.attr||m(p,!0,n!==b);var v,u,w=t&&t.parentElem||this.elem;if(B!==b){u=c(w);g=t&&t.attr||g;fa(B)&&T(this.expr+": missing parens");"visible"===g&&(g="css-display");if(t=/^css-/.test(g)&&g.slice(4))v=
c.style(w,t),+B===B&&(v=parseInt(v));else if("link"!==g){if("value"===g)w.type===Ha&&(v=u.prop(g=na));else if(g===Ba)if(w.value===""+B)v=u.prop(na);else break a;v===b&&(v=(v=Ra[g])?u[v]():u.attr(g))}this._val=v}}if(h&&h.error!==b)h=h.error;else if(k){h=h[0]?h:[h];f=e&&k.onUpdate&&!1===k.onUpdate(a,e,h);ya(k,h);if(f||g===P){g===U&&k.onBeforeLink&&k.onBeforeLink();oa(k,k.tagCtx);S(this,l,p);r.linkCtx=q;return}if(k._.chging)return;h=":"===k.tagName?y._cnvt(k.cvt,r,h[0]):y._tag(k,r,r.tmpl,h,!0)}else f._tag&&
(h=(n=""===n?xa:n)?y._cnvt(n,r,h):y._tag(f._tag,r,r.tmpl,h,!0),k=this.tag,g=this.attr||g);d(h,this,g,k)&&e&&(s=r.hlp(F))&&s.call(this,a,e);k&&oa(k,k.tagCtx)}S(this,l,p);r.linkCtx=q}}function d(a,d,f,g){var h,l,m,p,n,q,s=a!==b,t=d.data,B=g&&g.parentElem||d.elem,u=c(B),v=d.view;q=d._val;var w=v.ctx,y=v.linkCtx,x=g||f===U;g&&(g.parentElem=g.parentElem||d.expr||g._elCnt?B:B.parentNode,l=g._prv,m=g._nxt);if(s){if(/^css-/.test(f))"visible"===d.attr&&(d=(B.currentStyle||eb.call(e,B,"")).display,a?(a=B._jsvd||
d,a!==P||(a=bb[h=B.nodeName])||(d=ia.createElement(h),ia.body.appendChild(d),a=bb[h]=(d.currentStyle||eb.call(e,d,"")).display,ia.body.removeChild(d))):(B._jsvd=d,a=P)),(x=x||q!==a)&&c.style(B,f.slice(4),a);else if("link"!==f){if(f===na)n=1,a=a&&"false"!==a;else if(f===Ba)if(B.value===""+a)a=!0,n=1,f=na;else{S(d,t,B);return}else if("selected"===f||"disabled"===f||"multiple"===f||"readonly"===f)a=a&&"false"!==a?f:null;if(h=Ra[f])if(f===U){v.linkCtx=d;v.ctx=d.ctx;if(g&&g._.inline){f=g.nodes(!0);if(g._elCnt){if(l&&
...
f&&B.children&&!B.children[0])B.textContent!==b?B.textContent=a:B.innerText=null===a?"":a;else u[h](a)}else if(x=x||q!==a)u[n?"prop":"attr"](f,a!==b||n?a:null);d._val=a}return p||x}if(f===U&&g&&g.onBeforeLink)g.onBeforeLink()}function g(b,a){var c=this.hlp(O),d=this.hlp(F);if(!c||!1!==c.call(this,b,a)){if(a){var c=a.index,e=a.items;switch(a.change){case "insert":this.addViews(c,e);break;case "remove":this.removeViews(c,e.length);break;case "move":this.refresh();break;case "refresh":this.refresh()}}d&&
...
[];e&&d.link(b,this.parentElem,f?e.previousSibling:e,this._nxt,b,{get:{tags:g,deep:a,name:c,id:f&&this._tgId}});return g},refresh:function(a){var c,e=this.linkCtx,f=this.tagCtx.view;this.disposed&&T("Removed tag");a===b&&(a=y._tag(this,f,f.tmpl,ya(this),!0));a+""===a&&(c=this._.inline?U:e.attr||m(this.parentElem,!0),c=d(a,e,c,this));oa(this,this.tagCtx);return c||this},update:function(c){var d=this.linkedElem;d&&a({target:d[0]},b,c)}},H.onStore.template=function(a,b){b.link=Y;b.unlink=ga;a&&(c.link[a]=
