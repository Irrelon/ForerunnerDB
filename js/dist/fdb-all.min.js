...
var a=[],d;for(d=0;d<this._collections.length;d++)a=a.concat(this._collections[d].find(this._query,this._queryOptions));this._collData.setData(a)}this._reduce&&(a=this._reduce(),this._data.setData(a))};b.prototype._chainHandler=function(a,d,b,h){switch(d){case "setData":case "insert":case "update":case "remove":this._refresh()}};b.prototype.link=function(a,d){this._data.link.apply(this._data,arguments);this._refresh()};b.prototype.unlink=function(a,d){this._data.unlink.apply(this._data,arguments);
this._refresh()};e.prototype.init=function(){this._overview={};h.apply(this,arguments)};e.prototype.overview=function(a){return a?(this._overview[a]=this._overview[a]||(new b(a)).db(this),this._overview[a]):this._overview};m.exports=b},{"./Collection":2,"./Document":6,"./Shared":15}],13:[function(e,m,k){e=e("./Shared");k=function(h){this.init.apply(this,arguments)};k.prototype.init=function(h){h&&this.path(h)};e.addModule("Path",k);e.inherit(k.prototype,e.chainSystem);k.prototype.path=function(h){return void 0!==
h?(this._path=this.clean(h),this._pathParts=this._path.split("."),this):this._path};k.prototype.hasObjectPaths=function(h,a){var d=!0,b;for(b in h)if(h.hasOwnProperty(b)&&(void 0===a[b]||"object"===typeof h[b]&&(d=this.hasObjectPaths(h[b],a[b]),!d)))return!1;return d};k.prototype.countKeys=function(h){var a=0,d;for(d in h)h.hasOwnProperty(d)&&void 0!==h[d]&&("object"!==typeof h[d]?a++:a+=this.countKeys(h[d]));return a};k.prototype.countObjectPaths=function(h,a){var d,b={},c=0,f=0,g;for(g in a)a.hasOwnProperty(g)&&
("object"===typeof a[g]?(d=this.countObjectPaths(h[g],a[g]),b[g]=d.matchedKeys,f+=d.totalKeyCount,c+=d.matchedKeyCount):(f++,h&&h[g]&&"object"!==typeof h[g]?(b[g]=!0,c++):b[g]=!1));return{matchedKeys:b,matchedKeyCount:c,totalKeyCount:f}};k.prototype.parse=function(h,a){var d=[],b="",c,f,g;for(f in h)if(h.hasOwnProperty(f))if(b=f,"object"===typeof h[f])if(a)for(c=this.parse(h[f],a),g=0;g<c.length;g++)d.push({path:b+"."+c[g].path,value:c[g].value});else for(c=this.parse(h[f]),g=0;g<c.length;g++)d.push({path:b+
"."+c[g].path});else a?d.push({path:b,value:h[f]}):d.push({path:b});return d};k.prototype.parseArr=function(h,a){a=a||{};return this._parseArr(h,"",[],a)};k.prototype._parseArr=function(h,a,d,b){var c,f="";a=a||"";d=d||[];for(c in h)h.hasOwnProperty(c)&&(!b.ignore||b.ignore&&!b.ignore.test(c))&&(f=a?a+"."+c:c,"object"===typeof h[c]?this._parseArr(h[c],f,d,b):d.push(f));return d};k.prototype.value=function(h,a){if(void 0!==h&&"object"===typeof h){var d,b,c,f,g=[],e;void 0!==a&&(a=this.clean(a),d=a.split("."));
d=d||this._pathParts;b=d.length;c=h;for(e=0;e<b;e++){c=c[d[e]];if(f instanceof Array){for(b=0;b<f.length;b++)g=g.concat(this.value(f,b+"."+d[e]));return g}if(!c||"object"!==typeof c)break;f=c}return[c]}return[]};k.prototype.set=function(e,a,d){if(void 0!==e&&void 0!==a){var b;a=this.clean(a);a=a.split(".");b=a.shift();a.length?(e[b]=e[b]||{},this.set(e[b],a.join("."),d)):e[b]=d}return e};k.prototype.get=function(e,a){return this.value(e,a)[0]};k.prototype.push=function(e,a,d){if(void 0!==e&&void 0!==
a){var b;a=this.clean(a);a=a.split(".");b=a.shift();if(a.length)e[b]=e[b]||{},this.set(e[b],a.join("."),d);else if(e[b]=e[b]||[],e[b]instanceof Array)e[b].push(d);else throw"Cannot push to a path whose endpoint is not an array!";}return e};k.prototype.keyValue=function(e,a){var d,b,c,f,g;void 0!==a&&(a=this.clean(a),d=a.split("."));d=d||this._pathParts;b=d.length;c=e;for(g=0;g<b;g++)if(c=c[d[g]],!c||"object"!==typeof c){f=d[g]+":"+c;break}return f};k.prototype.clean=function(e){"."===e.substr(0,1)&&
(e=e.substr(1,e.length-1));return e};m.exports=k},{"./Shared":15}],14:[function(e,m,k){k=e("./Shared");var h,a,d,b;b=function(){this.init.apply(this,arguments)};b.prototype.init=function(a){a.isClient()&&void 0!==Storage&&this.mode("localStorage")};k.addModule("Persist",b);k.inherit(b.prototype,k.chainSystem);k=k.modules.Core;h=e("./Collection");a=h.prototype.drop;e("./CollectionGroup");d=k.prototype.init;b.prototype.mode=function(a){return void 0!==a?(this._mode=a,this):this._mode};b.prototype.save=
...
b[1]}if(d)d(!1,e);else return e}break;default:if(d)d("No data handler or unrecognised data type.");else throw"No data handler or unrecognised data type.";}};b.prototype.drop=function(a,d){switch(this.mode()){case "localStorage":try{localStorage.removeItem(a)}catch(b){d&&d(b)}d&&d(!1);break;default:d&&d("No data handler or unrecognised data type.")}};h.prototype.drop=function(c){if(c)if(this._name)if(this._db)this._db.persist.drop(this._name);else return callback&&callback("Cannot drop a collection's persistent storage when the collection is not attached to a database!"),
"Cannot drop a collection's persistent storage when the collection is not attached to a database!";else return callback&&callback("Cannot drop a collection's persistent storage when no name assigned to collection!"),"Cannot drop a collection's persistent storage when no name assigned to collection!";a.apply(this)};h.prototype.save=function(a){if(this._name)if(this._db)this._db.persist.save(this._name,this._data,a);else return a&&a("Cannot save a collection that is not attached to a database!"),"Cannot save a collection that is not attached to a database!";
...
k.prototype.init=function(){this.persist=new b(this);d.apply(this,arguments)};m.exports=b},{"./Collection":2,"./CollectionGroup":3,"./Shared":15}],15:[function(e,m,k){var h=0;e=function(a){if(a){var d,b=a.length;return function(){for(d=0;d<b;d++)if(a[d].length===arguments.length)return a[d].apply(this,arguments);return null}}return function(){}};e={modules:{},common:{decouple:function(a){return JSON.parse(JSON.stringify(a))},objectId:function(a){var d=Math.pow(10,17);if(a){var b=0,c=a.length,f;for(f=
0;f<c;f++)b+=a.charCodeAt(f)*d;a=b.toString(16)}else h++,a=(h+(Math.random()*d+Math.random()*d+Math.random()*d+Math.random()*d)).toString(16);return a},debug:new e([function(){return this._debug&&this._debug.all},function(a){return void 0!==a?"boolean"===typeof a?(this._debug=this._debug||{},this._debug.all=a,this.chainSend("debug",this._debug),this):this._debug&&this._debug[a]||this._db&&this._db._debug&&this._db._debug[a]||this._debug&&this._debug.all:this._debug&&this._debug.all},function(a,d){return void 0!==
a?void 0!==d?(this._debug=this._debug||{},this._debug[a]=d,this.chainSend("debug",this._debug),this):this._debug&&this._debug[d]||this._db&&this._db._debug&&this._db._debug[a]:this._debug&&this._debug.all}]),on:new e([function(a,d){this._listeners=this._listeners||{};this._listeners[a]=this._listeners[a]||{};this._listeners[a]["*"]=this._listeners[a]["*"]||[];this._listeners[a]["*"].push(d);return this},function(a,d,b){this._listeners=this._listeners||{};this._listeners[a]=this._listeners[a]||{};
this._listeners[a][d]=this._listeners[a][d]||[];this._listeners[a][d].push(b);return this}]),off:new e([function(a){this._listeners&&this._listeners[a]&&a in this._listeners&&delete this._listeners[a];return this},function(a,d){var b,c;"string"===typeof d?this._listeners&&this._listeners[a]&&this._listeners[a][d]&&delete this._listeners[a][d]:a in this._listeners&&(b=this._listeners[a]["*"],c=b.indexOf(d),-1<c&&b.splice(c,1));return this},function(a,d,b){this._listeners&&a in this._listeners&&(a=
this._listeners[a][d],b=a.indexOf(b),-1<b&&a.splice(b,1))}]),emit:function(a,d){this._listeners=this._listeners||{};if(a in this._listeners){if(this._listeners[a]["*"]){var b=this._listeners[a]["*"],c=b.length,f;for(f=0;f<c;f++)b[f].apply(this,Array.prototype.slice.call(arguments,1))}if(d instanceof Array&&d[0]&&d[0][this._primaryKey]){var b=this._listeners[a],g,e,c=d.length;for(f=0;f<c;f++)if(b[d[f][this._primaryKey]])for(g=b[d[f][this._primaryKey]].length,e=0;e<g;e++)b[d[f][this._primaryKey]][e].apply(this,
Array.prototype.slice.call(arguments,1))}}return this}},_synth:{},addModule:function(a,d){this.modules[a]=d},inherit:function(a,d){for(var b in d)d.hasOwnProperty(b)&&(a[b]=d[b])},synthesize:function(a,d,b){this._synth[d]=this._synth[d]||function(a){return void 0!==a?(this["_"+d]=a,this):this["_"+d]};if(b){var c=this;a[d]=function(){var a=this.$super,g;this.$super=c._synth[d];g=b.apply(this,arguments);this.$super=a;return g}}else a[d]=this._synth[d]},overload:e,chainSystem:{chain:function(a){this._chain=
this._chain||[];-1===this._chain.indexOf(a)&&this._chain.push(a)},unChain:function(a){this._chain&&(a=this._chain.indexOf(a),-1<a&&this._chain.splice(a,1))},chainSend:function(a,d,b){if(this._chain){var c=this._chain,f=c.length,g;for(g=0;g<f;g++)c[g].chainReceive(this,a,d,b)}},chainReceive:function(a,d,b,c){(!this._chainHandler||this._chainHandler&&!this._chainHandler(a,d,b,c))&&this.chainSend(d,b,c)}}};m.exports=e},{}],16:[function(e,m,k){var h,a,d;k=e("./Shared");var b=function(a,d,b){this.init.apply(this,
