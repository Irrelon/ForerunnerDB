...
data:d})));f.stop();return d||[]};e.prototype.updateById=function(g,b){var a={};a[this._primaryKey]=g;return this.update(a,b)};e.prototype._updateObject=function(g,a,e,f,c,k){a=this.decouple(a);c=c||"";"."===c.substr(0,1)&&(c=c.substr(1,c.length-1));var d=!1,h=!1,n,q,p,l;for(l in a)if(a.hasOwnProperty(l)){n=!1;if("$"===l.substr(0,1))switch(l){case "$index":break;default:n=!0,(h=this._updateObject(g,a[l],e,f,c,l))&&(d=!0)}if(this._isPositionalKey(l)&&(n=!0,l=l.substr(0,l.length-2),h=new b(c+"."+l),
g[l]&&g[l]instanceof Array&&g[l].length)){q=[];for(p=0;p<g[l].length;p++)this._match(g[l][p],h.value(e)[0])&&q.push(p);for(p=0;p<q.length;p++)(h=this._updateObject(g[l][q[p]],a[l+".$"],e,f,c+"."+l,k))&&(d=!0)}if(!n)if(k||"object"!==typeof a[l])switch(k){case "$inc":this._updateIncrement(g,l,a[l]);d=!0;break;case "$push":void 0===g[l]&&(g[l]=[]);if(g[l]instanceof Array){if(void 0!==a[l].$position&&a[l].$each instanceof Array)for(h=a[l].$position,n=a[l].$each.length,p=0;p<n;p++)this._updateSplicePush(g[l],
...
function(b,a,c){void 0!==b&&(this._querySettings.query=b);void 0!==a&&(this._querySettings.options=a);return void 0!==b||void 0!==a?(void 0!==c&&!0!==c||this.refresh(),this):this._querySettings};f.prototype.queryAdd=function(b,a,c){var d=this._querySettings.query,f;if(void 0!==b)for(f in b)b.hasOwnProperty(f)&&(void 0===d[f]||void 0!==d[f]&&a)&&(d[f]=b[f]);void 0!==c&&!0!==c||this.refresh()};f.prototype.queryRemove=function(b,a){var c=this._querySettings.query,d;if(void 0!==b)for(d in b)b.hasOwnProperty(d)&&
...
function(b){return Boolean(this._views[b])};h.prototype.views=function(){var b=[],a;for(a in this._views)this._views.hasOwnProperty(a)&&b.push({name:a,count:this._views[a].count()});return b};m.exports=f},{"./Collection":3,"./CollectionGroup":4,"./ReactorIO":16,"./Shared":17}],19:[function(h,m,d){window.jQuery&&(this.jQuery=window.jQuery,function(){(function(d,c,b){function a(b){return b}function f(b){debugger;return b}function e(b){ca=(xa._dbgMode=b)?"Unavailable (nested view): use #getIndex()":
"";Ba("dbg",Ha.dbg=na.dbg=b?f:a)}function g(b){this.name=(s.link?"JsViews":"JsRender")+" Error";this.message=b||this.name}function h(b,a){for(var c in a)b[c]=a[c];return b}function m(b){return"function"===typeof b}function sa(b,a,c){if(!P.rTag||b)x=b?b.charAt(0):x,T=b?b.charAt(1):T,M=a?a.charAt(0):M,I=a?a.charAt(1):I,N=c||N,b="\\"+x+"(\\"+N+")?\\"+T,a="\\"+M+"\\"+I,C="(?:(?:(\\w+(?=[\\/\\s\\"+M+"]))|(?:(\\w+)?(:)|(>)|!--((?:[^-]|-(?!-))*)--|(\\*)))\\s*((?:[^\\"+M+"]|\\"+M+"(?!\\"+I+"))*?)",P.rTag=
C+")",C=RegExp(b+C+"(\\/)?|(?:\\/(\\w+)))"+a,"g"),pa=RegExp("<.*>|([^\\\\]|^)[{}]|"+b+".*"+a);return[x,T,M,I,N]}function Ja(a,c){c||(c=a,a=b);var d,e,f,g;f=this;d=!c||"root"===c;if(a){if(g=f.type===c?f:b,!g)if(d=f.views,f._.useKey)for(e in d){if(g=d[e].get(a,c))break}else for(e=0,f=d.length;!g&&e<f;e++)g=d[e].get(a,c)}else if(d)for(;f.parent.parent;)g=f=f.parent;else for(;f&&!g;)g=f.type===c?f:b,f=f.parent;return g}function S(){var a=this.get("item");return a?a.index:b}function Y(){return this.index}
function Z(a){var c,e=this,f=e.linkCtx,g=(e.ctx||{})[a];g===b&&f&&f.ctx&&(g=f.ctx[a]);g===b&&(g=Ha[a]);g&&m(g)&&!g._wrp&&(c=function(){return g.apply(this&&this!==d?this:e,arguments)},c._wrp=1,h(c,g));return c||g}function n(a,c,d){var e,f,g=+d===d&&d,h=c.linkCtx;g&&(d=(g=c.tmpl.bnds[g-1])(c.data,c,F));e=d.args[0];if(a||g){e=h&&h.tag;e||(e={_:{inline:!h,bnd:g},tagName:":",cvt:a,flow:!0,tagCtx:d,_is:"tag"},h&&(h.tag=e,e.linkCtx=h,d.ctx=K(d.ctx,h.view.ctx)),P._lnk(e));for(f in d.props)Na.test(f)&&(e[f]=
...
F[a][c]}function l(a,c,d,e,f){var g,k,r,l,D,m,u,t,s,p,z,G="",n=+e===e&&e,C=c.linkCtx||0,w=c.ctx,x=d||c.tmpl;"tag"===a._is&&(g=a,a=g.tagName,e=g.tagCtxs);g=g||C.tag;n&&(e=(t=x.bnds[n-1])(c.data,c,F));m=e.length;for(D=0;D<m;D++){D||d&&g||(s=c.getRsc("tags",a)||la("Unknown tag: {{"+a+"}}"));k=e[D];C.tag||(u=k.tmpl,u=k.content=u&&x.tmpls[u-1],h(k,{tmpl:(g?g:s).template||u,render:V,index:D,view:c,ctx:K(k.ctx,w)}));if(d=k.props.tmpl)d=""+d===d?c.getRsc("templates",d)||Da(d):d,k.tmpl=d;g||(s._ctr?(g=new s._ctr,
p=!!g.init,g.attr=g.attr||s.attr||b):P._lnk(g={render:s.render}),g._={inline:!C},C&&(C.attr=g.attr=C.attr||g.attr,C.tag=g,g.linkCtx=C),(g._.bnd=t||C.fn)?g._.arrVws={}:g.dataBoundOnly&&la("{^{"+a+"}} tag must be data-bound"),g.tagName=a,g.parent=l=w&&w.tag,g._is="tag",g._def=s,g.tagCtxs=e);if(!D)for(z in u=k.props)Na.test(z)&&(g[z]=u[z]);k.tag=g;g.dataMap&&g.tagCtxs&&(k.map=g.tagCtxs[D].map);g.flow||(u=k.ctx=k.ctx||{},k=g.parents=u.parentTags=w&&K(u.parentTags,w.parentTags)||{},l&&(k[l.tagName]=l),
u.tag=g)}c._.tag=g;g.rendering={};for(D=0;D<m;D++){k=g.tagCtx=g.tagCtxs[D];u=k.props;a=q(g,g.convert);if(e=u.dataMap||g.dataMap)if(a.length||u.dataMap){l=k.map;if(!l||l.src!==a[0]||f)l&&l.src&&l.unmap(),l=k.map=e.map(a[0],u);a=[l.tgt]}g.ctx=k.ctx;!D&&p&&(e=g.template,g.init(k,C,g.ctx),p=b,g.template!==e&&(g._.tmpl=g.template));l=b;if(e=g.render)l=e.apply(g,a);a=a.length?a:[c];l=l!==b?l:k.render(a[0],!0)||(f?b:"");G=G?G+(l||""):l}delete g.rendering;g.tagCtx=g.tagCtxs[0];g.ctx=g.tagCtx.ctx;g._.inline&&
(r=g.attr)&&r!==L&&(G="text"===r?na.html(G):"");return n&&c._.onRender?c._.onRender(G,c,n):G}function aa(b,a,c,d,e,f,g,h){var k="array"===a,r={key:0,useKey:k?0:1,id:""+La++,onRender:h,bnds:{}};this.data=d;this.tmpl=e;this.content=g;this.views=k?[]:{};this.parent=c;this.type=a;this._=r;this.linked=!!h;c?(a=c.views,d=c._,d.useKey?(a[r.key="_"+d.useKey++]=this,this.index=ca,this.getIndex=S,f=d.tag,r.bnd=k&&(!f||!!f._.bnd&&f)):a.splice(r.key=this.index=f,0,this),this.ctx=b||c.ctx):this.ctx=b}function E(b){var a,
c,d,e,f,g;for(a in O)if(e=O[a],(f=e.compile)&&(c=b[a+"s"]))for(d in c)(e=c[d]=f(d,c[d],b))&&(g=P.onStore[a])&&g(d,e,f)}function ba(a,c,d){m(c)?c={depends:c.depends,render:c}:(c.baseTag&&(c.flow=!!c.flow,c=h(h({},c.baseTag),c)),(a=c.template)!==b&&(c.template=""+a===a?Da[a]||Da(a):a),!1!==c.init&&(a=c._ctr=function(){},(a.prototype=c).constructor=a));d&&(c._parentTmpl=d);return c}function ma(a,e,f,g){function h(e){if(""+e===e||0<e.nodeType){try{l=0<e.nodeType?e:!pa.test(e)&&c&&c(d.document).find(e)[0]}catch(r){}l&&
(e=Da[a=a||l.getAttribute(Q)],e||(a=a||"_"+X++,l.setAttribute(Q,a),e=Da[a]=ma(a,l.innerHTML,f,g)),l=b);return e}}var r,l;e=e||"";r=h(e);g=g||(e.markup?e:{});g.tmplName=a;f&&(g._parentTmpl=f);!r&&e.markup&&(r=h(e.markup))&&r.fn&&(r.debug!==e.debug||r.allowCode!==e.allowCode)&&(r=r.markup);if(r!==b)return a&&!f&&(w[a]=function(){return e.render.apply(e,arguments)}),r.fn||e.fn?r.fn&&(e=a&&a!==r.tmplName?K(g,r):r):(e=Ma(r,g),Fa(r.replace(y,"\\$&"),e)),E(g),e}function oa(b){function a(c,e){this.tgt=b.getTgt(c,
e)}m(b)&&(b={getTgt:b});b.baseMap&&(b=h(h({},b.baseMap),b));b.map=function(b,c){return new a(b,c)};return b}function Ma(b,a){var c,e=xa.wrapMap||{},d=h({markup:b,tmpls:[],links:{},tags:{},bnds:[],_is:"template",render:ta},a);a.htmlTag||(c=da.exec(b),d.htmlTag=c?c[1].toLowerCase():"");(c=e[d.htmlTag])&&c!==e.div&&(d.markup=s.trim(d.markup));return d}function qa(a,c){function e(f,g,h){var k,r,l;if(f&&"object"===typeof f&&!f.nodeType&&!f.markup&&!f.getTgt){for(r in f)e(r,f[r],g);return F}g===b&&(g=f,
f=b);f&&""+f!==f&&(h=g,g=f,f=b);l=h?h[d]=h[d]||{}:e;r=c.compile;null===g?f&&delete l[f]:(g=r?g=r(f,g,h):g,f&&(l[f]=g));r&&g&&(g._is=a);g&&(k=P.onStore[a])&&k(f,g,r);return g}var d=a+"s";F[d]=e;O[a]=c}function ra(b,a){var c=this.jquery&&(this[0]||la('Unknown template: "'+this.selector+'"')),e=c.getAttribute(Q);return ta.call(e?Da[e]:Da(c),b,a)}function ya(b,a,c){if(xa._dbgMode)try{return b.fn(a,c,F)}catch(e){return la(e,c)}return b.fn(a,c,F)}function ta(b,a,c,e,d,f){return e||!this.fn._nvw||s.isArray(b)?
V.call(this,b,a,c,e,d,f):ya(this,b,{tmpl:this})}function V(a,c,e,d,f,g){var h,k,r,l,D,u,m,t,p;r=this;var z="";!!c===c&&(e=c,c=b);!0===f&&(h=!0,f=0);r.tag?(u=r,r=r.tag,k=r._,D=r.tagName,t=k.tmpl||u.tmpl,p=r.attr&&r.attr!==L,c=K(c,r.ctx),m=u.content,!1===u.props.link&&(c=c||{},c.link=!1),d=d||u.view,a=arguments.length?a:d):t=r;if(t&&(!d&&a&&"view"===a._is&&(d=a),d&&(m=m||d.content,g=g||d._.onRender,a===d&&(a=d.data),c=K(c,d.ctx)),d&&d.data!==b||((c=c||{}).root=a),t.fn||(t=Da[t]||Da(t)),t)){u=g=!1!==
(c&&c.link)&&!p&&g;!0===g&&(u=b,g=d._.onRender);c=t.helpers?K(t.helpers,c):c;if(s.isArray(a)&&!e)for(l=h?d:f!==b&&d||new aa(c,"array",d,a,t,f,m,g),h=0,k=a.length;h<k;h++)r=a[h],D=new aa(c,"item",l,r,t,(f||0)+h,m,g),r=ya(t,r,D),z+=l._.onRender?l._.onRender(r,D):r;else{if(d||!t.fn._nvw)l=h?d:new aa(c,D||"data",d,a,t,f,m,g),k&&!r.flow&&(l.tag=r);z+=ya(t,a,l)}return u?u(z,l):z}return""}function la(b,a,c){c=xa.onError(b,a,c);if(""+b===b)throw new P.Err(c);return!a.linkCtx&&a.linked?na.html(c):c}function ga(b){la("Syntax error\n"+
b)}function Fa(b,a,c,d){function e(a){(a-=m)&&t.push(b.substr(m,a).replace(ja,"\\n"))}function f(a){a&&ga('Unmatched or missing tag: "{{/'+a+'}}" in template:\n'+b)}var g,h,k,l=a&&a.allowCode,u=[],m=0,K=[],t=u,s=[,,u];c&&(b=x+b+I);f(K[0]&&K[0][2].pop()[0]);b.replace(C,function(g,D,u,p,z,G,n,q,C,w,x,F){G&&(z=":",p=L);w=w||c;D=(D||c)&&[];var y="",A="",ha="",ua="",ka="",Ka="",Oa="",Xa="";n=!w&&!z&&!n;u=u||(C=C||"#data",z);e(F);m=F+g.length;q?l&&t.push(["*","\n"+C.replace(ia,"$1")+"\n"]):u?("else"===
u&&(R.test(C)&&ga('for "{{else if expr}}" use "{{else expr}}"'),D=s[7],s[8]=b.substring(s[8],F),s=K.pop(),t=s[2],n=!0),C&&r(C.replace(ja," "),D,a).replace(H,function(b,a,c,d,e,f,g,h){g?(A+=f+",",ua+="'"+h+"',"):c?(ha+=d+f+",",Ka+=d+"'"+h+"',"):a?Oa+=f:("trigger"===e&&(Xa+=f),y+=d+f+",",ka+=d+"'"+h+"',",k=k||Na.test(e));return""}).slice(0,-1),h=[u,p||!!d||k||"",n&&[],[ua.slice(0,-1),ka.slice(0,-1),Ka.slice(0,-1)],[A.slice(0,-1),y.slice(0,-1),ha.slice(0,-1)],Oa,Xa,D||0],t.push(h),n&&(K.push(s),s=h,
s[8]=m)):x&&(f(x!==s[0]&&"else"!==s[0]&&x),s[8]=b.substring(s[8],F),s=K.pop());f(!s&&x);t=s[2]});e(b.length);(m=u[u.length-1])&&f(""+m!==m&&+m[8]===m[8]&&m[0]);c?(g=D(u,b,c),g.paths=u[0][7]):g=D(u,a);g._nvw&&(g._nvw=!/[~#]/.test(b));return g}function Ia(b,a){return"\n\t"+(a?a+":{":"")+"args:["+b[0]+"]"+(b[1]||!a?",\n\tprops:{"+b[1]+"}":"")+(b[2]?",\n\tctx:{"+b[2]+"}":"")}function r(b,a,c){var d,e,f,g,h,r=0,k=c?c.links:a&&(a.links=a.links||{}),l={},D={0:-1},u=0;return(b+(c?" ":"")).replace(/\)\^/g,
").").replace(Ga,function(m,K,t,s,z,p,G,n,C,q,w,x,F,y,E,A,ha,ua,ka,Ka){function Oa(b,c,g,A,ha,h,ua,ka){return g&&(a&&("linkTo"===d&&(e=a._jsvto=a._jsvto||[],e.push(z)),d&&!f||a.push(z.slice(c.length))),"."!==g)?(b=(A?'view.hlp("'+A+'")':ha?"view":"data")+(ka?(h?"."+h:A?"":ha?"":"."+g)+(ua||""):(ka=A?"":ha?h||"":g,"")),b+=ka?"."+ka:"",c+("view.data"===b.slice(0,9)?b.slice(5):b)):b}p=p||"";t=t||K||x;z=z||C;q=q||ha||"";if(!G||h||g)return!a||!A||h||g||d&&!f&&!e||(A=D[u],Ka.length-1>ka-A&&(A=Ka.slice(A,
ka+1),A=T+":"+A+M,G=k[A],G||(k[A]=1,k[A]=G=Fa(A,c||a,!0),G.paths.push({_jsvOb:G})),1!==G&&(e||a).push({_jsvOb:G}))),h?(h=!F,h?m:'"'):g?(g=!y,g?m:'"'):(t?(u++,D[u]=ka++,t):"")+(ua?u?"":(r=Ka.slice(r,ka),d?(d=f=e=!1,"\b"):"\b,")+r+(r=ka+m.length,"\b"):n?(u&&ga(b),d=z,f=s,r=ka+m.length,z+":"):z?z.split("^").join(".").replace(W,Oa)+(q?(l[++u]=!0,"."!==z.charAt(0)&&(D[u]=ka),q):p):p?p:E?(l[u--]=!1,E)+(q?(l[++u]=!0,q):""):w?(l[u]||ga(b),","):K?"":(h=F,g=y,'"'));ga(b)})}function D(b,a,d){var e,f,g,h,r,k,
l,u,m,K,t,s,z,p,G,n,q,C,w,x,F,y,E,M,I=0,A="",ha={},ua=b.length;""+a===a?(G=d?'data-link="'+a.replace(ja," ").slice(1,-1)+'"':a,a=0):(G=a.tmplName||"unnamed",a.allowCode&&(ha.allowCode=!0),a.debug&&(ha.debug=!0),t=a.bnds,p=a.tmpls);for(e=0;e<ua;e++)if(f=b[e],""+f===f)A+='\n+"'+f+'"';else if(g=f[0],"*"===g)A+=";\n"+f[1]+"\nret=ret";else{h=f[1];C=f[2];r=Ia(f[3],"params")+"},"+Ia(z=f[4]);E=f[5];M=f[6];w=f[8];(F="else"===g)||(I=0,t&&(s=f[7])&&(I=t.push(s)));(f=":"===g)?h&&(g=h===L?">":h+g):(C&&(n=Ma(w,
ha),n.tmplName=G+"/"+g,D(C,n),p.push(n)),F||(q=g,x=A,A=""),n=(n=b[e+1])&&"else"===n[0]);F=E?";\ntry{\nret+=":"\n+";if(f&&(s||M||h&&h!==L)){y="return {"+r+"};";E&&(y="try {\n"+y+"\n}catch(e){return {error: j._err(e,view,"+E+")}}\n");y=new Function("data,view,j,u"," // "+G+" "+I+" "+g+"\n"+y);y.paths=s;y._tag=g;if(d)return y;K=1}A+=f?(d?(E?"\ntry{\n":"")+"return ":F)+(K?(K=0,m=u=!0,'c("'+h+'",view,'+(s?(t[I-1]=y,I):"{"+r+"}")+")"):">"===g?(l=!0,"h("+z[0]+")"):"((v="+z[0]+')!=null?v:"")'):(m=k=!0,"\n{view:view,tmpl:"+
(C?p.length:"0")+","+r+"},");if(q&&!n){A="["+A.slice(0,-1)+"]";if(d||s)if(A=new Function("data,view,j,u"," // "+G+" "+I+" "+q+"\nreturn "+A+";"),s&&((t[I-1]=A).paths=s),A._tag=g,d)return A;A=x+F+'t("'+q+'",view,this,'+(I||A)+")";q=s=0}E&&(m=!0,A+=";\n}catch(e){ret"+(d?"urn ":"+=")+"j._err(e,view,"+E+");}\n"+(d?"":"ret=ret"))}A="// "+G+"\nj=j||"+(c?"jQuery.":"jsviews.")+"views;var v"+(k?",t=j._tag":"")+(u?",c=j._cnvt":"")+(l?",h=j.converters.html":"")+(d?";\n":',ret=""\n')+(ha.debug?"debugger;":"")+
A+(d?"\n":";\nreturn ret;");try{A=new Function("data,view,j,u",A)}catch(ka){ga("Compiled template code:\n\n"+A+'\n: "'+ka.message+'"')}a&&(a.fn=A);m||(A._nvw=!0);return A}function K(b,a){return b&&b!==a?a?h(h({},a),b):b:a&&h({},a)}function u(b){return ea[b]||(ea[b]="&#"+b.charCodeAt(0)+";")}function z(b){var a,c,d=[];if("object"===typeof b)for(a in b)(c=b[a])&&c.toJSON&&!c.toJSON()||m(c)||d.push({key:a,prop:c});return d}function G(b){return null!=b?fa.test(b)&&(""+b).replace(va,u)||b:""}if(!(c&&c.render||
d.jsviews)){var s,t,C,pa,ca,x="{",T="{",M="}",I="}",N="^",W=/^(!*?)(?:null|true|false|\d[\d.]*|([\w$]+|\.|~([\w$]+)|#(view|([\w$]+))?)([\w$.^]*?)(?:[.[^]([\w$]+)\]?)?)$/g,Ga=/(\()(?=\s*\()|(?:([([])\s*)?(?:(\^?)(!*?[#~]?[\w$.^]+)?\s*((\+\+|--)|\+|-|&&|\|\||===|!==|==|!=|<=|>=|[<>%*:?\/]|(=))\s*|(!*?[#~]?[\w$.^]+)([([])?)|(,\s*)|(\(?)\\?(?:(')|("))|(?:\s*(([)\]])(?=\s*\.|\s*\^|\s*$)|[)\]])([([]?))|(\s+)/g,ja=/[ \t]*(\r\n|\n|\r)/g,ia=/\\(['"])/g,y=/['"\\]/g,H=/(?:\x08|^)(onerror:)?(?:(~?)(([\w$]+):)?([^\x08]+))\x08(,)?([^\x08]+)/gi,
R=/^if\s/,da=/<(\w+)[>\s]/,fa=/[\x00`><\"'&]/,Na=/^on[A-Z]|^convert(Back)?$/,va=/[\x00`><"'&]/g,X=0,La=0,ea={"&":"&amp;","<":"&lt;",">":"&gt;","\x00":"&#0;","'":"&#39;",'"':"&#34;","`":"&#96;"},L="html",Q="data-jsv-tmpl",w={},O={template:{compile:ma},tag:{compile:ba},helper:{},converter:{}},F={jsviews:"v1.0.0-beta",settings:function(b){h(xa,b);e(xa._dbgMode);xa.jsv&&xa.jsv()},sub:{View:aa,Err:g,tmplFn:Fa,cvt:q,parse:r,extend:h,syntaxErr:ga,onStore:{},_lnk:a},map:oa,_cnvt:n,_tag:l,_err:la};(g.prototype=
Error()).constructor=g;S.depends=function(){return[this.get("item"),"index"]};Y.depends=function(){return["index"]};aa.prototype={get:Ja,getIndex:Y,getRsc:p,hlp:Z,_is:"view"};for(t in O)qa(t,O[t]);var Da=F.templates,na=F.converters,Ha=F.helpers,Ba=F.tags,P=F.sub,xa=F.settings;c?(s=c,s.fn.render=ra,s.observable&&(h(P,s.views.sub),F.map=s.views.map)):(s=d.jsviews={},s.isArray=Array&&Array.isArray||function(b){return"[object Array]"===Object.prototype.toString.call(b)});s.render=w;s.views=F;s.templates=
...
a,c);else if(k.prop===c.path||"*"===k.prop)g=typeof g===ma&&(n[0]||p&&E(g))&&g,h=typeof(h=c.value)===ma&&(n[0]||p&&E(h))&&h,l?(d=l._path+"."+c.path,e=l.filter,f=[l.parents().slice()],g&&S(p,l.ns,[g],n,k.cb,!0,e,f,d),h&&S(p,l.ns,[h],n,k.cb,b,e,f,d)):(g&&S(p,[g],n,k.cb,!0),h&&S(p,[h],n,k.cb)),k.cb(a,c)}}function sa(){function d(b,a,e,f){var g,h=Fa(w),k=E(w)?[w]:w;b=fa?b+"."+fa:b;if(ca||f)h&&c(k).off(b,m);else{if(N=h&&c._data(w))for(M=(N=(N=N&&N.events)&&N[e?ra:qa])&&N.length;M--;)if((I=N[M].data)&&
I.cb._cId===x._cId&&I.ns===fa){if(e)return;("*"===a&&I.prop!==a||I.prop===t)&&c(w).off(b,m)}a=e?{}:{fullPath:n,paths:a?[a]:[],prop:t};a.ns=fa;a.cb=x;R&&(a.observeAll={_path:R,path:function(){g=H.length;return R.replace(/[[.]/g,function(b){g--;return"["===b?"["+c.inArray(H[g-1],H[g]):"."})},parents:function(){return H},filter:da,ns:fa});c(k).on(b,null,a,m);ja&&(ja[c.data(w,"obId")||c.data(w,"obId",la++)]=w)}}function e(b,a){b._ob=W(b,Q);var c=Q;return function(d,e){var g=b._ob,h=a.length;typeof g===
ma&&(f(g,!0),(h||X&&E(g))&&S(X,[g],a,x,W,!0));g=b._ob=W(b,c);typeof g===ma&&(f(g),(h||X&&E(g))&&S(X,[g],a,x,W,[c]));x(d,e)}}function f(c,e,g,h){if(X){var k=w,l=R;w=c;h&&(w=c[h],R+="."+h,da&&(w=a._fltr(h,c,R,da)));w&&(g||E(w))&&d(ra+".observe"+(x?".obs"+(T=x._cId=x._cId||ga++):""),b,!0,e);w=k;R=l}}var k,l,p,s,t,n,q,ca,x,T,M,I,N,W,ba,ja,ia,y,H,R,da,fa,Y,Z,X=!1!=this,oa=1,ea=ta,L=Array.apply(0,arguments);k=L.pop();var Q=L.shift(),w=y=Q,O=L.length;Q+""===Q&&X&&(fa=Q,Q=w=y=L.shift(),O--);if(V(k))x=k;else if(k+
""===k&&(R=k,H=L.pop(),da=L.pop(),k=L.pop(),O-=3),!0===k?ca=k:k&&(Q=k,oa=0),k=L[O-1],O&&k===b||V(k))x=L.pop(),O--;O&&V(L[O-1])&&(W=x,x=L.pop(),O--);ea+=ca?x?".obs"+x._cId:"":".obs"+(T=x._cId=x._cId||ga++);ca||(ja=ya[T]=ya[T]||{});Y=fa&&fa.match(Ma)||[""];for(Z=Y.length;Z--;)for(fa=Y[Z],E(y)?f(y,ca,!0):ca&&0===O&&y&&d(ea,""),k=ia=0;k<O;k++)if(n=L[k],""!==n){w=y;if(""+n===n){s=n.split("^");s[1]&&(ia=s[0].split(".").length,n=s.join("."),ia=n.split(".").length-ia);if(W&&(ba=W(n,y))){O+=ba.length-1;aa.apply(L,
[k--,1].concat(ba));continue}s=n.split(".")}else oa&&!V(n)&&(n._jsvOb&&(y=e(n,L.slice(k+1)),y.noArray=!X,y._cId=x._cId,S(X,[Q],L.slice(0,k),y,W),y=b,n=n._ob),w=n),y=n,s=[y];for(;w&&(t=s.shift())!==b;)if(typeof w===ma){if(""+t===t){if(""===t)continue;if(s.length<ia+1&&!w.nodeType){if(!ca&&(N=Fa(w)&&c._data(w))){M=(N=(N=N.events)&&N[qa])&&N.length;for(p=0;M--;)!(I=N[M].data)||I.cb!==x||I.ns!==fa||I.prop!==t&&"*"!==I.prop||((l=s.join("."))&&I.paths.push(l),p++);if(p){w=w[t];continue}}if("*"===t){!ca&&
N&&N.length&&d(ea,"",!1,!0);V(w)?(q=w.depends)&&S(X,[q],x,ca||Q):d(ea,"");for(l in w)f(w,ca,b,l);break}else t&&d(ea+"."+t,s.join("."))}R&&(R+="."+t);t=w[t]}if(V(t)){(q=t.depends)&&S(X,[w],g(q,w),x,W,ca||[Q]);break}w=t}f(w,ca)}T&&h(ja,T);return{cbId:T,bnd:ja}}function Ja(){[].push.call(arguments,!0);return sa.apply(this,arguments)}function S(){var b=[].concat.apply([],arguments);return sa.apply(b.shift(),b)}function Y(b,a,c,d){b+""!==b&&(c=a,a=b,b="");n(b,this._data,a,c,[],"root",d)}function Z(b,a,
c){Y.call(this,b,a,c,!0)}function n(c,d,e,f,g,h,k){function l(b,d){p=b.length;for(x=h+"[]";p--;)(T=a._fltr(p,b,x,f))&&n(c,T,e,f||"",g.slice(),x,d)}function m(b,a){h=b.data.observeAll._path;var d=g;g[0]!==b.target&&(g=g.slice(),g.unshift(b.target));switch(a.change){case "insert":l(a.items);break;case "remove":l(a.items,!0);break;case "refresh":l(a.oldItems,!0);l(b.target);break;case "set":x=h+"."+a.path,n(c,a.oldValue,e,0,g.slice(),x,!0),n(c,a.value,e,0,g.slice(),x)}e.apply(this,arguments);g=d}var p,
q,x,T;if(typeof d===ma){q=E(d)?"":"*";g.unshift(d);if(e){if(q||0!==f)m._cId=e._cId=e._cId||ga++,sa(c,d,q,m,k,f,g.slice(),h)}else sa(c,d,q,b,k,f,g.slice(),h);if(q)for(p in d)"_"!==p.charAt(0)&&p!==ba&&(x=h+"."+p,(T=a._fltr(p,d,x,f))&&n(c,T,e,f||0,g.slice(),x,k));else l(d,k)}}function q(b,a,c){return 0>c.indexOf(".")&&0>c.indexOf("[")&&a[b]}if(!c)throw"jsViews/jsObservable require jQuery";if(!c.observable){d=c.views=c.views||{jsviews:"v1.0.0-alpha",sub:{}};var p=d.sub,l=c.event.special,aa=[].splice,
E=c.isArray,ba=c.expando,ma="object",oa=parseInt,Ma=/\S+/g,qa=p.propChng=p.propChng||"propertyChange",ra=p.arrChng=p.arrChng||"arrayChange",ya=p._cbBnds=p._cbBnds||{},ta=qa+".observe",V=c.isFunction,la=1,ga=1,Fa=c.hasData,Ia={};p.getDeps=function(){var b=arguments;return function(){for(var a,c,d=[],e=b.length;e--;)a=b[e--],(c=b[e])&&(d=d.concat(V(c)?c(a,a):c));return d}};c.observable=a;a._fltr=function(b,a,c,d){(b=d&&V(d)?d(b,a,c):a[b])&&(b=V(b)?b.set&&b.call(a):b);return typeof b===ma&&b};a.Object=
f;a.Array=e;c.observe=a.observe=sa;c.unobserve=a.unobserve=Ja;a._apply=S;f.prototype={_data:null,observeAll:Y,unobserveAll:Z,data:function(){return this._data},setProperty:function(a,c,d){var e,f=this._data;a=a||"";if(f)if(E(a))for(e=a.length;e--;)c=a[e],this.setProperty(c.name,c.value,d===b||d);else if(""+a!==a)for(e in a)this.setProperty(e,a[e],c);else if(a!==ba){for(a=a.split(".");f&&1<a.length;)f=f[a.shift()];f&&this._setProperty(f,a[0],c,d)}return this},removeProperty:function(b){this.setProperty(b,
Ia);return this},_setProperty:function(a,c,d,e){var f,g,h,k=c?a[c]:a;V(k)&&k.set&&(g=k,f=!0===k.set?k:k.set,k=k.call(a));if(k!==d||e&&k!=d)if(!(k instanceof Date)||k>d||k<d)f?(f.call(a,d),d=g.call(a)):(h=d===Ia)?(delete a[c],d=b):c&&(a[c]=d),this._trigger(a,{change:"set",path:c,value:d,oldValue:k,remove:h})},_trigger:function(b,a){c(b).triggerHandler(qa,a)}};e.prototype={_data:null,observeAll:Y,unobserveAll:Z,data:function(){return this._data},insert:function(b,a){var c=this._data;1===arguments.length&&
...
items:c},e)},move:function(b,a,c){c=c?oa(c):0===c?0:1;b=oa(b);a=oa(a);if(0<c&&-1<b&&-1<a&&b!==a){var d=this._data.slice(b,b+c);(c=d.length)&&this._move(b,a,c,d)}return this},_move:function(b,a,c,d){var e=this._data,f=e.length;e.splice(b,c);e.splice.apply(e,[a,0].concat(d));this._trigger({change:"move",oldIndex:b,index:a,items:d},f)},refresh:function(b){var a=this._data.slice();this._refresh(a,b);return this},_refresh:function(b,a){var c=this._data,d=c.length;aa.apply(c,[0,c.length].concat(a));this._trigger({change:"refresh",
oldItems:b},d)},_trigger:function(b,a){var d=this._data,e=d.length,d=c([d]);d.triggerHandler(ra,b);e!==a&&d.triggerHandler(qa,{change:"set",path:"length",value:e,oldValue:a})}};l[qa]=l[ra]={remove:function(b){var a,d,e,f,g=b.data;if(g&&(g.off=1,g=g.cb)&&(a=ya[g._cId])){b=c._data(this).events[b.type];for(e=b.length;e--&&!d;)d=(f=b[e].data)&&f.cb===g;d||(delete a[c.data(this,"obId")],h(a,g._cId))}}};d.map=function(d){function e(b,c,f){var g,h=this;this.src&&this.unmap();"object"===typeof b&&(h.src=
b,h.tgt=f||h.tgt||[],h.options=c||h.options,h.update(),d.obsSrc&&a(h.src).observeAll(h.obs=function(b,a){g||(g=1,d.obsSrc(h,b,a),g=0)},h.srcFlt),d.obsTgt&&a(h.tgt).observeAll(h.obt=function(b,a){g||(g=1,d.obsTgt(h,b,a),g=0)},h.tgtFlt))}(e.prototype={srcFlt:d.srcFlt||q,tgtFlt:d.tgtFlt||q,update:function(b){c.observable(this.tgt).refresh(d.getTgt(this.src,this.options=b||this.options))},unmap:function(){this.src&&(this.obs&&c.observable(this.src).unobserveAll(this.obs,this.srcFlt),this.obt&&c.observable(this.tgt).unobserveAll(this.obt,
this.tgtFlt),this.src=b)},map:e,_def:d}).constructor=e;V(d)&&(d={getTgt:d});d.baseMap&&(d=c.extend({},d.baseMap,d));d.map=function(b,a,c){return new e(b,a,c)};return d}}})(this,this.jQuery);(function(d,c,b){function a(a,d,e){var f,g,h,k,l,p,n,q,r,B=a.target,s=B._jsvBnd,v=/&(\d+)\+?/g;if(s)for(;h=v.exec(s);)if(h=Ca[h[1]])if(d=h.to){h=h.linkCtx;n=h.view;r=h.tag;p=c(B);l=n.hlp(O);q=n.hlp(F);g=m(B);f=Ra[g];e===b&&(e=fa(g)?g(B):f?p[f]():p.attr(g));f=d[1];d=d[0];f&&(k=fa(f)?f:n.getRsc("converters",f));
k&&(e=k.call(r,e));f=n.linkCtx;n.linkCtx=h;g={change:"change",oldValue:h._val,value:e};if(!(l&&!1===l.call(h,a,g)||r&&r.onBeforeChange&&!1===r.onBeforeChange(a,g)||e===b)&&(l=d[0],e!==b&&l)){l=l._jsvOb?l._ob:l;r&&(r._.chging=!0);X(l).setProperty(d[2]||d[1],e);q&&q.call(h,a,g);if(r){if(r.onAfterChange)r.onAfterChange(a,g);delete r._.chging}h._val=e}n.linkCtx=f}}function f(a,d,f){var g,h,k,l=this.data,p=this.elem,n=this.convert;h=p.parentNode;var r=this.view,q=r.linkCtx,s=r.hlp(O);r.linkCtx=this;if(h&&
!(s&&d&&!1===s.call(this,a,d)||d&&"*"!==a.data.prop&&a.data.prop!==d.path)){d&&(this.eventArgs=d);if(d||this._initVal){delete this._initVal;h=f.call(r.tmpl,l,r,y);a:{var B=h,t=k=this.tag;g=this.attr||m(p,!0,n!==b);var v,u,w=t&&t.parentElem||this.elem;if(B!==b){u=c(w);g=t&&t.attr||g;fa(B)&&T(this.expr+": missing parens");"visible"===g&&(g="css-display");if(t=/^css-/.test(g)&&g.slice(4))v=c.style(w,t),+B===B&&(v=parseInt(v));else if("link"!==g){if("value"===g)w.type===Ha&&(v=u.prop(g=na));else if(g===
Ba)if(w.value===""+B)v=u.prop(na);else break a;v===b&&(v=(v=Ra[g])?u[v]():u.attr(g))}this._val=v}}if(h&&h.error!==b)h=h.error;else if(k){h=h[0]?h:[h];f=d&&k.onUpdate&&!1===k.onUpdate(a,d,h);ya(k,h);if(f||g===P){g===U&&k.onBeforeLink&&k.onBeforeLink();oa(k,k.tagCtx);S(this,l,p);r.linkCtx=q;return}if(k._.chging)return;h=":"===k.tagName?y._cnvt(k.cvt,r,h[0]):y._tag(k,r,r.tmpl,h,!0)}else f._tag&&(h=(n=""===n?xa:n)?y._cnvt(n,r,h):y._tag(f._tag,r,r.tmpl,h,!0),k=this.tag,g=this.attr||g);e(h,this,g,k)&&d&&
(s=r.hlp(F))&&s.call(this,a,d);k&&oa(k,k.tagCtx)}S(this,l,p);r.linkCtx=q}}function e(a,e,f,g){var h,l,m,p,n,q,s=a!==b,t=e.data,B=g&&g.parentElem||e.elem,u=c(B),v=e.view;q=e._val;var w=v.ctx,y=v.linkCtx,x=g||f===U;g&&(g.parentElem=g.parentElem||e.expr||g._elCnt?B:B.parentNode,l=g._prv,m=g._nxt);if(s){if(/^css-/.test(f))"visible"===e.attr&&(e=(B.currentStyle||eb.call(d,B,"")).display,a?(a=B._jsvd||e,a!==P||(a=bb[h=B.nodeName])||(e=ia.createElement(h),ia.body.appendChild(e),a=bb[h]=(e.currentStyle||
eb.call(d,e,"")).display,ia.body.removeChild(e))):(B._jsvd=e,a=P)),(x=x||q!==a)&&c.style(B,f.slice(4),a);else if("link"!==f){if(f===na)n=1,a=a&&"false"!==a;else if(f===Ba)if(B.value===""+a)a=!0,n=1,f=na;else{S(e,t,B);return}else if("selected"===f||"disabled"===f||"multiple"===f||"readonly"===f)a=a&&"false"!==a?f:null;if(h=Ra[f])if(f===U){v.linkCtx=e;v.ctx=e.ctx;if(g&&g._.inline){f=g.nodes(!0);if(g._elCnt){if(l&&l!==m)r(l,m,B,g._tgId,"^",!0);else if(p=B._dfr)q=g._tgId+"^",h=p.indexOf("#"+q)+1,n=p.indexOf("/"+
...
(d.setAttribute(ea,(d.getAttribute(ea)||"")+"#"+k+"^/"+k+"^"),f._tgId=""+k)}if(e&&e[0])for(f._.radio&&(e=e.children("input[type=radio]")),a=e.length;a--;)e[a]._jsvBnd=e[a]._jsvBnd||d._jsvBnd+"+",e[a]._jsvLnkdEl=f}function Y(b,a,c,d,e,f,g){return Z(this,b,a,c,d,e,f,g)}function Z(d,e,f,g,h,k,l,m){if(d&&e){e=e.jquery?e:c(e);G||(G=ia.body,c(G).on(w,a).on("blur","[contenteditable]",a));for(var n,p,r,t,B,u,v,x=Ja,y=g&&"replace"===g.target,D=e.length;D--;)if(v=e[D],""+d===d)B=s(v),n=B.ctx,B.ctx=g,q(d,v,
...
0,a;v=A||l||"";e=e||ha;d=d||m;la&&!d&&(e||v||g)&&(la=b,za=pa.shift());if(e=e||d)B=0,la=b,fa&&(d||m?Wa[za]||/;svg;|;math;/.test(";"+pa.join(";")+";")||(n="'<"+za+".../"):Wa[e]?n="'</"+e:pa.length&&e===za||(n="Mismatch: '</"+e),n&&Ta(n+">' in:\n"+k)),qa=Aa,za=pa.shift(),Aa=Va[za],ha=ha?"</"+ha+">":"",qa&&(wa+=Ea,Ea="",Aa?wa+="-":(p=ha+Za+"@"+wa+Ya+(ua||""),wa=Fa.shift()));Aa?(g?Ea+=g:c=ha||m||"",v&&(c+=v,Ea&&(c+=" "+ea+'="'+Ea+'"',Ea=""))):c=g?c+p+f+Za+g+Ya+h+v:p||a;B&&g&&Ta(" No {^{ tags within elem markup ("+
B+' ). Use data-link="..."');v&&(B=v,pa.unshift(za),za=v.slice(1),pa[0]&&pa[0]===jb[za]&&T("Parent of <tr> must be <tbody>"),la=Wa[za],(Aa=Va[za])&&!qa&&(Fa.unshift(wa),wa=""),qa=Aa,wa&&Aa&&(wa+="+"));return c}function t(a,c){var e,f,k,A,ua=[];if(a){"@"===a._tkns.charAt(0)&&(c=J.previousSibling,J.parentNode.removeChild(J),J=b);for(F=a.length;F--;){H=a[F];k=H.ch;if(e=H.path)for(C=e.length-1;f=e.charAt(C--);)"+"===f?"-"===e.charAt(C)?(C--,c=c.previousSibling):c=c.parentNode:c=c.lastChild;if("^"===k){if(v=
Ca[e=H.id]){f=c&&(!J||J.parentNode!==c);if(!J||f)v.parentElem=c;H.elCnt&&f&&(c._dfr=(H.open?"#":"/")+e+k+(c._dfr||""));ua.push([f?null:J,H])}}else if(z=ja[e=H.id])(z.parentElem||(z.parentElem=c||J&&J.parentNode||d,z._.onRender=Ja,z._.onArrayChange=g,h(z)),f=z.parentElem,H.open)?(z._elCnt=H.elCnt,c?c._dfr="#"+e+k+(c._dfr||""):(z._prv||(f._dfr=l(f._dfr,"#"+e+k)),z._prv=J)):(!c||J&&J.parentNode===c?J&&(z._nxt||(f._dfr=l(f._dfr,"/"+e+k)),z._nxt=J):(c._dfr="/"+e+k+(c._dfr||""),z._nxt=b),y=z.linkCtx,(A=
z.ctx&&z.ctx.onAfterCreate||Ia)&&A.call(y,z))}for(F=ua.length;F--;)ta.push(ua[F])}return!a||a.elCnt}function u(b){var a,c;if(b)for(F=b.length,C=0;C<F;C++)if(H=b[C],P.id)P.id=P.id!==H.id&&P.id;else if(c=v=Ca[H.id].linkCtx.tag,!v.flow){if(!Y){for(a=1;c=c.parent;)a++;da=da||a}!Y&&a!==da||Z&&v.tagName!==Z||X.push(v)}}function w(){I=Ua?d.querySelectorAll(N):c(N,d).get();G=I.length;e&&e.innerHTML&&(O=Ua?e.querySelectorAll(N):c(N,e).get(),e=O.length?O[O.length-1]:e);for(D=da=0;D<G;D++)if(J=I[D],e&&!ya)ya=
J===e;else if(f&&J===f)break;else J.parentNode&&Ha(E(J,b,X&&ob))&&!P&&J.getAttribute(M)&&ta.push([J]);va===Ga&&k===b&&d.getAttribute(M)&&ta.push([d]);ba(e,Aa);ba(f,Aa);if(!P){if(Aa&&wa+Ea&&(J=f,wa&&(f?t(E(wa+"+",1),f):t(E(wa,1),d)),t(E(Ea,1),d),f)){U=f.getAttribute(ea);if(G=U.indexOf(sa)+1)U=U.slice(G+sa.length-1);f.setAttribute(ea,Ea+U)}G=ta.length;for(D=0;D<G;D++)if(J=ta[D],L=J[1],J=J[0],L){if(v=Ca[L.id]){if(y=v.linkCtx)v=y.tag,v.linkCtx=y;L.open?(J&&(v.parentElem=J.parentNode,v._prv=J),v._elCnt=
L.elCnt,!v||v.onBeforeLink&&!1===v.onBeforeLink()||v._.bound||(v._.bound=!0,z=v.tagCtx.view,q(b,v._prv,z,a,L.id)),v._.linking=!0):(v._nxt=J,v._.linking&&(ca=v.tagCtx,z=ca.view,delete v._.linking,v._.bound||(v._.bound=!0,q(b,v._prv,z,a,L.id)),oa(v,ca)))}}else z=s(J),q(J.getAttribute(M),J,z,a,b,n)}ra&&ra.resolve()}var B,y,v,D,G,C,F,I,J,z,H,L,O,K,S,V,Q,X,Y,Z,ca,fa,da,P,ga,aa,za,la,na,U,Aa,qa,Ea,sa,ya,ra,va=this,Ba=va._.id+"_",wa="",ta=[],pa=[],Fa=[],Ia=va.hlp(Da),Ha=t;m&&(ra=m.lazyLink&&c.Deferred(),
m.tmpl?S="/"+m._.id+"_":(P=m.get,m.tag&&(Ba=m.tag+"^",m=!0)),m=!0===m);P&&(Ha=u,X=P.tags,Y=P.deep,Z=P.name);d=d?""+d===d?c(d)[0]:d.jquery?d[0]:d:va.parentElem||ia.body;fa=!R.noValidate&&d.contentEditable!==xa;za=d.tagName.toLowerCase();Aa=!!Va[za];e=e&&ma(e,Aa);f=f&&ma(f,Aa)||null;if(k!=b){na=ga=ia.createElement("div");sa=Ea="";aa="http://www.w3.org/2000/svg"===d.namespaceURI?"svg_ns":(K=hb.exec(k))&&K[1]||"";x&&K&&K[2]&&T("Unsupported: "+K[2]);if(Aa){for(Q=f;Q&&!(V=E(Q));)Q=Q.nextSibling;if(U=V?
V._tkns:d._dfr){K=S||"";if(m||!S)K+="#"+Ba;C=U.indexOf(K);C+1&&(C+=K.length,sa=Ea=U.slice(0,C),U=U.slice(C),V?Q.setAttribute(ea,U):d._dfr=U)}}la=b;k=(""+k).replace(lb,r);fa&&pa.length&&Ta("Mismatched '<"+za+"...>' in:\n"+k);if(p)return;ab.appendChild(ga);aa=W[aa]||W.div;m=aa[0];for(na.innerHTML=aa[1]+k+aa[2];m--;)na=na.lastChild;ab.removeChild(ga);for(ga=ia.createDocumentFragment();aa=na.firstChild;)ga.appendChild(aa);d.insertBefore(ga,f)}ra?setTimeout(w,0):w();return ra&&ra.promise()}function q(a,
d,e,f,g,h){var k,l,n,q,r,s,u,w;f=e.data===b?f||{}:e.data;if(g)h=Ca[g],h=h.linkCtx?h.linkCtx.tag:h,u=h.linkCtx||{data:f,elem:h._elCnt?h.parentElem:d,view:e,ctx:e.ctx,attr:U,fn:h._.bnd,tag:h,_bndId:g},p(u,u.fn);else if(a&&d)for(k=e.tmpl,n=m(d),a=c.trim(a).replace(ib,"\\$&"),a=a.slice(-1)!==pa?C+":"+a+(n?":":"")+pa:a,t.lastIndex=0;l=t.exec(a);)w=t.lastIndex,n=g?U:l[1],s=l[3],r=l[10],q=b,u={data:f,elem:d,view:e,ctx:h||e.ctx,attr:n,_initVal:!l[2]},l[6]&&(!n&&(q=/:([\w$]*)$/.exec(r))&&(q=q[1],q!==b&&(r=
-q.length-1,s=s.slice(0,r-1)+pa)),null===q&&(q=b),u.convert=l[5]||""),u.expr=n+s,(l=k.links[s])||(k.links[s]=l=H.tmplFn(s,k,!0,q)),u.fn=l,n||q===b||(u.convertBack=q),p(u,l),t.lastIndex=w}function p(b,a){function c(d,e){f.call(b,d,e,a)}c.noArray=!0;b._ctxCb=Fa(b.view);b._hdlr=c;c(!0)}function l(b,a){var c;return b?(c=b.indexOf(a),c+1?b.slice(0,c)+b.slice(c+a.length):b):""}function aa(b){return b&&(""+b===b?b:"SCRIPT"===b.tagName?b.type.slice(3):1===b.nodeType&&b.getAttribute(ea)||"")}function E(b,
a,c){function d(b,a,c,g,h,k){f.push({elCnt:e,id:g,ch:h,open:a,close:c,path:k,token:b})}var e,f=[];if(a=a?b:aa(b))return f.elCnt=!b.type,e="@"===a.charAt(0)||!b.type,f._tkns=a,a.replace(c||pb,d),f}function ba(b,a){b&&("jsv"===b.type?b.parentNode.removeChild(b):a&&""===b.getAttribute(M)&&b.removeAttribute(M))}function ma(b,a){for(var c=b;a&&c&&1!==c.nodeType;)c=c.previousSibling;c&&(1!==c.nodeType?(c=ia.createElement("SCRIPT"),c.type="jsv",b.parentNode.insertBefore(c,b)):aa(c)||c.getAttribute(M)||c.setAttribute(M,
""));return c}function oa(a,d){var e,f,g,h,k,l,m;e=d.view;var n=a.linkCtx=a.linkCtx||{tag:a,data:e.data,view:e,ctx:e.ctx};if(a.onAfterLink)a.onAfterLink(d,n);if(f=(e=a.targetTag?a.targetTag.linkedElem:a.linkedElem)&&e[0]){if(g=a._.radio)e=e.children("input[type=radio]");if(g||!a._.chging){h=H.cvt(a,a.convert)[0];if(g||f!==n.elem){for(m=e.length;m--;){f=e[m];k=f._jsvLnkdEl;if(a._.inline&&(!k||k!==a&&k.targetTag!==a))for(f._jsvLnkdEl=a,k=n.elem?n.elem._jsvBnd:a._prv._jsvBnd,f._jsvBnd=k+"+",k=k.slice(1).split("&"),
...
a?[]:[b,a.replace(kb,""),c]}}}function Ia(b){return b.type===Ha?b[na]:b.value}function r(b,a,c,d,e,f){var g,h,k,m,n,p,q=0,r=b===a;if(b){k=E(b)||[];g=0;for(h=k.length;g<h;g++){m=k[g];p=m.id;if(p===d&&m.ch===e)if(f)h=0;else break;r||(n="_"===m.ch?ja[p]:Ca[p].linkCtx.tag,m.open?n._prv=a:m.close&&(n._nxt=a));q+=p.length+2}q&&b.setAttribute(ea,b.getAttribute(ea).slice(q));b=a?a.getAttribute(ea):c._dfr;if(h=b.indexOf("/"+d+e)+1)b=k._tkns.slice(0,q)+b.slice(h+(f?-1:d.length+1));b&&(a?a.setAttribute(ea,b):
c._dfr=b)}else c._dfr=l(c._dfr,"#"+d+e),f||a||(c._dfr=l(c._dfr,"/"+d+e))}function D(a){var c,d,e;if(e=E(a,1,mb))for(a=0,c=e.length;a<c;a++)d=e[a],"_"===d.ch?(d=ja[d.id])&&d.data!==b&&d.parent.removeViews(d._.key,b,!0):V(d.id)}function K(b,a,d){switch(d.change){case "set":b=b.tgt;for(a=b.length;a--&&b[a].key!==d.path;);-1===a?d.path&&c.observable(b).insert({key:d.path,prop:d.value}):d.remove?c.observable(b).remove(a):c.observable(b[a]).setProperty("prop",d.value)}}function u(b,a,d){b=b.src;switch(d.change){case "set":"prop"===
d.path?c.observable(b).setProperty(a.target.key,d.value):(c.observable(b).setProperty(d.oldValue,null),delete b[d.oldValue],c.observable(b).setProperty(d.value,a.target.prop));break;case "remove":a=d.items[0];c.observable(b).removeProperty(a.key);delete b[a.key];break;case "insert":a=d.items[0],a.key&&c.observable(b).setProperty(a.key,a.prop)}}function z(b,a,c){return 0>c.indexOf(".")&&a[b]}var G,s,t,C,pa,ca,x,T,M,I,N,W,Ga,ja,ia=d.document,y=c.views,H=y.sub,R=y.settings,da=H.extend,fa=c.isFunction,
Na=y.converters,va=y.tags,X=c.observable,La=X.observe,ea="data-jsv",L=H.propChng=H.propChng||"propertyChange",Q=H.arrChng=H.arrChng||"arrayChange",w="change.jsv",O="onBeforeChange",F="onAfterChange",Da="onAfterCreate",na="checked",Ha="checkbox",Ba="radio",P="none",xa="true",Ya='">\x3c/script>',Za='<script type="jsv',Qa="script,["+ea+"]",U="html",Ra={value:"val",input:"val",html:U,text:"text"},$a={from:"value",to:"value"},Sa=0,fb=c.cleanData,gb=R.delimiters,Ta=H.syntaxErr,hb=/<(?!script)(\w+)(?:[^>]*(on\w+)\s*=)?[^>]*>/,
...
ya(this),!0));a+""===a&&(c=this._.inline?U:d.attr||m(this.parentElem,!0),c=e(a,d,c,this));oa(this,this.tagCtx);return c||this},update:function(c){var d=this.linkedElem;d&&a({target:d[0]},b,c)}},H.onStore.template=function(a,b){b.link=Y;b.unlink=ga;a&&(c.link[a]=function(){return Y.apply(b,arguments)},c.unlink[a]=function(){return ga.apply(b,arguments)})},H.onStore.tag=function(a,b){H._lnk(b)},H._lnk=function(a){return da(a,I)},H.viewInfos=E,(R.delimiters=function(){var a=gb.apply(y,arguments);C=a[1];
pa=a[2];ca=a[4];t=RegExp("(?:^|\\s*)([\\w-]*)(\\"+ca+")?(\\"+C+H.rTag+"\\"+pa+")","g");return this})(),da(H._lnk(H.View.prototype),{addViews:function(a,b,c){var d,e=b.length,f=this.views;if(!this._.useKey&&e&&(c=this.tmpl)&&(d=f.length+e,!1!==sa(this,a,c,f,b,this.ctx)))for(a+=e;a<d;a++)X(f[a]).setProperty("index",a);return this},removeViews:function(a,d,e){function f(a){var d,g,k,l,n,p=m[a];if(p&&p.link){a=p._.id;e||(n=p.nodes());p.removeViews(b,b,!0);p.data=b;k=p._prv;l=p._nxt;g=p.parentElem;e||
(p._elCnt&&r(k,l,g,a,"_"),c(n).remove());if(!p._elCnt)try{k.parentNode.removeChild(k),l.parentNode.removeChild(l)}catch(q){}h(p);for(d in p._.bnds)V(d);delete ja[a]}}var g,k,l=!this._.useKey,m=this.views;l&&(k=m.length);if(a===b)if(l){for(g=k;g--;)f(g);this.views=[]}else{for(g in m)f(g);this.views={}}else if(d===b&&(l?d=1:(f(a),delete m[a])),l&&d){for(g=a+d;g-- >a;)f(g);m.splice(a,d);if(k=m.length)for(;a<k;)X(m[a]).setProperty("index",a++)}return this},refresh:function(a){var b=this.parent;b&&(sa(this,
this.index,this.tmpl,b.views,this.data,a,!0),h(this));return this},link:n}),ja={0:Ga=new H.View(b,"top")},Na.merge=function(a){var b,c=this.linkCtx._val||"",d=this.tagCtx.props.toggle;d&&(b=d.replace(/[\\^$.|?*+()[{]/g,"\\$&"),c=c.replace(RegExp("(\\s(?="+b+"$)|(\\s)|^)("+b+"(\\s|$))"),"$2"),a=c+(a?(c&&" ")+d:""));return a},va("on",{attr:P,onAfterLink:function(a,d){for(var e,f,g=0,h=a.args,k=a.props.data,l=a.view,m=a.props.context;!fa(e=h[g++]););f=h.slice(g);h=h.slice(0,g-1);m||(m=(m=/^(.*)[\.^][\w$]+$/.exec(a.params.args.slice(-f.length-
1)[0]))&&H.tmplFn("{:"+m[1]+"}",l.tmpl,!0)(d.data,l));if(e){if(this._evs)this.onDispose();c(d.elem).on(this._evs=h[0]||"click",this._sel=h[1],k==b?null:k,this._hlr=function(a){return e.apply(m||d.data,[].concat(f,a,{change:a.type,view:l,linkCtx:d}))})}},onDispose:function(){c(this.parentElem).off(this._evs,this._sel,this._hlr)},flow:!0}),da(va["for"],{onArrayChange:function(a,b){var c,d=b.change;if(this.tagCtxs[1]&&("insert"===d&&a.target.length===b.items.length||"remove"===d&&!a.target.length||"refresh"===
