...
!1;break}q&&(this._updatePush(e[l],b[l]),h=!0)}else throw"Cannot addToSet on a key that is not an array! (undefined)!";break;case "$splicePush":void 0===e[l]&&(e[l]=[]);if(e[l]instanceof Array)if(k=b.$index,void 0!==k)delete b.$index,this._updateSplicePush(e[l],k,b[l]),h=!0;else throw"Cannot splicePush without a $index integer value!";else throw"Cannot splicePush with a key that is not an array! ("+l+")";break;case "$move":if(e[l]instanceof Array)for(n=0;n<e[l].length;n++){if(this._match(e[l][n],
