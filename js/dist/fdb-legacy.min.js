...
b[g]!=d[g]){c._removeIndex(d);var k=c._updateObject(d,b,f,a,"");if(c._insertIndex(d))return k;throw"Primary key violation in update! Key violated: "+d[g];}return c._updateObject(d,b,f,a,"")};d.start();d.time("Retrieve documents to update");k=this.find(f,{$decouple:!1});d.time("Retrieve documents to update");k.length&&(d.time("Update documents"),e=k.filter(h),d.time("Update documents"),e.length&&(d.time("Resolve chains"),this.chainSend("update",{query:f,update:b},a),d.time("Resolve chains"),this._onUpdate(e),
this.deferEmit("change",{type:"update",data:e})));d.stop();return e||[]};b.prototype.updateById=function(f,b){var a={};a[this._primaryKey]=f;return this.update(a,b)};b.prototype._updateObject=function(f,b,a,d,g,k){b=this.decouple(b);g=g||"";"."===g.substr(0,1)&&(g=g.substr(1,g.length-1));var e=!1,h=!1,q,p,n,l;for(l in b)if(b.hasOwnProperty(l)){q=!1;if("$"===l.substr(0,1))switch(l){case "$index":q=!0;break;default:q=!0,(h=this._updateObject(f,b[l],a,d,g,l))&&(e=!0)}if(this._isPositionalKey(l)&&(q=
...
d>c?1:d<c?-1:0}:function(f,b){var d=a.value(f)[0],c=a.value(b)[0];return"string"===typeof d&&"string"===typeof c?1===d.localeCompare(c)?-1:1:d>c?-1:d<c?1:0})};b.prototype.bucket=function(f,b){var a,d={};for(a=0;a<b.length;a++)d[b[a][f]]=d[b[a][f]]||[],d[b[a][f]].push(b[a]);return d};b.prototype._analyseQuery=function(f,b,a){var d={queriesOn:[this._name],indexMatch:[],hasJoin:!1,queriesJoin:!1,joinQueries:{},query:f,options:b},g,k=[],e=[],h,m,p,n,l;a.time("checkIndexes");void 0!==f[this._primaryKey]&&
(a.time("checkIndexMatch: Primary Key"),h=new c,d.indexMatch.push({lookup:this._primaryIndex.lookup(f,b),keyData:{matchedKeys:[this._primaryKey],matchedKeyCount:1,totalKeyCount:h.countKeys(f)},index:this._primaryIndex}),a.time("checkIndexMatch: Primary Key"));for(l in this._indexById)if(this._indexById.hasOwnProperty(l)&&(m=this._indexById[l],p=m.name(),a.time("checkIndexMatch: "+p),h=m.match(f,b),n=m.lookup(f,b),0<h.matchedKeyCount&&d.indexMatch.push({lookup:n,keyData:h,index:m}),a.time("checkIndexMatch: "+
p),h.totalKeyCount===h.matchedKeyCount))break;a.time("checkIndexes");1<d.indexMatch.length&&(a.time("findOptimalIndex"),d.indexMatch.sort(function(f,b){return f.keyData.totalKeyCount===f.keyData.matchedKeyCount?-1:b.keyData.totalKeyCount===b.keyData.matchedKeyCount?1:f.keyData.matchedKeyCount===b.keyData.matchedKeyCount?f.lookup.length-b.lookup.length:b.keyData.matchedKeyCount-f.keyData.matchedKeyCount}),a.time("findOptimalIndex"));if(b.join){d.hasJoin=!0;for(a=0;a<b.join.length;a++)for(g in b.join[a])b.join[a].hasOwnProperty(g)&&
(k.push(g),"$as"in b.join[a][g]?e.push(b.join[a][g].$as):e.push(g));for(g=0;g<e.length;g++)if(b=this._queryReferencesCollection(f,e[g],""))d.joinQueries[k[g]]=b,d.queriesJoin=!0;d.joinsOn=k;d.queriesOn=d.queriesOn.concat(k)}return d};b.prototype._queryReferencesCollection=function(f,b,a){for(var d in f)if(f.hasOwnProperty(d)){if(d===b)return a&&(a+="."),a+d;if("object"===typeof f[d])return a&&(a+="."),a+=d,this._queryReferencesCollection(f[d],b,a)}return!1};b.prototype._match=function(b,a,d){var c,
g;c=typeof b;g=typeof a;var k=!0,e;if(!("string"!==c&&"number"!==c||"string"!==g&&"number"!==g))b!==a&&(k=!1);else for(e in a)if(a.hasOwnProperty(e)){c=!1;if("$"===e.substr(0,1))switch(e){case "$gt":if(b>a[e]){if("or"===d)return!0}else k=!1;c=!0;break;case "$gte":if(b>=a[e]){if("or"===d)return!0}else k=!1;c=!0;break;case "$lt":if(b<a[e]){if("or"===d)return!0}else k=!1;c=!0;break;case "$lte":if(b<=a[e]){if("or"===d)return!0}else k=!1;c=!0;break;case "$exists":if(void 0===b!==a[e]){if("or"===d)return!0}else k=
!1;c=!0;break;case "$or":c=!0;for(g=0;g<a[e].length;g++){if(this._match(b,a[e][g],"and"))return!0;k=!1}break;case "$and":c=!0;for(g=0;g<a[e].length;g++)if(!this._match(b,a[e][g],"and"))return!1;break;case "$in":if(a[e]instanceof Array){c=a[e];g=c.length;var h,m=!1;for(h=0;h<g;h++)if(c[h]===b){m=!0;break}if(m){if("or"===d)return!0}else k=!1}else throw"Cannot use a $nin operator on a non-array key: "+e;c=!0;break;case "$nin":if(a[e]instanceof Array){c=a[e];g=c.length;m=!0;for(h=0;h<g;h++)if(c[h]===
