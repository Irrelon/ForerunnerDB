...
new a;this._collections=[]};h.addModule("Overview",d);h.inherit(d.prototype,h.chainSystem);a=e("./Collection");c=e("./Document");e=h.modules.Core;k=h.modules.Core.prototype.init;h.synthesize(d.prototype,"db");h.synthesize(d.prototype,"name");h.synthesize(d.prototype,"query",function(a){var c=this.$super(a);void 0!==a&&this._refresh();return c});h.synthesize(d.prototype,"queryOptions",function(a){var c=this.$super(a);void 0!==a&&this._refresh();return c});h.synthesize(d.prototype,"reduce",function(a){var c=
this.$super(a);void 0!==a&&this._refresh();return c});d.prototype.debug=h.common.debug;d.prototype.objectId=h.common.objectId;d.prototype.from=function(a){void 0!==a&&("string"===typeof a&&(a=this._db.collection(a)),this._addCollection(a));return this};d.prototype.find=function(){return this._collData.find.apply(this._collData,arguments)};d.prototype._addCollection=function(a){-1===this._collections.indexOf(a)&&(this._collections.push(a),a.chain(this),this._refresh());return this};d.prototype._removeCollection=
function(a){-1<this._collections.indexOf(a)&&(this._collections.splice(a,1),a.unChain(this),this._refresh());return this};d.prototype._refresh=function(){if(this._collections&&this._collections[0]){this._collData.primaryKey(this._collections[0].primaryKey());var a=[],c;for(c=0;c<this._collections.length;c++)a=a.concat(this._collections[c].find(this._query,this._queryOptions));this._collData.setData(a)}this._reduce&&(a=this._reduce(),this._data.setData(a))};d.prototype._chainHandler=function(a,c,d,
e){switch(c){case "setData":case "insert":case "update":case "remove":this._refresh()}};d.prototype.link=function(a,c){this._data.link.apply(this._data,arguments);this._refresh()};d.prototype.unlink=function(a,c){this._data.unlink.apply(this._data,arguments);this._refresh()};e.prototype.init=function(){this._overview={};k.apply(this,arguments)};e.prototype.overview=function(a){return a?(this._overview[a]=this._overview[a]||(new d(a)).db(this),this._overview[a]):this._overview};m.exports=d},{"./Collection":2,
"./Document":6,"./Shared":17}],15:[function(e,m,h){e=e("./Shared");h=function(e){this.init.apply(this,arguments)};h.prototype.init=function(e){e&&this.path(e)};e.addModule("Path",h);e.inherit(h.prototype,e.chainSystem);h.prototype.path=function(e){return void 0!==e?(this._path=this.clean(e),this._pathParts=this._path.split("."),this):this._path};h.prototype.hasObjectPaths=function(e,a){var c=!0,d;for(d in e)if(e.hasOwnProperty(d)&&(void 0===a[d]||"object"===typeof e[d]&&(c=this.hasObjectPaths(e[d],
a[d]),!c)))return!1;return c};h.prototype.countKeys=function(e){var a=0,c;for(c in e)e.hasOwnProperty(c)&&void 0!==e[c]&&("object"!==typeof e[c]?a++:a+=this.countKeys(e[c]));return a};h.prototype.countObjectPaths=function(e,a){var c,d={},b=0,f=0,g;for(g in a)a.hasOwnProperty(g)&&("object"===typeof a[g]?(c=this.countObjectPaths(e[g],a[g]),d[g]=c.matchedKeys,f+=c.totalKeyCount,b+=c.matchedKeyCount):(f++,e&&e[g]&&"object"!==typeof e[g]?(d[g]=!0,b++):d[g]=!1));return{matchedKeys:d,matchedKeyCount:b,totalKeyCount:f}};
h.prototype.parse=function(e,a){var c=[],d="",b,f,g;for(f in e)if(e.hasOwnProperty(f))if(d=f,"object"===typeof e[f])if(a)for(b=this.parse(e[f],a),g=0;g<b.length;g++)c.push({path:d+"."+b[g].path,value:b[g].value});else for(b=this.parse(e[f]),g=0;g<b.length;g++)c.push({path:d+"."+b[g].path});else a?c.push({path:d,value:e[f]}):c.push({path:d});return c};h.prototype.parseArr=function(e,a){a=a||{};return this._parseArr(e,"",[],a)};h.prototype._parseArr=function(e,a,c,d){var b,f="";a=a||"";c=c||[];for(b in e)e.hasOwnProperty(b)&&
(!d.ignore||d.ignore&&!d.ignore.test(b))&&(f=a?a+"."+b:b,"object"===typeof e[b]?this._parseArr(e[b],f,c,d):c.push(f));return c};h.prototype.value=function(e,a){if(void 0!==e&&"object"===typeof e){var c,d,b,f,g=[],h;void 0!==a&&(a=this.clean(a),c=a.split("."));c=c||this._pathParts;d=c.length;b=e;for(h=0;h<d;h++){b=b[c[h]];if(f instanceof Array){for(d=0;d<f.length;d++)g=g.concat(this.value(f,d+"."+c[h]));return g}if(!b||"object"!==typeof b)break;f=b}return[b]}return[]};h.prototype.set=function(e,a,
c){if(void 0!==e&&void 0!==a){var d;a=this.clean(a);a=a.split(".");d=a.shift();a.length?(e[d]=e[d]||{},this.set(e[d],a.join("."),c)):e[d]=c}return e};h.prototype.get=function(e,a){return this.value(e,a)[0]};h.prototype.push=function(e,a,c){if(void 0!==e&&void 0!==a){var d;a=this.clean(a);a=a.split(".");d=a.shift();if(a.length)e[d]=e[d]||{},this.set(e[d],a.join("."),c);else if(e[d]=e[d]||[],e[d]instanceof Array)e[d].push(c);else throw"Cannot push to a path whose endpoint is not an array!";}return e};
h.prototype.keyValue=function(e,a){var c,d,b,f,g;void 0!==a&&(a=this.clean(a),c=a.split("."));c=c||this._pathParts;d=c.length;b=e;for(g=0;g<d;g++)if(b=b[c[g]],!b||"object"!==typeof b){f=c[g]+":"+b;break}return f};h.prototype.clean=function(e){"."===e.substr(0,1)&&(e=e.substr(1,e.length-1));return e};m.exports=h},{"./Shared":17}],16:[function(e,m,h){h=e("./Shared");var k,a,c,d;d=function(){this.init.apply(this,arguments)};d.prototype.init=function(a){a.isClient()&&void 0!==Storage&&this.mode("localStorage")};
h.addModule("Persist",d);h.inherit(d.prototype,h.chainSystem);h=h.modules.Core;k=e("./Collection");a=k.prototype.drop;e("./CollectionGroup");c=h.prototype.init;d.prototype.mode=function(a){return void 0!==a?(this._mode=a,this):this._mode};d.prototype.save=function(a,c,d){switch(this.mode()){case "localStorage":c="object"===typeof c?"json::fdb::"+JSON.stringify(c):"raw::fdb::"+c;try{localStorage.setItem(a,c)}catch(e){if(d)d(e);else throw e;break}if(d)d(!1);else return!1;break;default:if(d)d("No data handler.");
else throw"No data handler.";}};d.prototype.load=function(a,c){var d,e;switch(this.mode()){case "localStorage":try{d=localStorage.getItem(a)}catch(h){c(h,null)}if(d){d=d.split("::fdb::");switch(d[0]){case "json":e=JSON.parse(d[1]);break;case "raw":e=d[1]}if(c)c(!1,e);else return e}break;default:if(c)c("No data handler or unrecognised data type.");else throw"No data handler or unrecognised data type.";}};d.prototype.drop=function(a,c){switch(this.mode()){case "localStorage":try{localStorage.removeItem(a)}catch(d){c&&
c(d)}c&&c(!1);break;default:c&&c("No data handler or unrecognised data type.")}};k.prototype.drop=function(b){if(b)if(this._name)if(this._db)this._db.persist.drop(this._name);else return callback&&callback("Cannot drop a collection's persistent storage when the collection is not attached to a database!"),"Cannot drop a collection's persistent storage when the collection is not attached to a database!";else return callback&&callback("Cannot drop a collection's persistent storage when no name assigned to collection!"),
"Cannot drop a collection's persistent storage when no name assigned to collection!";a.apply(this)};k.prototype.save=function(a){if(this._name)if(this._db)this._db.persist.save(this._name,this._data,a);else return a&&a("Cannot save a collection that is not attached to a database!"),"Cannot save a collection that is not attached to a database!";else return a&&a("Cannot save a collection with no assigned name!"),"Cannot save a collection with no assigned name!"};k.prototype.load=function(a){var c=this;
if(this._name)if(this._db)this._db.persist.load(this._name,function(d,e){if(d)return a&&a(d),d;e&&c.setData(e);a&&a(!1)});else return a&&a("Cannot load a collection that is not attached to a database!"),"Cannot load a collection that is not attached to a database!";else return a&&a("Cannot load a collection with no assigned name!"),"Cannot load a collection with no assigned name!"};h.prototype.init=function(){this.persist=new d(this);c.apply(this,arguments)};m.exports=d},{"./Collection":2,"./CollectionGroup":3,
"./Shared":17}],17:[function(e,m,h){var k=0;e=function(a){if(a){var c,d=a.length;return function(){for(c=0;c<d;c++)if(a[c].length===arguments.length)return a[c].apply(this,arguments);return null}}return function(){}};e={modules:{},common:{decouple:function(a){return JSON.parse(JSON.stringify(a))},objectId:function(a){var c=Math.pow(10,17);if(a){var d=0,b=a.length,e;for(e=0;e<b;e++)d+=a.charCodeAt(e)*c;a=d.toString(16)}else k++,a=(k+(Math.random()*c+Math.random()*c+Math.random()*c+Math.random()*c)).toString(16);
return a},debug:new e([function(){return this._debug&&this._debug.all},function(a){return void 0!==a?"boolean"===typeof a?(this._debug=this._debug||{},this._debug.all=a,this.chainSend("debug",this._debug),this):this._debug&&this._debug[a]||this._db&&this._db._debug&&this._db._debug[a]||this._debug&&this._debug.all:this._debug&&this._debug.all},function(a,c){return void 0!==a?void 0!==c?(this._debug=this._debug||{},this._debug[a]=c,this.chainSend("debug",this._debug),this):this._debug&&this._debug[c]||
this._db&&this._db._debug&&this._db._debug[a]:this._debug&&this._debug.all}]),on:new e([function(a,c){this._listeners=this._listeners||{};this._listeners[a]=this._listeners[a]||{};this._listeners[a]["*"]=this._listeners[a]["*"]||[];this._listeners[a]["*"].push(c);return this},function(a,c,d){this._listeners=this._listeners||{};this._listeners[a]=this._listeners[a]||{};this._listeners[a][c]=this._listeners[a][c]||[];this._listeners[a][c].push(d);return this}]),off:new e([function(a){this._listeners&&
this._listeners[a]&&a in this._listeners&&delete this._listeners[a];return this},function(a,c){var d,b;"string"===typeof c?this._listeners&&this._listeners[a]&&this._listeners[a][c]&&delete this._listeners[a][c]:a in this._listeners&&(d=this._listeners[a]["*"],b=d.indexOf(c),-1<b&&d.splice(b,1));return this},function(a,c,d){this._listeners&&a in this._listeners&&(a=this._listeners[a][c],d=a.indexOf(d),-1<d&&a.splice(d,1))}]),emit:function(a,c){this._listeners=this._listeners||{};if(a in this._listeners){if(this._listeners[a]["*"]){var d=
this._listeners[a]["*"],b=d.length,e;for(e=0;e<b;e++)d[e].apply(this,Array.prototype.slice.call(arguments,1))}if(c instanceof Array&&c[0]&&c[0][this._primaryKey]){var d=this._listeners[a],g,h,b=c.length;for(e=0;e<b;e++)if(d[c[e][this._primaryKey]])for(g=d[c[e][this._primaryKey]].length,h=0;h<g;h++)d[c[e][this._primaryKey]][h].apply(this,Array.prototype.slice.call(arguments,1))}}return this}},_synth:{},addModule:function(a,c){this.modules[a]=c},inherit:function(a,c){for(var d in c)c.hasOwnProperty(d)&&
(a[d]=c[d])},synthesize:function(a,c,d){this._synth[c]=this._synth[c]||function(a){return void 0!==a?(this["_"+c]=a,this):this["_"+c]};if(d){var b=this;a[c]=function(){var a=this.$super,e;this.$super=b._synth[c];e=d.apply(this,arguments);this.$super=a;return e}}else a[c]=this._synth[c]},overload:e,chainSystem:{chain:function(a){this._chain=this._chain||[];-1===this._chain.indexOf(a)&&this._chain.push(a)},unChain:function(a){this._chain&&(a=this._chain.indexOf(a),-1<a&&this._chain.splice(a,1))},chainSend:function(a,
c,d){if(this._chain){var b=this._chain,e=b.length,g;for(g=0;g<e;g++)b[g].chainReceive(this,a,c,d)}},chainReceive:function(a,c,d,b){(!this._chainHandler||this._chainHandler&&!this._chainHandler(a,c,d,b))&&this.chainSend(c,d,b)}}};m.exports=e},{}],18:[function(e,m,h){var k,a,c;h=e("./Shared");var d=function(a,c,d){this.init.apply(this,arguments)};d.prototype.init=function(a,c,d){this._name=a;this._collections=[];this._groups=[];this._listeners={};this._querySettings={query:c,options:d};this._debug=
...
e.prototype.views=function(){var a=[],c;for(c in this._views)this._views.hasOwnProperty(c)&&a.push({name:c,count:this._views[c].count()});return a};m.exports=d},{"./Collection":2,"./CollectionGroup":3,"./Shared":17}],19:[function(e,m,h){window.jQuery&&(this.jQuery=window.jQuery,function(){(function(e,a,c){function d(a){return a}function b(a){debugger;return a}function f(a){ea=(ya._dbgMode=a)?"Unavailable (nested view): use #getIndex()":"";Ca("dbg",Ia.dbg=T.dbg=a?b:d)}function g(a){this.name=(H.link?
"JsViews":"JsRender")+" Error";this.message=a||this.name}function h(a,c){for(var b in c)a[b]=c[b];return a}function m(a){return"function"===typeof a}function ta(a,c,b){if(!P.rTag||a)v=a?a.charAt(0):v,U=a?a.charAt(1):U,M=c?c.charAt(0):M,E=c?c.charAt(1):E,N=b||N,a="\\"+v+"(\\"+N+")?\\"+U,c="\\"+M+"\\"+E,F="(?:(?:(\\w+(?=[\\/\\s\\"+M+"]))|(?:(\\w+)?(:)|(>)|!--((?:[^-]|-(?!-))*)--|(\\*)))\\s*((?:[^\\"+M+"]|\\"+M+"(?!\\"+E+"))*?)",P.rTag=F+")",F=RegExp(a+F+"(\\/)?|(?:\\/(\\w+)))"+c,"g"),ma=RegExp("<.*>|([^\\\\]|^)[{}]|"+
a+".*"+c);return[v,U,M,E,N]}function Ja(a,b){b||(b=a,a=c);var d,e,g,f;g=this;d=!b||"root"===b;if(a){if(f=g.type===b?g:c,!f)if(d=g.views,g._.useKey)for(e in d){if(f=d[e].get(a,b))break}else for(e=0,g=d.length;!f&&e<g;e++)f=d[e].get(a,b)}else if(d)for(;g.parent.parent;)f=g=g.parent;else for(;g&&!f;)f=g.type===b?g:c,g=g.parent;return f}function S(){var a=this.get("item");return a?a.index:c}function aa(){return this.index}function ba(a){var b,d=this,g=d.linkCtx,f=(d.ctx||{})[a];f===c&&g&&g.ctx&&(f=g.ctx[a]);
f===c&&(f=Ia[a]);f&&m(f)&&!f._wrp&&(b=function(){return f.apply(this&&this!==e?this:d,arguments)},b._wrp=1,h(b,f));return b||f}function q(a,b,d){var e,g,f=+d===d&&d,h=b.linkCtx;f&&(d=(f=b.tmpl.bnds[f-1])(b.data,b,C));e=d.args[0];if(a||f){e=h&&h.tag;e||(e={_:{inline:!h,bnd:f},tagName:":",cvt:a,flow:!0,tagCtx:d,_is:"tag"},h&&(h.tag=e,e.linkCtx=h,d.ctx=K(d.ctx,h.view.ctx)),P._lnk(e));for(g in d.props)Ma.test(g)&&(e[g]=d.props[g]);d.view=b;e.ctx=d.ctx||{};delete d.ctx;b._.tag=e;e=p(e,e.convert||"true"!==
a&&a)[0];e=f&&b._.onRender?b._.onRender(e,b,f):e;b._.tag=c}return e!=c?e:""}function p(a,c){var b=a.tagCtx,d=b.view,e=b.args;c=c&&(""+c===c?d.getRsc("converters",c)||na("Unknown converter: '"+c+"'"):c);e=e.length||b.index?c?e.slice():e:[d.data];c&&(c.depends&&(a.depends=P.getDeps(a.depends,a,c.depends,c)),e[0]=c.apply(a,e));return e}function n(a,b){for(var d,e=this;d===c&&e;)d=(d=e.tmpl[a])&&d[b],e=e.parent;return d||C[a][b]}function l(a,b,d,e,g){var f,k,r,l,D,m,w,n,s,H,I,A="",q=+e===e&&e,F=b.linkCtx||
0,t=b.ctx,v=d||b.tmpl;"tag"===a._is&&(f=a,a=f.tagName,e=f.tagCtxs);f=f||F.tag;q&&(e=(n=v.bnds[q-1])(b.data,b,C));m=e.length;for(D=0;D<m;D++){D||d&&f||(s=b.getRsc("tags",a)||na("Unknown tag: {{"+a+"}}"));k=e[D];F.tag||(w=k.tmpl,w=k.content=w&&v.tmpls[w-1],h(k,{tmpl:(f?f:s).template||w,render:V,index:D,view:b,ctx:K(k.ctx,t)}));if(d=k.props.tmpl)d=""+d===d?b.getRsc("templates",d)||Ea(d):d,k.tmpl=d;f||(s._ctr?(f=new s._ctr,H=!!f.init,f.attr=f.attr||s.attr||c):P._lnk(f={render:s.render}),f._={inline:!F},
F&&(F.attr=f.attr=F.attr||f.attr,F.tag=f,f.linkCtx=F),(f._.bnd=n||F.fn)?f._.arrVws={}:f.dataBoundOnly&&na("{^{"+a+"}} tag must be data-bound"),f.tagName=a,f.parent=l=t&&t.tag,f._is="tag",f._def=s,f.tagCtxs=e);if(!D)for(I in w=k.props)Ma.test(I)&&(f[I]=w[I]);k.tag=f;f.dataMap&&f.tagCtxs&&(k.map=f.tagCtxs[D].map);f.flow||(w=k.ctx=k.ctx||{},k=f.parents=w.parentTags=t&&K(w.parentTags,t.parentTags)||{},l&&(k[l.tagName]=l),w.tag=f)}b._.tag=f;f.rendering={};for(D=0;D<m;D++){k=f.tagCtx=f.tagCtxs[D];w=k.props;
a=p(f,f.convert);if(e=w.dataMap||f.dataMap)if(a.length||w.dataMap){l=k.map;if(!l||l.src!==a[0]||g)l&&l.src&&l.unmap(),l=k.map=e.map(a[0],w);a=[l.tgt]}f.ctx=k.ctx;!D&&H&&(e=f.template,f.init(k,F,f.ctx),H=c,f.template!==e&&(f._.tmpl=f.template));l=c;if(e=f.render)l=e.apply(f,a);a=a.length?a:[b];l=l!==c?l:k.render(a[0],!0)||(g?c:"");A=A?A+(l||""):l}delete f.rendering;f.tagCtx=f.tagCtxs[0];f.ctx=f.tagCtx.ctx;f._.inline&&(r=f.attr)&&r!==L&&(A="text"===r?T.html(A):"");return q&&b._.onRender?b._.onRender(A,
b,q):A}function ca(a,c,b,d,e,f,g,h){var k="array"===c,r={key:0,useKey:k?0:1,id:""+Ha++,onRender:h,bnds:{}};this.data=d;this.tmpl=e;this.content=g;this.views=k?[]:{};this.parent=b;this.type=c;this._=r;this.linked=!!h;b?(c=b.views,d=b._,d.useKey?(c[r.key="_"+d.useKey++]=this,this.index=ea,this.getIndex=S,f=d.tag,r.bnd=k&&(!f||!!f._.bnd&&f)):c.splice(r.key=this.index=f,0,this),this.ctx=a||b.ctx):this.ctx=a}function z(a){var c,b,d,e,f,g;for(c in O)if(e=O[c],(f=e.compile)&&(b=a[c+"s"]))for(d in b)(e=b[d]=
f(d,b[d],a))&&(g=P.onStore[c])&&g(d,e,f)}function da(a,b,d){m(b)?b={depends:b.depends,render:b}:(b.baseTag&&(b.flow=!!b.flow,b=h(h({},b.baseTag),b)),(a=b.template)!==c&&(b.template=""+a===a?Ea[a]||Ea(a):a),!1!==b.init&&(a=b._ctr=function(){},(a.prototype=b).constructor=a));d&&(b._parentTmpl=d);return b}function oa(b,d,f,g){function h(d){if(""+d===d||0<d.nodeType){try{l=0<d.nodeType?d:!ma.test(d)&&a&&a(e.document).find(d)[0]}catch(r){}l&&(d=Ea[b=b||l.getAttribute(Q)],d||(b=b||"_"+Z++,l.setAttribute(Q,
b),d=Ea[b]=oa(b,l.innerHTML,f,g)),l=c);return d}}var r,l;d=d||"";r=h(d);g=g||(d.markup?d:{});g.tmplName=b;f&&(g._parentTmpl=f);!r&&d.markup&&(r=h(d.markup))&&r.fn&&(r.debug!==d.debug||r.allowCode!==d.allowCode)&&(r=r.markup);if(r!==c)return b&&!f&&(t[b]=function(){return d.render.apply(d,arguments)}),r.fn||d.fn?r.fn&&(d=b&&b!==r.tmplName?K(g,r):r):(d=La(r,g),ra(r.replace(x,"\\$&"),d)),z(g),d}function pa(a){function c(b,d){this.tgt=a.getTgt(b,d)}m(a)&&(a={getTgt:a});a.baseMap&&(a=h(h({},a.baseMap),
a));a.map=function(a,b){return new c(a,b)};return a}function La(a,c){var b,d=ya.wrapMap||{},e=h({markup:a,tmpls:[],links:{},tags:{},bnds:[],_is:"template",render:ua},c);c.htmlTag||(b=fa.exec(a),e.htmlTag=b?b[1].toLowerCase():"");(b=d[e.htmlTag])&&b!==d.div&&(e.markup=H.trim(e.markup));return e}function W(a,b){function d(f,g,h){var k,r,l;if(f&&"object"===typeof f&&!f.nodeType&&!f.markup&&!f.getTgt){for(r in f)d(r,f[r],g);return C}g===c&&(g=f,f=c);f&&""+f!==f&&(h=g,g=f,f=c);l=h?h[e]=h[e]||{}:d;r=b.compile;
null===g?f&&delete l[f]:(g=r?g=r(f,g,h):g,f&&(l[f]=g));r&&g&&(g._is=a);g&&(k=P.onStore[a])&&k(f,g,r);return g}var e=a+"s";C[e]=d;O[a]=b}function sa(a,c){var b=this.jquery&&(this[0]||na('Unknown template: "'+this.selector+'"')),d=b.getAttribute(Q);return ua.call(d?Ea[d]:Ea(b),a,c)}function za(a,c,b){if(ya._dbgMode)try{return a.fn(c,b,C)}catch(d){return na(d,b)}return a.fn(c,b,C)}function ua(a,c,b,d,e,f){return d||!this.fn._nvw||H.isArray(a)?V.call(this,a,c,b,d,e,f):za(this,a,{tmpl:this})}function V(a,
b,d,e,f,g){var h,k,r,l,D,m,w,s,n;r=this;var I="";!!b===b&&(d=b,b=c);!0===f&&(h=!0,f=0);r.tag?(m=r,r=r.tag,k=r._,D=r.tagName,s=k.tmpl||m.tmpl,n=r.attr&&r.attr!==L,b=K(b,r.ctx),w=m.content,!1===m.props.link&&(b=b||{},b.link=!1),e=e||m.view,a=arguments.length?a:e):s=r;if(s&&(!e&&a&&"view"===a._is&&(e=a),e&&(w=w||e.content,g=g||e._.onRender,a===e&&(a=e.data),b=K(b,e.ctx)),e&&e.data!==c||((b=b||{}).root=a),s.fn||(s=Ea[s]||Ea(s)),s)){m=g=!1!==(b&&b.link)&&!n&&g;!0===g&&(m=c,g=e._.onRender);b=s.helpers?
K(s.helpers,b):b;if(H.isArray(a)&&!d)for(l=h?e:f!==c&&e||new ca(b,"array",e,a,s,f,w,g),h=0,k=a.length;h<k;h++)r=a[h],D=new ca(b,"item",l,r,s,(f||0)+h,w,g),r=za(s,r,D),I+=l._.onRender?l._.onRender(r,D):r;else{if(e||!s.fn._nvw)l=h?e:new ca(b,D||"data",e,a,s,f,w,g),k&&!r.flow&&(l.tag=r);I+=za(s,a,l)}return m?m(I,l):I}return""}function na(a,c,b){b=ya.onError(a,c,b);if(""+a===a)throw new P.Err(b);return!c.linkCtx&&c.linked?T.html(b):b}function ia(a){na("Syntax error\n"+a)}function ra(a,c,b,d){function e(c){(c-=
w)&&s.push(a.substr(w,c).replace(la,"\\n"))}function f(c){c&&ia('Unmatched or missing tag: "{{/'+c+'}}" in template:\n'+a)}var g,h,k,l=c&&c.allowCode,m=[],w=0,K=[],s=m,n=[,,m];b&&(a=v+a+E);f(K[0]&&K[0][2].pop()[0]);a.replace(F,function(g,D,m,I,H,A,p,q,F,t,v,C){A&&(H=":",I=L);t=t||b;D=(D||b)&&[];var x="",B="",ja="",va="",X="",Ka="",Na="",Wa="";p=!t&&!H&&!p;m=m||(F=F||"#data",H);e(C);w=C+g.length;q?l&&s.push(["*","\n"+F.replace(ka,"$1")+"\n"]):m?("else"===m&&(R.test(F)&&ia('for "{{else if expr}}" use "{{else expr}}"'),
D=n[7],n[8]=a.substring(n[8],C),n=K.pop(),s=n[2],p=!0),F&&r(F.replace(la," "),D,c).replace(G,function(a,c,b,d,e,f,g,h){g?(B+=f+",",va+="'"+h+"',"):b?(ja+=d+f+",",Ka+=d+"'"+h+"',"):c?Na+=f:("trigger"===e&&(Wa+=f),x+=d+f+",",X+=d+"'"+h+"',",k=k||Ma.test(e));return""}).slice(0,-1),h=[m,I||!!d||k||"",p&&[],[va.slice(0,-1),X.slice(0,-1),Ka.slice(0,-1)],[B.slice(0,-1),x.slice(0,-1),ja.slice(0,-1)],Na,Wa,D||0],s.push(h),p&&(K.push(n),n=h,n[8]=w)):v&&(f(v!==n[0]&&"else"!==n[0]&&v),n[8]=a.substring(n[8],C),
n=K.pop());f(!n&&v);s=n[2]});e(a.length);(w=m[m.length-1])&&f(""+w!==w&&+w[8]===w[8]&&w[0]);b?(g=D(m,a,b),g.paths=m[0][7]):g=D(m,c);g._nvw&&(g._nvw=!/[~#]/.test(a));return g}function Ga(a,c){return"\n\t"+(c?c+":{":"")+"args:["+a[0]+"]"+(a[1]||!c?",\n\tprops:{"+a[1]+"}":"")+(a[2]?",\n\tctx:{"+a[2]+"}":"")}function r(a,c,b){var d,e,f,g,h,k=0,r=b?b.links:c&&(c.links=c.links||{}),l={},D={0:-1},m=0;return(a+(b?" ":"")).replace(/\)\^/g,").").replace(Fa,function(w,K,s,n,I,H,p,A,F,q,t,v,C,x,z,B,ja,va,X,Ka){function Na(a,
b,g,B,ja,h,va,X){return g&&(c&&("linkTo"===d&&(e=c._jsvto=c._jsvto||[],e.push(I)),d&&!f||c.push(I.slice(b.length))),"."!==g)?(a=(B?'view.hlp("'+B+'")':ja?"view":"data")+(X?(h?"."+h:B?"":ja?"":"."+g)+(va||""):(X=B?"":ja?h||"":g,"")),a+=X?"."+X:"",b+("view.data"===a.slice(0,9)?a.slice(5):a)):a}H=H||"";s=s||K||v;I=I||F;q=q||ja||"";if(!p||h||g)return!c||!B||h||g||d&&!f&&!e||(B=D[m],Ka.length-1>X-B&&(B=Ka.slice(B,X+1),B=U+":"+B+M,p=r[B],p||(r[B]=1,r[B]=p=ra(B,b||c,!0),p.paths.push({_jsvOb:p})),1!==p&&
(e||c).push({_jsvOb:p}))),h?(h=!C,h?w:'"'):g?(g=!x,g?w:'"'):(s?(m++,D[m]=X++,s):"")+(va?m?"":(k=Ka.slice(k,X),d?(d=f=e=!1,"\b"):"\b,")+k+(k=X+w.length,"\b"):A?(m&&ia(a),d=I,f=n,k=X+w.length,I+":"):I?I.split("^").join(".").replace(Y,Na)+(q?(l[++m]=!0,"."!==I.charAt(0)&&(D[m]=X),q):H):H?H:z?(l[m--]=!1,z)+(q?(l[++m]=!0,q):""):t?(l[m]||ia(a),","):K?"":(h=C,g=x,'"'));ia(a)})}function D(c,b,d){var e,f,g,h,k,r,l,m,w,K,s,n,I,H,p,A,q,F,t,v,C,x,z,M,E=0,B="",ja={},va=c.length;""+b===b?(p=d?'data-link="'+b.replace(la,
" ").slice(1,-1)+'"':b,b=0):(p=b.tmplName||"unnamed",b.allowCode&&(ja.allowCode=!0),b.debug&&(ja.debug=!0),s=b.bnds,H=b.tmpls);for(e=0;e<va;e++)if(f=c[e],""+f===f)B+='\n+"'+f+'"';else if(g=f[0],"*"===g)B+=";\n"+f[1]+"\nret=ret";else{h=f[1];F=f[2];k=Ga(f[3],"params")+"},"+Ga(I=f[4]);z=f[5];M=f[6];t=f[8];(C="else"===g)||(E=0,s&&(n=f[7])&&(E=s.push(n)));(f=":"===g)?h&&(g=h===L?">":h+g):(F&&(A=La(t,ja),A.tmplName=p+"/"+g,D(F,A),H.push(A)),C||(q=g,v=B,B=""),A=(A=c[e+1])&&"else"===A[0]);C=z?";\ntry{\nret+=":
"\n+";if(f&&(n||M||h&&h!==L)){x="return {"+k+"};";z&&(x="try {\n"+x+"\n}catch(e){return {error: j._err(e,view,"+z+")}}\n");x=new Function("data,view,j,u"," // "+p+" "+E+" "+g+"\n"+x);x.paths=n;x._tag=g;if(d)return x;K=1}B+=f?(d?(z?"\ntry{\n":"")+"return ":C)+(K?(K=0,w=m=!0,'c("'+h+'",view,'+(n?(s[E-1]=x,E):"{"+k+"}")+")"):">"===g?(l=!0,"h("+I[0]+")"):"((v="+I[0]+')!=null?v:"")'):(w=r=!0,"\n{view:view,tmpl:"+(F?H.length:"0")+","+k+"},");if(q&&!A){B="["+B.slice(0,-1)+"]";if(d||n)if(B=new Function("data,view,j,u",
" // "+p+" "+E+" "+q+"\nreturn "+B+";"),n&&((s[E-1]=B).paths=n),B._tag=g,d)return B;B=v+C+'t("'+q+'",view,this,'+(E||B)+")";q=n=0}z&&(w=!0,B+=";\n}catch(e){ret"+(d?"urn ":"+=")+"j._err(e,view,"+z+");}\n"+(d?"":"ret=ret"))}B="// "+p+"\nj=j||"+(a?"jQuery.":"jsviews.")+"views;var v"+(r?",t=j._tag":"")+(m?",c=j._cnvt":"")+(l?",h=j.converters.html":"")+(d?";\n":',ret=""\n')+(ja.debug?"debugger;":"")+B+(d?"\n":";\nreturn ret;");try{B=new Function("data,view,j,u",B)}catch(X){ia("Compiled template code:\n\n"+
B+'\n: "'+X.message+'"')}b&&(b.fn=B);w||(B._nvw=!0);return B}function K(a,c){return a&&a!==c?c?h(h({},c),a):a:c&&h({},c)}function w(a){return ga[a]||(ga[a]="&#"+a.charCodeAt(0)+";")}function I(a){var c,b,d=[];if("object"===typeof a)for(c in a)(b=a[c])&&b.toJSON&&!b.toJSON()||m(b)||d.push({key:c,prop:b});return d}function A(a){return null!=a?ha.test(a)&&(""+a).replace(wa,w)||a:""}if(!(a&&a.render||e.jsviews)){var H,s,F,ma,ea,v="{",U="{",M="}",E="}",N="^",Y=/^(!*?)(?:null|true|false|\d[\d.]*|([\w$]+|\.|~([\w$]+)|#(view|([\w$]+))?)([\w$.^]*?)(?:[.[^]([\w$]+)\]?)?)$/g,
...
a+b);(b=d.length)&&this._move(a,c,b,d)}return this},_move:function(a,c,b,d){var e=this._data,f=e.length;e.splice(a,b);e.splice.apply(e,[c,0].concat(d));this._trigger({change:"move",oldIndex:a,index:c,items:d},f)},refresh:function(a){var c=this._data.slice();this._refresh(c,a);return this},_refresh:function(a,c){var b=this._data,d=b.length;ca.apply(b,[0,b.length].concat(c));this._trigger({change:"refresh",oldItems:a},d)},_trigger:function(c,b){var d=this._data,e=d.length,d=a([d]);d.triggerHandler(sa,
c);e!==b&&d.triggerHandler(W,{change:"set",path:"length",value:e,oldValue:b})}};l[W]=l[sa]={remove:function(c){var b,d,e,f,g=c.data;if(g&&(g.off=1,g=g.cb)&&(b=za[g._cId])){c=a._data(this).events[c.type];for(e=c.length;e--&&!d;)d=(f=c[e].data)&&f.cb===g;d||(delete b[a.data(this,"obId")],h(b,g._cId))}}};e.map=function(b){function e(a,c,f){var g,h=this;this.src&&this.unmap();"object"===typeof a&&(h.src=a,h.tgt=f||h.tgt||[],h.options=c||h.options,h.update(),b.obsSrc&&d(h.src).observeAll(h.obs=function(a,
