...
var d=this._data;this._linked?this.remove():this._data=[];e.length&&(this._linked?this.insert(e):this._data=this._data.concat(e));b.time("Rebuild Primary Key Index");this._rebuildPrimaryKeyIndex(r);b.time("Rebuild Primary Key Index");b.time("Resolve chains");this.chainSend("setData",e,{oldData:d});b.time("Resolve chains");b.stop();this.emit("setData",this._data,d)}a&&a(!1);return this};b.prototype._rebuildPrimaryKeyIndex=function(e){var r=e&&void 0!==e.ensureKeys?e.ensureKeys:!0;e=e&&void 0!==e.violationCheck?
e.violationCheck:!0;var b,a,d,c=this._primaryIndex,f=this._primaryCrc,g=this._crcLookup,h=this._primaryKey,k;c.truncate();f.truncate();g.truncate();b=this._data;for(a=b.length;a--;){d=b[a];r&&this._ensurePrimaryKey(d);if(e){if(!c.uniqueSet(d[h],d))throw"Call to setData failed because your data violates the primary key unique constraint. One or more documents are using the same primary key: "+d[this._primaryKey];}else c.set(d[h],d);k=JSON.stringify(d);f.set(d[h],k);g.set(k,d)}};b.prototype._ensurePrimaryKey=
function(e){void 0===e[this._primaryKey]&&(e[this._primaryKey]=this.objectId())};b.prototype.truncate=function(){this.emit("truncate",this._data);this._data.length=0;this.deferEmit("change");return this};b.prototype.upsert=function(e,r){if(e){var b=this._deferQueue.upsert,a=this._deferThreshold.upsert,d={},c;if(e instanceof Array){if(e.length>a){this._deferQueue.upsert=b.concat(e);this.processQueue("upsert",r);return}d=[];for(b=0;b<e.length;b++)d.push(this.upsert(e[b]));r&&r();return d}e[this._primaryKey]?
(c={},c[this._primaryKey]=e[this._primaryKey],this._primaryIndex.lookup(c)[0]?d.op="update":d.op="insert"):d.op="insert";switch(d.op){case "insert":d.result=this.insert(e);break;case "update":d.result=this.update(c,e)}return d}r&&r()};b.prototype.update=function(e,b,a){b=this.decouple(b);b=this.transformIn(b);this.debug()&&console.log('Updating some collection data for collection "'+this.name()+'"');var d=this,c=this._metrics.create("update"),f=this._primaryKey,g,h,k=function(c){if(b&&void 0!==b[f]&&
b[f]!=c[f]){d._removeIndex(c);var g=d._updateObject(c,b,e,a,"");if(d._insertIndex(c))return g;throw"Primary key violation in update! Key violated: "+c[f];}return d._updateObject(c,b,e,a,"")};c.start();c.time("Retrieve documents to update");g=this.find(e,{$decouple:!1});c.time("Retrieve documents to update");g.length&&(c.time("Update documents"),h=g.filter(k),c.time("Update documents"),h.length&&(c.time("Resolve chains"),this.chainSend("update",{query:e,update:b},a),c.time("Resolve chains"),this._onUpdate(h),
this.deferEmit("change",{type:"update",data:h})));c.stop();return h||[]};b.prototype.updateById=function(e,b){var a={};a[this._primaryKey]=e;return this.update(a,b)};b.prototype._updateObject=function(e,b,a,d,f,g){b=this.decouple(b);f=f||"";"."===f.substr(0,1)&&(f=f.substr(1,f.length-1));var h=!1,k=!1,q,p,n,l;for(l in b)if(b.hasOwnProperty(l)){q=!1;if("$"===l.substr(0,1))switch(l){case "$index":q=!0;break;default:q=!0,(k=this._updateObject(e,b[l],a,d,f,l))&&(h=!0)}if(this._isPositionalKey(l)&&(q=
!0,l=l.substr(0,l.length-2),k=new c(f+"."+l),e[l]&&e[l]instanceof Array&&e[l].length)){p=[];for(n=0;n<e[l].length;n++)this._match(e[l][n],k.value(a)[0])&&p.push(n);for(n=0;n<p.length;n++)(k=this._updateObject(e[l][p[n]],b[l+".$"],a,d,f+"."+l,g))&&(h=!0)}if(!q)if(g||"object"!==typeof b[l])switch(g){case "$inc":this._updateIncrement(e,l,b[l]);h=!0;break;case "$push":void 0===e[l]&&(e[l]=[]);if(e[l]instanceof Array){if(void 0!==b[l].$position&&b[l].$each instanceof Array)for(k=b[l].$position,q=b[l].$each.length,
...
b[l])){h=b.$index;if(void 0!==h)delete b.$index,this._updateSpliceMove(e[l],n,h),h=!0;else throw"Cannot move without a $index integer value!";break}}else throw"Cannot move on a key that is not an array! ("+l+")";break;case "$mul":this._updateMultiply(e,l,b[l]);h=!0;break;case "$rename":this._updateRename(e,l,b[l]);h=!0;break;case "$unset":this._updateUnset(e,l);h=!0;break;case "$pop":if(e[l]instanceof Array)this._updatePop(e[l],b[l])&&(h=!0);else throw"Cannot pop from a key that is not an array! ("+
l+")";break;default:e[l]!==b[l]&&(this._updateProperty(e,l,b[l]),h=!0)}else if(null!==e[l]&&"object"===typeof e[l])if(n=e[l]instanceof Array,p=b[l]instanceof Array,n||p)if(!p&&n)for(n=0;n<e[l].length;n++)(k=this._updateObject(e[l][n],b[l],a,d,f+"."+l,g))&&(h=!0);else e[l]!==b[l]&&(this._updateProperty(e,l,b[l]),h=!0);else(k=this._updateObject(e[l],b[l],a,d,f+"."+l,g))&&(h=!0);else e[l]!==b[l]&&(this._updateProperty(e,l,b[l]),h=!0)}return h};b.prototype._isPositionalKey=function(e){return".$"===e.substr(e.length-
...
0,e);return!0}return"No document passed to insert"};b.prototype._insertIndex=function(e){var b=this._indexByName,a,d,c=JSON.stringify(e);d=this._primaryIndex.uniqueSet(e[this._primaryKey],e);this._primaryCrc.uniqueSet(e[this._primaryKey],c);this._crcLookup.uniqueSet(c,e);for(a in b)b.hasOwnProperty(a)&&b[a].insert(e);return d};b.prototype._removeIndex=function(e){var b=this._indexByName,a,d=JSON.stringify(e);this._primaryIndex.unSet(e[this._primaryKey]);this._primaryCrc.unSet(e[this._primaryKey]);
this._crcLookup.unSet(d);for(a in b)b.hasOwnProperty(a)&&b[a].remove(e)};b.prototype.subset=function(e,a){var d=this.find(e,a);return(new b)._subsetOf(this).primaryKey(this._primaryKey).setData(d)};b.prototype.subsetOf=function(){return this.__subsetOf};b.prototype._subsetOf=function(e){this.__subsetOf=e;return this};b.prototype.distinct=function(e,b,a){b=this.find(b,a);e=new c(e);a={};var d=[],f,h;for(h=0;h<b.length;h++)(f=e.value(b[h])[0])&&!a[f]&&(a[f]=!0,d.push(f));return d};b.prototype.decouple=
k.common.decouple;b.prototype.findById=function(e,b){var a={};a[this._primaryKey]=e;return this.find(a,b)[0]};b.prototype.peek=function(e,a){var d=this._data,c=d.length,f,h,g=new b;if("string"===typeof e){for(f=0;f<c;f++)h=JSON.stringify(d[f]),-1<h.indexOf(e)&&g.insert(d[f]);return g.find({},a)}return this.find(e,a)};b.prototype.explain=function(e,b){return this.find(e,b).__fdbOp._data};b.prototype.find=function(e,b){e=e||{};b=b||{};b.$decouple=void 0!==b.$decouple?b.$decouple:!0;var a=this._metrics.create("find"),
d=this,f,h=!0,g,k,m,p,n,l,u,t,s,x=[];k=function(b){return d._match(b,e,"and")};a.start();if(e){a.time("analyseQuery");f=this._analyseQuery(e,b,a);a.time("analyseQuery");a.data("analysis",f);if(f.hasJoin&&f.queriesJoin){a.time("joinReferences");for(m=0;m<f.joinsOn.length;m++)n=f.joinsOn[m],p=new c(f.joinQueries[n]),p=p.value(e)[0],this._db.collection(f.joinsOn[m]).subset(p);a.time("joinReferences")}f.indexMatch.length&&(!b||b&&!b.$skipIndex)?(a.data("index.potential",f.indexMatch),a.data("index.used",
f.indexMatch[0].index),a.time("indexLookup"),g=f.indexMatch[0].lookup,a.time("indexLookup"),f.indexMatch[0].keyData.totalKeyCount===f.indexMatch[0].keyData.matchedKeyCount&&(h=!1)):a.flag("usedIndex",!1);h&&(g&&g.length?(f=g.length,a.time("tableScan: "+f),g=g.filter(k)):(f=this._data.length,a.time("tableScan: "+f),g=this._data.filter(k)),b.$orderBy&&(a.time("sort"),g=this.sort(b.$orderBy,g),a.time("sort")),a.time("tableScan: "+f));b.limit&&g&&g.length>b.limit&&(g.length=b.limit,a.data("limit",b.limit));
b.$decouple&&(a.time("decouple"),g=this.decouple(g),a.time("decouple"),a.data("flag.decouple",!0));if(b.join){for(k=0;k<b.join.length;k++)for(n in b.join[k])if(b.join[k].hasOwnProperty(n))for(t=n,f=this._db.collection(n),h=b.join[k][n],s=0;s<g.length;s++){u={};p=m=!1;for(l in h)if(h.hasOwnProperty(l))if("$"===l.substr(0,1))switch(l){case "$as":t=h[l];break;case "$multi":m=h[l];break;case "$require":p=h[l];break;default:l.substr(0,3)}else u[l]=(new c(h[l])).value(g[s])[0];u=f.find(u);!p||p&&u[0]?g[s][t]=
!1===m?u[0]:u:x.push(g[s])}a.data("flag.join",!0)}if(x.length){a.time("removalQueue");for(l=0;l<x.length;l++)n=g.indexOf(x[l]),-1<n&&g.splice(n,1);a.time("removalQueue")}if(b.transform){a.time("transform");for(l=0;l<g.length;l++)g.splice(l,1,b.transform(g[l]));a.time("transform");a.data("flag.transform",!0)}this._transformEnabled&&this._transformOut&&(a.time("transformOut"),g=this.transformOut(g),a.time("transformOut"));a.data("results",g.length);a.stop()}else a.stop(),g=[];g.__fdbOp=a;return g};
b.prototype.indexOf=function(e){if(e=this.find(e,{$decouple:!1})[0])return this._data.indexOf(e)};b.prototype.transform=function(e){return void 0!==e?("object"===typeof e?(void 0!==e.enabled&&(this._transformEnabled=e.enabled),void 0!==e.dataIn&&(this._transformIn=e.dataIn),void 0!==e.dataOut&&(this._transformOut=e.dataOut)):this._transformEnabled=!1===e?!1:!0,this):{enabled:this._transformEnabled,dataIn:this._transformIn,dataOut:this._transformOut}};b.prototype.transformIn=function(e){if(this._transformEnabled&&
this._transformIn){if(e instanceof Array){var b=[],a;for(a=0;a<e.length;a++)b[a]=this._transformIn(e[a]);return b}return this._transformIn(e)}return e};b.prototype.transformOut=function(e){if(this._transformEnabled&&this._transformOut){if(e instanceof Array){var b=[],a;for(a=0;a<e.length;a++)b[a]=this._transformOut(e[a]);return b}return this._transformOut(e)}return e};b.prototype.sort=function(e,b){b=b||[];var a=[],d,c;for(d in e)e.hasOwnProperty(d)&&(c={},c[d]=e[d],c.___fdbKey=d,a.push(c));return 2>
a.length?this._sort(e,b):this._bucketSort(a,b)};b.prototype._bucketSort=function(e,b){var a=e.shift(),d,c,f=[];if(0<e.length){b=this._sort(a,b);d=this.bucket(a.___fdbKey,b);for(c in d)d.hasOwnProperty(c)&&(a=[].concat(e),f=f.concat(this._bucketSort(a,d[c])));return f}return this._sort(a,b)};b.prototype._sort=function(e,b){var a,d=new c;a=d.parse(e,!0)[0];d.path(a.path);if(1===a.value)a=function(e,b){var a=d.value(e)[0],c=d.value(b)[0];return"string"===typeof a&&"string"===typeof c?a.localeCompare(c):
a>c?1:a<c?-1:0};else if(-1===a.value)a=function(e,b){var a=d.value(e)[0],c=d.value(b)[0];return"string"===typeof a&&"string"===typeof c?1===a.localeCompare(c)?-1:1:a>c?-1:a<c?1:0};else throw this._name+": $orderBy clause has invalid direction: "+a.value+", accepted values are 1 or -1 for ascending or descending!";return b.sort(a)};b.prototype.bucket=function(e,b){var a,d={};for(a=0;a<b.length;a++)d[b[a][e]]=d[b[a][e]]||[],d[b[a][e]].push(b[a]);return d};b.prototype._analyseQuery=function(e,b,a){var d=
{queriesOn:[this._name],indexMatch:[],hasJoin:!1,queriesJoin:!1,joinQueries:{},query:e,options:b},f,g=[],h=[],k,m,p,n,l;a.time("checkIndexes");void 0!==e[this._primaryKey]&&(a.time("checkIndexMatch: Primary Key"),k=new c,d.indexMatch.push({lookup:this._primaryIndex.lookup(e,b),keyData:{matchedKeys:[this._primaryKey],matchedKeyCount:1,totalKeyCount:k.countKeys(e)},index:this._primaryIndex}),a.time("checkIndexMatch: Primary Key"));for(l in this._indexById)if(this._indexById.hasOwnProperty(l)&&(m=this._indexById[l],
p=m.name(),a.time("checkIndexMatch: "+p),k=m.match(e,b),n=m.lookup(e,b),0<k.matchedKeyCount&&d.indexMatch.push({lookup:n,keyData:k,index:m}),a.time("checkIndexMatch: "+p),k.totalKeyCount===k.matchedKeyCount))break;a.time("checkIndexes");1<d.indexMatch.length&&(a.time("findOptimalIndex"),d.indexMatch.sort(function(e,b){return e.keyData.totalKeyCount===e.keyData.matchedKeyCount?-1:b.keyData.totalKeyCount===b.keyData.matchedKeyCount?1:e.keyData.matchedKeyCount===b.keyData.matchedKeyCount?e.lookup.length-
b.lookup.length:b.keyData.matchedKeyCount-e.keyData.matchedKeyCount}),a.time("findOptimalIndex"));if(b.join){d.hasJoin=!0;for(a=0;a<b.join.length;a++)for(f in b.join[a])b.join[a].hasOwnProperty(f)&&(g.push(f),"$as"in b.join[a][f]?h.push(b.join[a][f].$as):h.push(f));for(f=0;f<h.length;f++)if(b=this._queryReferencesCollection(e,h[f],""))d.joinQueries[g[f]]=b,d.queriesJoin=!0;d.joinsOn=g;d.queriesOn=d.queriesOn.concat(g)}return d};b.prototype._queryReferencesCollection=function(e,b,a){for(var d in e)if(e.hasOwnProperty(d)){if(d===
b)return a&&(a+="."),a+d;if("object"===typeof e[d])return a&&(a+="."),a+=d,this._queryReferencesCollection(e[d],b,a)}return!1};b.prototype._match=function(e,b,a){var d,c;d=typeof e;c=typeof b;var f=!0,g;if(!("string"!==d&&"number"!==d||"string"!==c&&"number"!==c))e!==b&&(f=!1);else for(g in b)if(b.hasOwnProperty(g)){d=!1;if("$"===g.substr(0,1))switch(g){case "$gt":if(e>b[g]){if("or"===a)return!0}else f=!1;d=!0;break;case "$gte":if(e>=b[g]){if("or"===a)return!0}else f=!1;d=!0;break;case "$lt":if(e<
b[g]){if("or"===a)return!0}else f=!1;d=!0;break;case "$lte":if(e<=b[g]){if("or"===a)return!0}else f=!1;d=!0;break;case "$exists":if(void 0===e!==b[g]){if("or"===a)return!0}else f=!1;d=!0;break;case "$or":d=!0;for(c=0;c<b[g].length;c++){if(this._match(e,b[g][c],"and"))return!0;f=!1}break;case "$and":d=!0;for(c=0;c<b[g].length;c++)if(!this._match(e,b[g][c],"and"))return!1;break;case "$in":if(b[g]instanceof Array){d=b[g];c=d.length;var h,k=!1;for(h=0;h<c;h++)if(d[h]===e){k=!0;break}if(k){if("or"===a)return!0}else f=
!1}else throw"Cannot use a $nin operator on a non-array key: "+g;d=!0;break;case "$nin":if(b[g]instanceof Array){d=b[g];c=d.length;k=!0;for(h=0;h<c;h++)if(d[h]===e){k=!1;break}if(k){if("or"===a)return!0}else f=!1}else throw"Cannot use a $nin operator on a non-array key: "+g;d=!0;break;case "$ne":if(e!=b[g]){if("or"===a)return!0}else f=!1;d=!0}if(!d&&b[g]instanceof RegExp)if(d=!0,"object"===typeof e&&void 0!==e[g]&&b[g].test(e[g])){if("or"===a)return!0}else f=!1;if(!d)if("object"===typeof b[g])if(void 0!==
e[g]){if(e[g]instanceof Array&&!(b[g]instanceof Array))for(d=!1,c=0;c<e[g].length&&!(d=this._match(e[g][c],b[g],void 0));c++);else if(!(e[g]instanceof Array)&&b[g]instanceof Array)for(d=!1,c=0;c<b[g].length&&!(d=this._match(e[g],b[g][c],void 0));c++);else d="object"===typeof e?this._match(e[g],b[g],void 0):this._match(void 0,b[g],void 0);if(d){if("or"===a)return!0}else f=!1}else if(b[g]&&void 0!==b[g].$exists)if(d=this._match(void 0,b[g],void 0)){if("or"===a)return!0}else f=!1;else f=!1;else if(e&&
e[g]===b[g]){if("or"===a)return!0}else if(e&&e[g]&&e[g]instanceof Array&&b[g]&&"object"!==typeof b[g]){d=!1;for(c=0;c<e[g].length&&!(d=this._match(e[g][c],b[g],void 0));c++);if(d){if("or"===a)return!0}else f=!1}else f=!1;if("and"===a&&!f)return!1}return f};b.prototype.count=function(b,a){return b?this.find(b,a).length:this._data.length};b.prototype.link=function(b,a){if(window.jQuery){this._links=this._links||{};var d,c;a&&"object"===typeof a?a.template&&"string"===typeof a.template&&(d=this.objectId(a.template),
...
this.name()+'" to output target: '+b),this;console.log("Cannot remove link, one does not exist to the target: "+b+" with the template: "+a)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";return this};b.prototype.isLinked=function(){return Boolean(this._data._linked)};b.prototype.findSub=function(b,a,d,f){var g=new c(a);b=this.find(b);var h=b.length,k,m,q=this._db.collection("__FDB_temp_"+this.objectId()),p={parents:h,subDocTotal:0,subDocs:[],pathFound:!1,err:""};for(k=
0;k<h;k++)if(m=g.value(b[k])[0]){q.setData(m);m=q.find(d,f);if(f.returnFirst&&m.length)return m[0];p.subDocs.push(m);p.subDocTotal+=m.length;p.pathFound=!0}q.drop();if(f.noStats)return p.subDocs;p.pathFound||(p.err="No objects found in the parent documents with a matching path of: "+a);return p};b.prototype.insertIndexViolation=function(b){var a,d=this._indexByName,c,f;if(this._primaryIndex.get(b[this._primaryKey]))a=this._primaryIndex;else for(c in d)if(d.hasOwnProperty(c)&&(f=d[c],f.unique()&&f.violation(b))){a=
f;break}return a?a.name():!1};b.prototype.ensureIndex=function(b,d){this._indexByName=this._indexByName||{};this._indexById=this._indexById||{};var c=new a(b,d,this),f={start:(new Date).getTime()};if(this._indexByName[c.name()])return{err:"Index with that name already exists"};if(this._indexById[c.id()])return{err:"Index with those keys already exists"};c.rebuild();this._indexByName[c.name()]=c;this._indexById[c.id()]=c;f.end=(new Date).getTime();f.total=f.end-f.start;this._lastOp={type:"ensureIndex",
stats:{time:f}};return{index:c,id:c.id(),name:c.name(),state:c.state()}};b.prototype.index=function(b){if(this._indexByName)return this._indexByName[b]};b.prototype.lastOp=function(){return this._metrics.list()};b.prototype.objectId=k.common.objectId;b.prototype.diff=function(b){var a={insert:[],update:[],remove:[]},d=this.primaryKey(),c,f,g,h;if(d===b.primaryKey()){for(c=b._data;c&&!(c instanceof Array);)b=c,c=b._data;h=c.length;for(f=0;f<h;f++)g=c[f],this._primaryIndex.get(g[d])?this._primaryCrc.get(g[d])!==
b._primaryCrc.get(g[d])&&a.update.push(g):a.insert.push(g);c=this._data;h=c.length;for(f=0;f<h;f++)g=c[f],b._primaryIndex.get(g[d])||a.remove.push(g)}else throw"Collection diffing requires that both collections have the same primary key!";return a};h.prototype.collection=function(a,d){if(a)return this._collection[a]||this.debug()&&console.log("Creating collection "+a),this._collection[a]=this._collection[a]||(new b(a)).db(this),void 0!==d&&this._collection[a].primaryKey(d),this._collection[a];throw"Cannot get collection with undefined name!";
};h.prototype.collectionExists=function(b){return Boolean(this._collection[b])};h.prototype.collections=function(){var b=[],a;for(a in this._collection)this._collection.hasOwnProperty(a)&&b.push({name:a,count:this._collection[a].count()});return b};m.exports=b},{"./Crc":6,"./Index":9,"./KeyValueStore":10,"./Metrics":11,"./Path":16,"./Shared":19}],4:[function(h,m,k){var g,f;k=h("./Shared");var c=function(){this.init.apply(this,arguments)};c.prototype.init=function(a){this._name=a;this._data=new f("__FDB__cg_data_"+
...
for(a=0;a<b.length;a++)this._removeView(b[a]);this.emit("drop");return!0};h.prototype.init=function(){this._collectionGroup={};g.apply(this,arguments)};h.prototype.collectionGroup=function(a){return a?(this._collectionGroup[a]=this._collectionGroup[a]||(new c(a)).db(this),this._collectionGroup[a]):this._collectionGroup};m.exports=c},{"./Collection":3,"./Shared":19}],5:[function(h,m,k){var g,f;g=h("./Shared.js");k=function(){this.init.apply(this,arguments)};k.prototype.init=function(){this._collection=
{};this._debug={};this._version="1.2.7"};k.prototype.moduleLoaded=g.overload({string:function(c){if(void 0!==c){c=c.replace(/ /g,"");var a=c.split(","),d;for(d=0;d<a.length;d++)if(!g.modules[c])return!1;return!0}return!1},"string, function":function(c,a){if(void 0!==c){c=c.replace(/ /g,"");var d=c.split(","),b;for(b=0;b<d.length;b++)if(!g.modules[c])return!1;a()}},"string, function, function":function(c,a,d){if(void 0!==c){c=c.replace(/ /g,"");var b=c.split(","),e;for(e=0;e<b.length;e++)if(!g.modules[c])return d(),
...
k.prototype.debug=g.common.debug;k.prototype.arrayToCollection=function(c){return(new f).setData(c)};k.prototype.on=function(c,a){this._listeners=this._listeners||{};this._listeners[c]=this._listeners[c]||[];this._listeners[c].push(a);return this};k.prototype.off=function(c,a){if(c in this._listeners){var d=this._listeners[c],b=d.indexOf(a);-1<b&&d.splice(b,1)}return this};k.prototype.emit=function(c,a){this._listeners=this._listeners||{};if(c in this._listeners){var d=this._listeners[c],b=d.length,
e;for(e=0;e<b;e++)d[e].apply(this,Array.prototype.slice.call(arguments,1))}return this};k.prototype.objectId=g.common.objectId;k.prototype.peek=function(c){var a,d,b=[],e=typeof c;for(a in this._collection)this._collection.hasOwnProperty(a)&&(d=this._collection[a],b="string"===e?b.concat(d.peek(c)):b.concat(d.find(c)));return b};k.prototype.peekCat=function(c){var a,d,b={},e,f=typeof c;for(a in this._collection)this._collection.hasOwnProperty(a)&&(d=this._collection[a],(e="string"===f?d.peek(c):d.find(c))&&
e.length&&(b[d.name()]=e));return b};m.exports=k},{"./Collection.js":3,"./Crc.js":6,"./Metrics.js":11,"./Shared.js":19}],6:[function(h,m,k){var g=function(){var f=[],c,a,d;for(a=0;256>a;a++){c=a;for(d=0;8>d;d++)c=c&1?3988292384^c>>>1:c>>>1;f[a]=c}return f}();m.exports=function(f){var c=-1,a;for(a=0;a<f.length;a++)c=c>>>8^g[(c^f.charCodeAt(a))&255];return(c^-1)>>>0}},{}],7:[function(h,m,k){var g,f;k=h("./Shared");var c=function(){this.init.apply(this,arguments)};c.prototype.init=function(a){this._name=
...
};c.prototype.drop=function(){this._db&&this._name&&this._db&&this._db._document&&this._db._document[this._name]&&(delete this._db._document[this._name],this._data={})};g.prototype.init=function(){f.apply(this,arguments)};g.prototype.document=function(a){return a?(this._document=this._document||{},this._document[a]=this._document[a]||(new c(a)).db(this),this._document[a]):this._document};m.exports=c},{"./Collection":3,"./Shared":19}],8:[function(h,m,k){var g;h=h("./Shared");var f=function(c,a){this.init.apply(this,
arguments)};f.prototype.init=function(c,a){this._options=a;this._selector=$(this._options.selector);this._listeners={};this._collection=c;this._options.series=[];var d,b;switch(this._options.type){case "pie":this._selector.highcharts(this._options.chartOptions);this._chart=this._selector.highcharts();d=this._collection.find();b={allowPointSelect:!0,cursor:"pointer",dataLabels:{enabled:!0,format:"<b>{point.name}</b>: {y} ({point.percentage:.0f}%)",style:{color:Highcharts.theme&&Highcharts.theme.contrastTextColor||
...
delete this._chart;delete this._options;delete this._collection;return this};h.prototype.init=function(){this._highcharts={};g.apply(this,arguments)};h.prototype.chart=function(c){this._highcharts[c.selector]||(this._highcharts[c.selector]=new f(this,c));return this._highcharts[c.selector]};h.prototype.dropChart=function(c){this._highcharts[c]&&this._highcharts[c].drop()};m.exports=f},{"./Shared":19}],9:[function(h,m,k){k=h("./Shared");var g=h("./Path");h=function(){this.init.apply(this,arguments)};
h.prototype.init=function(f,c,a){this._crossRef={};this._size=0;this._id=this._itemKeyHash(f,f);this.data({});this.unique(c&&c.unique?c.unique:!1);void 0!==f&&this.keys(f);void 0!==a&&this.collection(a);this.name(c&&c.name?c.name:this._id)};k.addModule("Index",h);k.inherit(h.prototype,k.chainReactor);h.prototype.id=function(){return this._id};h.prototype.state=function(){return this._state};h.prototype.size=function(){return this._size};h.prototype.data=function(f){return void 0!==f?(this._data=f,
this):this._data};k.synthesize(h.prototype,"name");h.prototype.collection=function(f){return void 0!==f?(this._collection=f,this):this._collection};h.prototype.keys=function(f){return void 0!==f?(this._keys=f,this._keyCount=(new g).parse(this._keys).length,this):this._keys};h.prototype.type=function(f){return void 0!==f?(this._type=f,this):this._type};h.prototype.unique=function(f){return void 0!==f?(this._unique=f,this):this._unique};h.prototype.rebuild=function(){if(this._collection){var f=this._collection.subset({},
{$decouple:!1,$orderBy:this._keys}).find(),c,a=f.length;this._data={};this._unique&&(this._uniqueLookup={});for(c=0;c<a;c++)this.insert(f[c])}this._state={name:this._name,keys:this._keys,indexSize:this._size,built:new Date,updated:new Date,ok:!0}};h.prototype.insert=function(f,c){var a,d;this._unique&&(a=this._itemHash(f,this._keys),this._uniqueLookup[a]=f);a=this._itemHashArr(f,this._keys);for(d=0;d<a.length;d++)this.pushToPathValue(a[d],f)};h.prototype.remove=function(f,c){var a,d;this._unique&&
(a=this._itemHash(f,this._keys),delete this._uniqueLookup[a]);a=this._itemHashArr(f,this._keys);for(d=0;d<a.length;d++)this.pullFromPathValue(a[d],f)};h.prototype.violation=function(f){f=this._itemHash(f,this._keys);return Boolean(this._uniqueLookup[f])};h.prototype.hashViolation=function(f){return Boolean(this._uniqueLookup[f])};h.prototype.pushToPathValue=function(f,c){var a=this._data[f]=this._data[f]||[];-1===a.indexOf(c)&&(a.push(c),this._size++,this.pushToCrossRef(c,a))};h.prototype.pullFromPathValue=
function(f,c){var a=this._data[f],d;d=a.indexOf(c);-1<d&&(a.splice(d,1),this._size--,this.pullFromCrossRef(c,a));a.length||delete this._data[f]};h.prototype.pull=function(f){var c=f[this._collection.primaryKey()],a=this._crossRef[c],d,b=a.length,e;for(d=0;d<b;d++)e=a[d],this._pullFromArray(e,f);this._size--;delete this._crossRef[c]};h.prototype._pullFromArray=function(f,c){for(var a=f.length;a--;)f[a]===c&&f.splice(a,1)};h.prototype.pushToCrossRef=function(f,c){var a=f[this._collection.primaryKey()];
this._crossRef[a]=this._crossRef[a]||[];a=this._crossRef[a];-1===a.indexOf(c)&&a.push(c)};h.prototype.pullFromCrossRef=function(f,c){var a=f[this._collection.primaryKey()];delete this._crossRef[a]};h.prototype.lookup=function(f){return this._data[this._itemHash(f,this._keys)]||[]};h.prototype.match=function(f,c){return(new g).countObjectPaths(this._keys,f)};h.prototype._itemHash=function(f,c){var a=new g,d,b="",e;d=a.parse(c);for(e=0;e<d.length;e++)b&&(b+="_"),b+=a.value(f,d[e].path).join(":");return b};
h.prototype._itemKeyHash=function(f,c){var a=new g,d,b="",e;d=a.parse(c);for(e=0;e<d.length;e++)b&&(b+="_"),b+=a.keyValue(f,d[e].path);return b};h.prototype._itemHashArr=function(f,c){var a=new g,d,b=[],e,h,k,m;d=a.parse(c);for(k=0;k<d.length;k++)for(e=a.value(f,d[k].path),h=0;h<e.length;h++)if(0===k)b.push(e[h]);else for(m=0;m<b.length;m++)b[m]=b[m]+"_"+e[h];return b};m.exports=h},{"./Path":16,"./Shared":19}],10:[function(h,m,k){h=h("./Shared");k=function(g){this.init.apply(this,arguments)};k.prototype.init=
...
Array){c=g.length;d=[];for(f=0;f<c;f++)(a=this._data[g[f]])&&d.push(a);return d}if(g instanceof RegExp){d=[];for(f in this._data)this._data.hasOwnProperty(f)&&g.test(f)&&d.push(this._data[f]);return d}if("object"===typeof g){if(g.$ne){d=[];for(f in this._data)this._data.hasOwnProperty(f)&&f!==g.$ne&&d.push(this._data[f]);return d}if(g.$in&&g.$in instanceof Array){d=[];for(f in this._data)this._data.hasOwnProperty(f)&&-1<g.$in.indexOf(f)&&d.push(this._data[f]);return d}if(g.$nin&&g.$nin instanceof
Array){d=[];for(f in this._data)this._data.hasOwnProperty(f)&&-1===g.$nin.indexOf(f)&&d.push(this._data[f]);return d}if(g.$or&&g.$or instanceof Array){d=[];for(f=0;f<g.$or.length;f++)d=d.concat(this.lookup(g.$or[f]));return d}}else return a=this._data[g],void 0!==a?[a]:[]};k.prototype.unSet=function(g){delete this._data[g];return this};k.prototype.uniqueSet=function(g,f){return void 0===this._data[g]?(this._data[g]=f,!0):!1};m.exports=k},{"./Shared":19}],11:[function(h,m,k){k=h("./Shared");var g=
h("./Operation");h=function(){this.init.apply(this,arguments)};h.prototype.init=function(){this._data=[]};k.addModule("Metrics",h);k.inherit(h.prototype,k.chainReactor);h.prototype.create=function(f){f=new g(f);this._enabled&&this._data.push(f);return f};h.prototype.start=function(){this._enabled=!0;return this};h.prototype.stop=function(){this._enabled=!1;return this};h.prototype.clear=function(){this._data=[];return this};h.prototype.list=function(){return this._data};m.exports=h},{"./Operation":14,
"./Shared":19}],12:[function(h,m,k){var g;h=h("./Shared").modules.OldView;g=h.prototype.init;h.prototype.init=function(){var f=this;this._binds=[];this._renderEnd=this._renderStart=0;this._deferQueue={insert:[],update:[],remove:[],upsert:[],_bindInsert:[],_bindUpdate:[],_bindRemove:[],_bindUpsert:[]};this._deferThreshold={insert:100,update:100,remove:100,upsert:100,_bindInsert:100,_bindUpdate:100,_bindRemove:100,_bindUpsert:100};this._deferTime={insert:100,update:1,remove:1,upsert:1,_bindInsert:100,
_bindUpdate:1,_bindRemove:1,_bindUpsert:1};g.apply(this,arguments);this.on("insert",function(c,a){f._bindEvent("insert",c,a)});this.on("update",function(c,a){f._bindEvent("update",c,a)});this.on("remove",function(c,a){f._bindEvent("remove",c,a)});this.on("change",f._bindChange)};h.prototype.bind=function(f,c){if(c&&c.template)this._binds[f]=c;else throw"Cannot bind data to element, missing options information!";return this};h.prototype.unBind=function(f){delete this._binds[f];return this};h.prototype.isBound=
function(f){return Boolean(this._binds[f])};h.prototype.bindSortDom=function(f,c){var a=$(f),d,b,e;this.debug()&&console.log("ForerunnerDB.OldView.Bind: Sorting data in DOM...",c);for(d=0;d<c.length;d++)b=c[d],e=a.find("#"+b[this._primaryKey]),e.length?0===d?(this.debug()&&console.log("ForerunnerDB.OldView.Bind: Sort, moving to index 0...",e),a.prepend(e)):(this.debug()&&console.log("ForerunnerDB.OldView.Bind: Sort, moving to index "+d+"...",e),e.insertAfter(a.children(":eq("+(d-1)+")"))):this.debug()&&
console.log("ForerunnerDB.OldView.Bind: Warning, element for array item not found!",b)};h.prototype.bindRefresh=function(f){var c=this._binds,a,d;f||(f={data:this.find()});for(a in c)c.hasOwnProperty(a)&&(d=c[a],this.debug()&&console.log("ForerunnerDB.OldView.Bind: Sorting DOM..."),this.bindSortDom(a,f.data),d.afterOperation&&d.afterOperation(),d.refresh&&d.refresh())};h.prototype.bindRender=function(f,c){var a=this._binds[f],d=$(f),b,e,g=$("<ul></ul>"),h;if(a){b=this._data.find();for(h=0;h<b.length;h++)e=
b[h],a.template(e,function(b){g.append(b)});c?c(f,g.html()):d.append(g.html())}};h.prototype.processQueue=function(f,c){var a=this._deferQueue[f],d=this._deferThreshold[f],b=this._deferTime[f];if(a.length){var e=this;a.length&&(a=a.length>d?a.splice(0,d):a.splice(0,a.length),this._bindEvent(f,a,[]));setTimeout(function(){e.processQueue(f,c)},b)}else c&&c(),this.emit("bindQueueComplete")};h.prototype._bindEvent=function(f,c,a){var d=this._binds,b=this.find({}),e,g;for(g in d)if(d.hasOwnProperty(g))switch(e=
d[g].reduce?this.find(d[g].reduce.query,d[g].reduce.options):b,f){case "insert":this._bindInsert(g,d[g],c,a,e);break;case "update":this._bindUpdate(g,d[g],c,a,e);break;case "remove":this._bindRemove(g,d[g],c,a,e)}};h.prototype._bindChange=function(f){this.debug()&&console.log("ForerunnerDB.OldView.Bind: Bind data change, refreshing bind...",f);this.bindRefresh(f)};h.prototype._bindInsert=function(f,c,a,d,b){var e=$(f),g;for(g=0;g<a.length;g++)f=e.find("#"+a[g][this._primaryKey]),f.length||c.template(a[g],
function(b,a,d,f){return function(b){c.insert?c.insert(b,a,d,f):c.prependInsert?e.prepend(b):e.append(b);c.afterInsert&&c.afterInsert(b,a,d,f)}}(f,a[g],d,b))};h.prototype._bindUpdate=function(f,c,a,d,b){var e=$(f);for(d=0;d<a.length;d++)f=e.find("#"+a[d][this._primaryKey]),c.template(a[d],function(a,d){return function(f){c.update?c.update(f,d,b,a.length?"update":"append"):a.length?a.replaceWith(f):c.prependUpdate?e.prepend(f):e.append(f);c.afterUpdate&&c.afterUpdate(f,d,b)}}(f,a[d]))};h.prototype._bindRemove=
...
this._name=b;this._groups=[];this._listeners={};this._query={query:{},options:{}};this._onFromSetData=function(){a._onSetData.apply(a,arguments)};this._onFromInsert=function(){a._onInsert.apply(a,arguments)};this._onFromUpdate=function(){a._onUpdate.apply(a,arguments)};this._onFromRemove=function(){a._onRemove.apply(a,arguments)};this._onFromChange=function(){a.debug()&&console.log("ForerunnerDB.OldView: Received change");a._onChange.apply(a,arguments)}};k.modules.OldView=b;g=h("./CollectionGroup");
f=h("./Collection");c=f.prototype.init;a=g.prototype.init;h=k.modules.Core;d=h.prototype.init;b.prototype.on=k.common.on;b.prototype.off=k.common.off;b.prototype.emit=k.common.emit;b.prototype.drop=function(){return(this._db||this._from)&&this._name?(this.debug()&&console.log("ForerunnerDB.OldView: Dropping view "+this._name),this.emit("drop"),this._db&&delete this._db._oldViews[this._name],this._from&&delete this._from._oldViews[this._name],!0):!1};b.prototype.debug=function(){return!1};b.prototype.db=
...
function(a,e,c){this.init.apply(this,arguments)};d.prototype.init=function(a,e,c){this._name=a;this._groups=[];this._listeners={};this._querySettings={query:e,options:c};this._debug={};this._privateData=new g("__FDB__view_privateData_"+this._name)};k.addModule("View",d);k.inherit(d.prototype,k.chainReactor);g=h("./Collection");CollectionGroup=h("./CollectionGroup");a=h("./ReactorIO");f=g.prototype.init;h=k.modules.Core;c=h.prototype.init;k.synthesize(d.prototype,"name");d.prototype.debug=k.common.debug;
d.prototype.insert=function(){this._from.insert.apply(this._from,arguments)};d.prototype.update=function(){this._from.update.apply(this._from,arguments)};d.prototype.updateById=function(){this._from.updateById.apply(this._from,arguments)};d.prototype.remove=function(){this._from.remove.apply(this._from,arguments)};d.prototype.find=function(a,e){return this.publicData().find(a,e)};d.prototype.link=function(a,e){var c=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Setting up data binding on view "'+
this.name()+'" in underlying (internal) view collection "'+c.name()+'" for output target: '+a);c.link(a,e);return this};d.prototype.unlink=function(a,e){var c=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Removing data binding on view "'+this.name()+'" in underlying (internal) view collection "'+c.name()+'" for output target: '+a);c.unlink(a,e);return this};d.prototype.isLinked=function(){return this._privateData.isLinked()};d.prototype.decouple=k.common.decouple;d.prototype.from=
function(b){var e=this;if(void 0!==b){"string"===typeof b&&(b=this._db.collection(b));this._from=b;this._io=new a(b,this,function(a){var b,c,d;if("insert"===a.type){if(e._querySettings.query){b=a.data;if(b instanceof Array)for(c=[],a=0;a<b.length;a++)e._privateData._match(b[a],e._querySettings.query,"and")&&(c.push(b[a]),d=!0);else e._privateData._match(b,e._querySettings.query,"and")&&(c=b,d=!0);d&&this.chainSend("insert",c);return!0}return!1}if("update"===a.type){if(e._querySettings.query&&(c=e._privateData.diff(e._from.subset(e._querySettings.query,
e._querySettings.options)),c.insert.length||c.remove.length)){c.insert.length&&this.chainSend("insert",c.insert);if(c.update.length)for(d=e._privateData.primaryKey(),a=0;a<c.update.length;a++)b={},b[d]=c.update[a][d],this.chainSend("update",{query:b,update:c.update[a]});if(c.remove.length){d=e._privateData.primaryKey();b=[];var f={query:{$or:b}};for(a=0;a<c.remove.length;a++)b.push({_id:c.remove[a][d]});this.chainSend("remove",f)}return!0}return!1}});var c=b.find(this._querySettings.query,this._querySettings.options);
this._transformPrimaryKey(b.primaryKey());this._transformInsert(c);this._privateData.primaryKey(b.primaryKey());this._privateData.insert(c)}return this};d.prototype.ensureIndex=function(){return this._privateData.ensureIndex.apply(this._privateData,arguments)};d.prototype._chainHandler=function(a){var c,d,f,g;switch(a.type){case "setData":this.debug()&&console.log('ForerunnerDB.View: Setting data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');a.data=
this.decouple(a.data);this._transformSetData(a.data);this._privateData.setData(a.data);break;case "insert":this.debug()&&console.log('ForerunnerDB.View: Inserting some data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');a.data=this.decouple(a.data);a.data instanceof Array||(a.data=[a.data]);c=this._privateData._data.length;this._transformInsert(a.data,c);this._privateData._insertHandle(a.data,c);this._refreshSort(a.data);break;case "update":this.debug()&&
console.log('ForerunnerDB.View: Updating some data on view "'+this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"');this._privateData.primaryKey();a=this._privateData.update(a.data.query,a.data.update,a.data.options);this._refreshSort(a);if(this._transformEnabled&&this._transformIn)for(c=this._publicData.primaryKey(),g=0;g<a.length;g++)d={},f=a[g],d[c]=f[c],this._transformUpdate(d,f);break;case "remove":this.debug()&&console.log('ForerunnerDB.View: Removing some data on view "'+
this.name()+'" in underlying (internal) view collection "'+this._privateData.name()+'"'),this._transformRemove(a.data.query,a.options),this._privateData.remove(a.data.query,a.options)}};d.prototype._refreshSort=function(){this._querySettings.options&&this._querySettings.options.$orderBy&&this._refreshSortAction()};d.prototype._refreshSortAction=function(){var a,c,d,f;delete this._refreshSortDebounce;a=this._privateData.find({},{$orderBy:this._querySettings.options.$orderBy,$decouple:!1});for(f=0;f<
a.length;f++)c=this._privateData._data.indexOf(a[f]),d=a.indexOf(a[f]),c!==d&&this._privateData._updateSpliceMove(this._privateData._data,c,d)};d.prototype.on=function(){this._privateData.on.apply(this._privateData,arguments)};d.prototype.off=function(){this._privateData.off.apply(this._privateData,arguments)};d.prototype.emit=function(){this._privateData.emit.apply(this._privateData,arguments)};d.prototype.drop=function(){return this._from?((this.debug()||this._db&&this._db.debug())&&console.log("ForerunnerDB.View: Dropping view "+
this._name),this._io.drop(),this._privateData.drop(),!0):!1};d.prototype.db=function(a){return void 0!==a?(this._db=a,this.privateData().db(a),this.publicData().db(a),this):this._db};d.prototype.primaryKey=function(){return this._privateData.primaryKey()};d.prototype.queryData=function(a,c,d){void 0!==a&&(this._querySettings.query=a);void 0!==c&&(this._querySettings.options=c);return void 0!==a||void 0!==c?(void 0!==d&&!0!==d||this.refresh(),this):this._querySettings};d.prototype.queryAdd=function(a,
c,d){var f=this._querySettings.query,g;if(void 0!==a)for(g in a)a.hasOwnProperty(g)&&(void 0===f[g]||void 0!==f[g]&&c)&&(f[g]=a[g]);void 0!==d&&!0!==d||this.refresh()};d.prototype.queryRemove=function(a,c){var d=this._querySettings.query,f;if(void 0!==a)for(f in a)a.hasOwnProperty(f)&&delete d[f];void 0!==c&&!0!==c||this.refresh()};d.prototype.query=function(a,c){return void 0!==a?(this._querySettings.query=a,void 0!==c&&!0!==c||this.refresh(),this):this._querySettings.query};d.prototype.queryOptions=
...
d.prototype.transform=function(a){return void 0!==a?("object"===typeof a?(void 0!==a.enabled&&(this._transformEnabled=a.enabled),void 0!==a.dataIn&&(this._transformIn=a.dataIn),void 0!==a.dataOut&&(this._transformOut=a.dataOut)):this._transformEnabled=!1===a?!1:!0,this._transformPrimaryKey(this.privateData().primaryKey()),this._transformSetData(this.privateData().find()),this):{enabled:this._transformEnabled,dataIn:this._transformIn,dataOut:this._transformOut}};d.prototype.privateData=function(){return this._privateData};
d.prototype.publicData=function(){return this._transformEnabled?this._publicData:this._privateData};d.prototype._transformSetData=function(a){this._transformEnabled&&(this._publicData=new g("__FDB__view_publicData_"+this._name),this._publicData.db(this._privateData._db),this._publicData.transform({enabled:!0,dataIn:this._transformIn,dataOut:this._transformOut}),this._publicData.setData(a))};d.prototype._transformInsert=function(a,c){this._transformEnabled&&this._publicData&&this._publicData.insert(a,
c)};d.prototype._transformUpdate=function(a,c,d){this._transformEnabled&&this._publicData&&this._publicData.update(a,c,d)};d.prototype._transformRemove=function(a,c){this._transformEnabled&&this._publicData&&this._publicData.remove(a,c)};d.prototype._transformPrimaryKey=function(a){this._transformEnabled&&this._publicData&&this._publicData.primaryKey(a)};g.prototype.init=function(){this._views=[];f.apply(this,arguments)};g.prototype.view=function(a,c,f){if(this._db&&this._db._views){if(this._db._views[a])throw"Cannot create a view using this collection because one with this name already exists: "+
a;a=(new d(a,c,f)).db(this._db)._addCollection(this);this._views=this._views||[];this._views.push(a);return a}};g.prototype._addView=CollectionGroup.prototype._addView=function(a){void 0!==a&&this._views.push(a);return this};g.prototype._removeView=CollectionGroup.prototype._removeView=function(a){void 0!==a&&(a=this._views.indexOf(a),-1<a&&this._views.splice(a,1));return this};h.prototype.init=function(){this._views={};c.apply(this,arguments)};h.prototype.view=function(a){this._views[a]||(this.debug()||
this._db&&this._db.debug())&&console.log("Core.View: Creating view "+a);this._views[a]=this._views[a]||(new d(a)).db(this);return this._views[a]};h.prototype.viewExists=function(a){return Boolean(this._views[a])};h.prototype.views=function(){var a=[],c;for(c in this._views)this._views.hasOwnProperty(c)&&a.push({name:c,count:this._views[c].count()});return a};m.exports=d},{"./Collection":3,"./CollectionGroup":4,"./ReactorIO":18,"./Shared":19}]},{},[1])(1)});
