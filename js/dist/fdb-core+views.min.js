...
m=g[l]instanceof Array,q||m)if(!m&&q)for(q=0;q<c[l].length;q++)(n=this._updateObject(c[l][q],g[l],a,b,f+"."+l,h))&&(d=!0);else c[l]!==g[l]&&(this._updateProperty(c,l,g[l]),d=!0);else(n=this._updateObject(c[l],g[l],a,b,f+"."+l,h))&&(d=!0);else c[l]!==g[l]&&(this._updateProperty(c,l,g[l]),d=!0)}return d};f.prototype._isPositionalKey=function(c){return".$"===c.substr(c.length-2,2)};f.prototype._updateProperty=function(c,g,a){this._linked?(jQuery.observable(c).setProperty(g,a),this.debug()&&console.log('ForerunnerDB.Collection: Setting data-bound document property "'+
g+'" for collection "'+this.name()+'"')):(c[g]=a,this.debug()&&console.log('ForerunnerDB.Collection: Setting non-data-bound document property "'+g+'" for collection "'+this.name()+'"'))};f.prototype._updateIncrement=function(c,g,a){this._linked?jQuery.observable(c).setProperty(g,c[g]+a):c[g]+=a};f.prototype._updateSpliceMove=function(c,g,a){this._linked?(jQuery.observable(c).move(g,a),this.debug()&&console.log('ForerunnerDB.Collection: Moving data-bound document array index from "'+g+'" to "'+a+'" for collection "'+
this.name()+'"')):(c.splice(a,0,c.splice(g,1)[0]),this.debug()&&console.log('ForerunnerDB.Collection: Moving non-data-bound document array index from "'+g+'" to "'+a+'" for collection "'+this.name()+'"'))};f.prototype._updateSplicePush=function(c,g,a){c.length>g?this._linked?jQuery.observable(c).insert(g,a):c.splice(g,0,a):this._linked?jQuery.observable(c).insert(a):c.push(a)};f.prototype._updatePush=function(c,g){this._linked?jQuery.observable(c).insert(g):c.push(g)};f.prototype._updatePull=function(c,
g){this._linked?jQuery.observable(c).remove(g):c.splice(g,1)};f.prototype._updateMultiply=function(c,g,a){this._linked?jQuery.observable(c).setProperty(g,c[g]*a):c[g]*=a};f.prototype._updateRename=function(c,g,a){var b=c[g];this._linked?(jQuery.observable(c).setProperty(a,b),jQuery.observable(c).removeProperty(g)):(c[a]=b,delete c[g])};f.prototype._updateUnset=function(c,g){this._linked?jQuery.observable(c).removeProperty(g):delete c[g]};f.prototype._updatePop=function(c,g){var a,b=!1;0<c.length&&
(this._linked?(1===g?a=c.length-1:-1===g&&(a=0),-1<a&&(jQuery.observable(arr).remove(a),b=!0)):1===g?(c.pop(),b=!0):-1===g&&(c.shift(),b=!0));return b};f.prototype.remove=function(c){var g,a,b=this._views,e;if(c instanceof Array){b=[];for(g=0;g<c.length;g++)b.push(this.remove(c[g]));return b}g=this.find(c,{decouple:!1});if(g.length){for(e=0;e<g.length;e++)a=g[e],this._removeIndex(a),a=this._data.indexOf(a),this._linked?jQuery.observable(this._data).remove(a):this._data.splice(a,1);if(b&&b.length)for(e=
0;e<b.length;e++)b[e].remove(c);this._onRemove(g);this.deferEmit("change",{type:"remove",data:g})}return g};f.prototype.removeById=function(c){var g={};g[this._primaryKey]=c;return this.remove(g)};f.prototype.deferEmit=function(){var c=this,g;this._noEmitDefer||this._db&&(!this._db||this._db._noEmitDefer)?this.emit.apply(this,arguments):(g=arguments,this._changeTimeout&&clearTimeout(this._changeTimeout),this._changeTimeout=setTimeout(function(){c.debug()&&console.log("ForerunnerDB.Collection: Emitting "+
g[0]);c.emit.apply(c,g)},100))};f.prototype.processQueue=function(c,g){var a=this._deferQueue[c],b=this._deferThreshold[c],e=this._deferTime[c];if(a.length){var f=this;a.length&&(a=a.length>b?a.splice(0,b):a.splice(0,a.length),this[c](a));setTimeout(function(){f.processQueue(c,g)},e)}else g&&g()};f.prototype.insert=function(c,g,a){"function"===typeof g?(a=g,g=this._data.length):void 0===g&&(g=this._data.length);c=this.transformIn(c);return this._insertHandle(c,g,a)};f.prototype._insertHandle=function(c,
g,a){var b=this._deferQueue.insert,e=this._deferThreshold.insert,f=[],d=[],h=this._views;if(c instanceof Array){if(c.length>e){this._deferQueue.insert=b.concat(c);this.processQueue("insert",a);return}for(e=0;e<c.length;e++)b=this._insert(c[e],g+e),!0===b?f.push(c[e]):d.push({doc:c[e],reason:b})}else b=this._insert(c,g),!0===b?f.push(c):d.push({doc:c,reason:b});if(h&&h.length)for(b=0;b<h.length;b++)h[b].insert(c,g);this._onInsert(f,d);a&&a();this.deferEmit("change",{type:"insert",data:f});return{inserted:f,
failed:d}};f.prototype._insert=function(c,g){if(c){var a;this._ensurePrimaryKey(c);if(a=this.insertIndexViolation(c))return"Index violation in index: "+a;this._insertIndex(c);this._linked?jQuery.observable(this._data).insert(g,c):this._data.splice(g,0,c);return!0}return"No document passed to insert"};f.prototype._insertIndex=function(c){var g=this._indexByName,a,b=JSON.stringify(c);this._primaryIndex.uniqueSet(c[this._primaryKey],c);this._primaryCrc.uniqueSet(c[this._primaryKey],b);this._crcLookup.uniqueSet(b,
c);for(a in g)g.hasOwnProperty(a)&&g[a].insert(c)};f.prototype._removeIndex=function(c){var g=this._indexByName,a,b=JSON.stringify(c);this._primaryIndex.unSet(c[this._primaryKey]);this._primaryCrc.unSet(c[this._primaryKey]);this._crcLookup.unSet(b);for(a in g)g.hasOwnProperty(a)&&g[a].remove(c)};f.prototype.subset=function(c,g){var a=this.find(c,g);return(new f)._subsetOf(this).primaryKey(this._primaryKey).setData(a)};f.prototype.subsetOf=function(){return this.__subsetOf};f.prototype._subsetOf=function(c){this.__subsetOf=
c;return this};f.prototype.distinct=function(c,g,a){g=this.find(g,a);c=new e(c);a={};var b=[],f,d;for(d=0;d<g.length;d++)(f=c.value(g[d])[0])&&!a[f]&&(a[f]=!0,b.push(f));return b};f.prototype.decouple=function(c){return JSON.parse(JSON.stringify(c))};f.prototype.findById=function(c,g){var a={};a[this._primaryKey]=c;return this.find(a,g)[0]};f.prototype.peek=function(c,g){var a=this._data,b=a.length,e,d,h=new f;if("string"===typeof c){for(e=0;e<b;e++)d=JSON.stringify(a[e]),-1<d.indexOf(c)&&h.insert(a[e]);
return h.find({},g)}return this.find(c,g)};f.prototype.explain=function(c,g){return this.find(c,g).__fdbOp._data};f.prototype.find=function(c,g){c=c||{};g=g||{};g.decouple=void 0!==g.decouple?g.decouple:!0;var a=this._metrics.create("find"),b=this,f,d=!0,h,n,k,m,q,l,p,u,s,v=[];n=function(a){return b._match(a,c,"and")};a.start();if(c){a.time("analyseQuery");f=this._analyseQuery(c,g,a);a.time("analyseQuery");a.data("analysis",f);if(f.hasJoin&&f.queriesJoin){a.time("joinReferences");for(k=0;k<f.joinsOn.length;k++)q=
f.joinsOn[k],m=new e(f.joinQueries[q]),m=m.value(c)[0],this._db.collection(f.joinsOn[k]).subset(m);a.time("joinReferences")}f.indexMatch.length&&(!g||g&&!g.skipIndex)?(a.data("index.potential",f.indexMatch),a.data("index.used",f.indexMatch[0].index),a.time("indexLookup"),h=f.indexMatch[0].lookup,a.time("indexLookup"),f.indexMatch[0].keyData.totalKeyCount===f.indexMatch[0].keyData.matchedKeyCount&&(d=!1)):a.flag("usedIndex",!1);d&&(h&&h.length?(f=h.length,a.time("tableScan: "+f),h=h.filter(n)):(f=
this._data.length,a.time("tableScan: "+f),h=this._data.filter(n)),g.sort&&(a.time("sort"),h=this.sort(g.sort,h),a.time("sort")),a.time("tableScan: "+f));g.limit&&h&&h.length>g.limit&&(h.length=g.limit,a.data("limit",g.limit));g.decouple&&(a.time("decouple"),h=this.decouple(h),a.time("decouple"),a.data("flag.decouple",!0));if(g.join){for(n=0;n<g.join.length;n++)for(q in g.join[n])if(g.join[n].hasOwnProperty(q))for(u=q,f=this._db.collection(q),d=g.join[n][q],s=0;s<h.length;s++){p={};m=k=!1;for(l in d)if(d.hasOwnProperty(l))if("$"===
l.substr(0,1))switch(l){case "$as":u=d[l];break;case "$multi":k=d[l];break;case "$require":m=d[l];break;default:l.substr(0,3)}else p[l]=(new e(d[l])).value(h[s])[0];p=f.find(p);!m||m&&p[0]?h[s][u]=!1===k?p[0]:p:v.push(h[s])}a.data("flag.join",!0)}if(v.length){a.time("removalQueue");for(l=0;l<v.length;l++)q=h.indexOf(v[l]),-1<q&&h.splice(q,1);a.time("removalQueue")}if(g.transform){a.time("transform");for(l=0;l<h.length;l++)h.splice(l,1,g.transform(h[l]));a.time("transform");a.data("flag.transform",
!0)}this._transformEnabled&&this._transformOut&&(a.time("transformOut"),h=this.transformOut(h),a.time("transformOut"));a.data("results",h.length);a.stop()}else a.stop(),h=[];h.__fdbOp=a;return h};f.prototype.transform=function(c){return void 0!==c?("object"===typeof c?(void 0!==c.enabled&&(this._transformEnabled=c.enabled),void 0!==c.dataIn&&(this._transformIn=c.dataIn),void 0!==c.dataOut&&(this._transformOut=c.dataOut)):this._transformEnabled=!1===c?!1:!0,this):{enabled:this._transformEnabled,dataIn:this._transformIn,
dataOut:this._transformOut}};f.prototype.transformIn=function(c){if(this._transformEnabled&&this._transformIn){if(c instanceof Array){var a=[],b;for(b=0;b<c.length;b++)a[b]=this._transformIn(c[b]);return a}return this._transformIn(c)}return c};f.prototype.transformOut=function(c){if(this._transformEnabled&&this._transformOut){if(c instanceof Array){var a=[],b;for(b=0;b<c.length;b++)a[b]=this._transformOut(c[b]);return a}return this._transformOut(c)}return c};f.prototype.sort=function(c,a){a=a||[];
var b=[],e,f;for(e in c)c.hasOwnProperty(e)&&(f={},f[e]=c[e],f.___fdbKey=e,b.push(f));return 2>b.length?this._sort(c,a):this._bucketSort(b,a)};f.prototype._bucketSort=function(c,a){var b=c.shift(),e,f,h=[];if(0<c.length){a=this._sort(b,a);e=this.bucket(b.___fdbKey,a);for(f in e)e.hasOwnProperty(f)&&(b=[].concat(c),h=h.concat(this._bucketSort(b,e[f])));return h}return this._sort(b,a)};f.prototype._sort=function(c,a){var b=new e,f=b.parse(c,!0)[0];b.path(f.path);return a.sort(1===f.value?function(c,
a){var g=b.value(c)[0],e=b.value(a)[0];return"string"===typeof g&&"string"===typeof e?g.localeCompare(e):g>e?1:g<e?-1:0}:function(c,a){var g=b.value(c)[0],e=b.value(a)[0];return"string"===typeof g&&"string"===typeof e?1===g.localeCompare(e)?-1:1:g>e?-1:g<e?1:0})};f.prototype.bucket=function(c,a){var b,e={};for(b=0;b<a.length;b++)e[a[b][c]]=e[a[b][c]]||[],e[a[b][c]].push(a[b]);return e};f.prototype._analyseQuery=function(c,a,b){var f={queriesOn:[this._name],indexMatch:[],hasJoin:!1,queriesJoin:!1,
joinQueries:{},query:c,options:a},h,d=[],n=[],k,m,p,q,l;b.time("checkIndexes");void 0!==c[this._primaryKey]&&(b.time("checkIndexMatch: Primary Key"),k=new e,f.indexMatch.push({lookup:this._primaryIndex.lookup(c,a),keyData:{matchedKeys:[this._primaryKey],matchedKeyCount:1,totalKeyCount:k.countKeys(c)},index:this._primaryIndex}),b.time("checkIndexMatch: Primary Key"));for(l in this._indexById)if(this._indexById.hasOwnProperty(l)&&(m=this._indexById[l],p=m.name(),b.time("checkIndexMatch: "+p),k=m.match(c,
a),q=m.lookup(c,a),0<k.matchedKeyCount&&f.indexMatch.push({lookup:q,keyData:k,index:m}),b.time("checkIndexMatch: "+p),k.totalKeyCount===k.matchedKeyCount))break;b.time("checkIndexes");1<f.indexMatch.length&&(b.time("findOptimalIndex"),f.indexMatch.sort(function(c,a){return c.keyData.totalKeyCount===c.keyData.matchedKeyCount?-1:a.keyData.totalKeyCount===a.keyData.matchedKeyCount?1:c.keyData.matchedKeyCount===a.keyData.matchedKeyCount?c.lookup.length-a.lookup.length:a.keyData.matchedKeyCount-c.keyData.matchedKeyCount}),
b.time("findOptimalIndex"));if(a.join){f.hasJoin=!0;for(b=0;b<a.join.length;b++)for(h in a.join[b])a.join[b].hasOwnProperty(h)&&(d.push(h),"$as"in a.join[b][h]?n.push(a.join[b][h].$as):n.push(h));for(h=0;h<n.length;h++)if(a=this._queryReferencesCollection(c,n[h],""))f.joinQueries[d[h]]=a,f.queriesJoin=!0;f.joinsOn=d;f.queriesOn=f.queriesOn.concat(d)}return f};f.prototype._queryReferencesCollection=function(c,a,b){for(var e in c)if(c.hasOwnProperty(e)){if(e===a)return b&&(b+="."),b+e;if("object"===
...
Array&&a[d]&&"object"!==typeof a[d]){e=!1;for(f=0;f<c[d].length&&!(e=this._match(c[d][f],a[d],void 0));f++);if(e){if("or"===b)return!0}else h=!1}else h=!1;if("and"===b&&!h)return!1}return h};f.prototype.count=function(a,b){return a?this.find(a,b).length:this._data.length};f.prototype.link=function(a,b){if(window.jQuery){this._links=this._links||{};if(!this._links[b]){if(jQuery(a).length){if(!jQuery.templates[b]){var e=jQuery(b);if(e.length)jQuery.views.templates(b,jQuery(e[0]).html());else throw"Unable to bind collection to target because template does not exist: "+
b;}jQuery.templates[b].link(a,this._data);this._links[b]=a;this._linked++;this.debug()&&console.log('ForerunnerDB.Collection: Added binding collection "'+this.name()+'" to output target: '+a);return this}throw'Cannot bind view data to output target selector "'+a+'" because it does not exist in the DOM!';}throw"Cannot create a duplicate link to the target: "+a+" with the template: "+b;}throw"Cannot data-bind without jQuery, please add jQuery to your page!";};f.prototype.unlink=function(a,b){if(window.jQuery){this._links=
this._links||{};if(this._links[b])return jQuery.templates[b].unlink(a),delete this._links[b],this._linked--,this.debug()&&console.log('ForerunnerDB.Collection: Removed binding collection "'+this.name()+'" to output target: '+a),this;console.log("Cannot remove link, one does not exist to the target: "+a+" with the template: "+b)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";};f.prototype.findSub=function(a,b,f,d){var h=new e(b);a=this.find(a);var n=a.length,k,m,p=this._db.collection("__FDB_temp_"+
this.objectId()),t={parents:n,subDocTotal:0,subDocs:[],pathFound:!1,err:""};for(k=0;k<n;k++)if(m=h.value(a[k])[0]){p.setData(m);m=p.find(f,d);if(d.returnFirst&&m.length)return m[0];t.subDocs.push(m);t.subDocTotal+=m.length;t.pathFound=!0}p.drop();if(d.noStats)return t.subDocs;t.pathFound||(t.err="No objects found in the parent documents with a matching path of: "+b);return t};f.prototype.insertIndexViolation=function(a){var b,e=this._indexByName,f,d;if(this._primaryIndex.get(a[this._primaryKey]))b=
this._primaryIndex;else for(f in e)if(e.hasOwnProperty(f)&&(d=e[f],d.unique()&&d.violation(a))){b=d;break}return b?b.name():!1};f.prototype.ensureIndex=function(c,b){this._indexByName=this._indexByName||{};this._indexById=this._indexById||{};var e=new a(c,b,this),f={start:(new Date).getTime()};if(this._indexByName[e.name()])return{err:"Index with that name already exists"};if(this._indexById[e.id()])return{err:"Index with those keys already exists"};e.rebuild();this._indexByName[e.name()]=e;this._indexById[e.id()]=
e;f.end=(new Date).getTime();f.total=f.end-f.start;this._lastOp={type:"ensureIndex",stats:{time:f}};return{index:e,id:e.id(),name:e.name(),state:e.state()}};f.prototype.index=function(a){if(this._indexByName)return this._indexByName[a]};f.prototype.lastOp=function(){return this._metrics.list()};f.prototype.objectId=function(a){var b=Math.pow(10,17);if(a){var e=0,f=a.length,h;for(h=0;h<f;h++)e+=a.charCodeAt(h)*b;a=e.toString(16)}else d.idCounter++,a=(d.idCounter+(Math.random()*b+Math.random()*b+Math.random()*
b+Math.random()*b)).toString(16);return a};f.prototype.diff=function(a){var b={insert:[],update:[],remove:[]},e=this.primaryKey(),f,d,h,n;if(e===a.primaryKey()){f=a._data;n=f.length;for(d=0;d<n;d++)h=f[d],this._primaryIndex.get(h[e])?this._primaryCrc.get(h[e])!==a._primaryCrc.get(h[e])&&b.update.push(h):b.insert.push(h);f=this._data;n=f.length;for(d=0;d<n;d++)h=f[d],a._primaryIndex.get(h[e])||b.remove.push(h)}return b};k.prototype.collection=function(a,b){if(a)return this._collection[a]||this.debug()&&
...
"./Metrics":7,"./Overload":9,"./Path":10,"./Shared":11}],3:[function(k,p,m){var d,b;d=k("./Shared.js");var h=function(){this.init.apply(this,arguments)};h.prototype.init=function(){this._collection={};this._debug={}};d.modules.Core=h;m=k("./Overload.js");b=k("./Collection.js");k("./Metrics.js");k=k("./Crc.js");h.prototype._isServer=!1;h.prototype.isClient=function(){return!this._isServer};h.prototype.isServer=function(){return this._isServer};h.prototype.crc=k;h.prototype.isClient=function(){return!this._isServer};
h.prototype.isServer=function(){return this._isServer};h.prototype.decouple=function(b){return JSON.parse(JSON.stringify(b))};h.prototype.debug=new m([function(){return this._debug.all},function(b){return void 0!==b&&"boolean"===typeof b?(this._debug.all=b,this):this._debug.all},function(b,a){return void 0!==b?void 0!==a?(this._debug[b]=a,this):this._debug[b]:this._debug.all}]);h.prototype.arrayToCollection=function(e){return(new b).setData(e)};h.prototype.on=function(b,a){this._listeners=this._listeners||
{};this._listeners[b]=this._listeners[b]||[];this._listeners[b].push(a);return this};h.prototype.off=function(b,a){if(b in this._listeners){var d=this._listeners[b],f=d.indexOf(a);-1<f&&d.splice(f,1)}return this};h.prototype.emit=function(b,a){this._listeners=this._listeners||{};if(b in this._listeners){var d=this._listeners[b],f=d.length,c;for(c=0;c<f;c++)d[c].apply(this,Array.prototype.slice.call(arguments,1))}return this};h.prototype.objectId=function(b){var a,h,f=Math.pow(10,17),c;if(b){a=0;h=
b.length;for(c=0;c<h;c++)a+=b.charCodeAt(c)*f;b=a.toString(16)}else d.idCounter++,b=(d.idCounter+(Math.random()*f+Math.random()*f+Math.random()*f+Math.random()*f)).toString(16);return b};h.prototype.peek=function(b){var a,d,f=[],c=typeof b;for(a in this._collection)this._collection.hasOwnProperty(a)&&(d=this._collection[a],f="string"===c?f.concat(d.peek(b)):f.concat(d.find(b)));return f};h.prototype.peekCat=function(b){var a,d,f={},c,h=typeof b;for(a in this._collection)this._collection.hasOwnProperty(a)&&
(d=this._collection[a],(c="string"===h?d.peek(b):d.find(b))&&c.length&&(f[d.name()]=c));return f};p.exports=h},{"./Collection.js":2,"./Crc.js":4,"./Metrics.js":7,"./Overload.js":9,"./Shared.js":11}],4:[function(k,p,m){var d=function(){var b=[],d,e,a;for(e=0;256>e;e++){d=e;for(a=0;8>a;a++)d=d&1?3988292384^d>>>1:d>>>1;b[e]=d}return b}();p.exports=function(b){var h=-1,e;for(e=0;e<b.length;e++)h=h>>>8^d[(h^b.charCodeAt(e))&255];return(h^-1)>>>0}},{}],5:[function(k,p,m){m=k("./Shared");var d=k("./Path");
...
p.exports=k},{"./Operation":8,"./Shared":11}],8:[function(k,p,m){m=k("./Shared");var d=k("./Path");k=function(b){this.pathSolver=new d;this.counter=0;this.init.apply(this,arguments)};k.prototype.init=function(b){this._data={operation:b,index:{potential:[],used:!1},steps:[],time:{startMs:0,stopMs:0,totalMs:0,process:{}},flag:{},log:[]}};m.modules.Operation=k;k.prototype.start=function(){this._data.time.startMs=(new Date).getTime()};k.prototype.log=function(b){if(b){var d=0<this._log.length?this._data.log[this._data.log.length-
1].time:0;b={event:b,time:(new Date).getTime(),delta:0};this._data.log.push(b);d&&(b.delta=b.time-d);return this}return this._data.log};k.prototype.time=function(b){if(void 0!==b){var d=this._data.time.process,d=d[b]=d[b]||{};d.startMs?(d.stopMs=(new Date).getTime(),d.totalMs=d.stopMs-d.startMs,d.stepObj.totalMs=d.totalMs,delete d.stepObj):(d.startMs=(new Date).getTime(),d.stepObj={name:b},this._data.steps.push(d.stepObj));return this}return this._data.time};k.prototype.flag=function(b,d){if(void 0!==
b&&void 0!==d)this._data.flag[b]=d;else return void 0!==b?this._data.flag[b]:this._data.flag};k.prototype.data=function(b,d,e){return void 0!==d?(this.pathSolver.set(this._data,b,d),this):this.pathSolver.get(this._data,b)};k.prototype.pushData=function(b,d,e){this.pathSolver.push(this._data,b,d)};k.prototype.stop=function(){this._data.time.stopMs=(new Date).getTime();this._data.time.totalMs=this._data.time.stopMs-this._data.time.startMs};p.exports=k},{"./Path":10,"./Shared":11}],9:[function(k,p,m){m=
function(d){if(d){var b,h=d.length;return function(){for(b=0;b<h;b++)if(d[b].length===arguments.length)return d[b].apply(this,arguments);return null}}return function(){}};k("./Shared").modules.Overload=m;p.exports=m},{"./Shared":11}],10:[function(k,p,m){k=k("./Shared");m=function(d){this.init.apply(this,arguments)};m.prototype.init=function(d){d&&this.path(d)};k.modules.Path=m;m.prototype.path=function(d){return void 0!==d?(this._path=this.clean(d),this._pathParts=this._path.split("."),this):this._path};
m.prototype.hasObjectPaths=function(d,b){var h=!0,e;for(e in d)if(d.hasOwnProperty(e)&&(void 0===b[e]||"object"===typeof d[e]&&(h=this.hasObjectPaths(d[e],b[e]),!h)))return!1;return h};m.prototype.countKeys=function(d){var b=0,h;for(h in d)d.hasOwnProperty(h)&&void 0!==d[h]&&("object"!==typeof d[h]?b++:b+=this.countKeys(d[h]));return b};m.prototype.countObjectPaths=function(d,b){var h,e={},a=0,k=0,f;for(f in b)b.hasOwnProperty(f)&&("object"===typeof b[f]?(h=this.countObjectPaths(d[f],b[f]),e[f]=h.matchedKeys,
k+=h.totalKeyCount,a+=h.matchedKeyCount):(k++,d&&d[f]&&"object"!==typeof d[f]?(e[f]=!0,a++):e[f]=!1));return{matchedKeys:e,matchedKeyCount:a,totalKeyCount:k}};m.prototype.parse=function(d,b){var h=[],e="",a,k,f;for(k in d)if(d.hasOwnProperty(k))if(e=k,"object"===typeof d[k])if(b)for(a=this.parse(d[k],b),f=0;f<a.length;f++)h.push({path:e+"."+a[f].path,value:a[f].value});else for(a=this.parse(d[k]),f=0;f<a.length;f++)h.push({path:e+"."+a[f].path});else b?h.push({path:e,value:d[k]}):h.push({path:e});
return h};m.prototype.parseArr=function(d,b){b=b||{};return this._parseArr(d,"",[],b)};m.prototype._parseArr=function(d,b,h,e){var a,k="";b=b||"";h=h||[];for(a in d)d.hasOwnProperty(a)&&(!e.ignore||e.ignore&&!e.ignore.test(a))&&(k=b?b+"."+a:a,"object"===typeof d[a]?this._parseArr(d[a],k,h,e):h.push(k));return h};m.prototype.value=function(d,b){if(void 0!==d&&"object"===typeof d){var h,e,a,k,f=[],c;void 0!==b&&(b=this.clean(b),h=b.split("."));h=h||this._pathParts;e=h.length;a=d;for(c=0;c<e;c++){a=
a[h[c]];if(k instanceof Array){for(e=0;e<k.length;e++)f=f.concat(this.value(k,e+"."+h[c]));return f}if(!a||"object"!==typeof a)break;k=a}return[a]}return[]};m.prototype.set=function(d,b,h){if(void 0!==d&&void 0!==b){var e;b=this.clean(b);b=b.split(".");e=b.shift();b.length?(d[e]=d[e]||{},this.set(d[e],b.join("."),h)):d[e]=h}return d};m.prototype.get=function(d,b){return this.value(d,b)[0]};m.prototype.push=function(d,b,h){if(void 0!==d&&void 0!==b){var e;b=this.clean(b);b=b.split(".");e=b.shift();
...
'"');return this._privateData.remove(a)};e.prototype.link=function(a,b){var d=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Setting up data binding on view "'+this.name()+'" in underlying (internal) view collection "'+d.name()+'" for output target: '+a);return d.link(a,b)};e.prototype.unlink=function(a,b){var d=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Removing data binding on view "'+this.name()+'" in underlying (internal) view collection "'+d.name()+'" for output target: '+
a);return d.unlink(a,b)};e.prototype.from=function(a){void 0!==a&&("string"===typeof a&&(a=this._db.collection(a)),this._addCollection(a));return this};e.prototype._addCollection=function(a){if(-1===this._collections.indexOf(a)){this._collections.push(a);a._addView(this);var b=a.find(this._querySettings.query,this._querySettings.options);this._transformPrimaryKey(a.primaryKey());this._transformInsert(b);this._privateData.primaryKey(a.primaryKey());this._privateData.insert(b)}return this};e.prototype._removeCollection=
...
this._publicData&&this._publicData.update(a,b)};e.prototype._transformRemove=function(a){this._transformEnabled&&this._publicData&&this._publicData.remove(a)};e.prototype._transformPrimaryKey=function(a){this._transformEnabled&&this._publicData&&this._publicData.primaryKey(a)};d.prototype.init=function(){this._views=[];b.apply(this,arguments)};d.prototype.view=function(a,b,d){a=(new e(a,b,d)).db(this._db)._addCollection(this);this._views=this._views||[];this._views.push(a);return a};d.prototype._addView=
function(a){void 0!==a&&this._views.push(a);return this};d.prototype._removeView=function(a){void 0!==a&&(a=this._views.indexOf(a),-1<a&&this._views.splice(a,1));return this};m.prototype.init=function(){this._views={};h.apply(this,arguments)};m.prototype.view=function(a){this._views[a]||(this.debug()||this._db&&this._db.debug())&&console.log("Core.View: Creating view "+a);this._views[a]=this._views[a]||(new e(a)).db(this);return this._views[a]};m.prototype.viewExists=function(a){return Boolean(this._views[a])};
m.prototype.views=function(){var a=[],b;for(b in this._views)this._views.hasOwnProperty(b)&&a.push({name:b,count:this._views[b].count()});return a};p.exports=e},{"./Collection":2,"./Overload":9,"./Shared":11}]},{},[1])(1)});
