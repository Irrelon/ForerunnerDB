...
delete this._links[g],this._linked--,this.debug()&&console.log('ForerunnerDB.Collection: Removed binding collection "'+this.name()+'" to output target: '+b),this;console.log("Cannot remove link, one does not exist to the target: "+b+" with the template: "+a)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";return this};b.prototype._dataReplace=function(b){this._linked?jQuery.observable(this._data).refresh(b):hb.apply(this,arguments)};b.prototype._dataInsertAtIndex=function(b,
a){this._linked?jQuery.observable(this._data).insert(b,a):v.apply(this,arguments)};b.prototype._dataRemoveAtIndex=function(b){this._linked?jQuery.observable(this._data).remove(b):ea.apply(this,arguments)};b.prototype._updateProperty=function(b,a,g){this._linked?(jQuery.observable(b).setProperty(a,g),this.debug()&&console.log('ForerunnerDB.Collection: Setting data-bound document property "'+a+'" for collection "'+this.name()+'"')):k.apply(this,arguments)};b.prototype._updateIncrement=function(b,a,
g){this._linked?jQuery.observable(b).setProperty(a,b[a]+g):P.apply(this,arguments)};b.prototype._updateSpliceMove=function(b,a,g){this._linked?(jQuery.observable(b).move(a,g),this.debug()&&console.log('ForerunnerDB.Collection: Moving data-bound document array index from "'+a+'" to "'+g+'" for collection "'+this.name()+'"')):S.apply(this,arguments)};b.prototype._updateSplicePush=function(b,a,g){this._linked?b.length>a?jQuery.observable(b).insert(a,g):jQuery.observable(b).insert(g):H.apply(this,arguments)};
b.prototype._updatePush=function(b,a){this._linked?jQuery.observable(b).insert(a):ja.apply(this,arguments)};b.prototype._updatePull=function(b,a){this._linked?jQuery.observable(b).remove(a):L.apply(this,arguments)};b.prototype._updateMultiply=function(b,a,g){this._linked?jQuery.observable(b).setProperty(a,b[a]*g):qa.apply(this,arguments)};b.prototype._updateRename=function(b,a,g){this._linked?(jQuery.observable(b).setProperty(g,b[a]),jQuery.observable(b).removeProperty(a)):oa.apply(this,arguments)};
b.prototype._updateUnset=function(b,a){this._linked?jQuery.observable(b).removeProperty(a):$.apply(this,arguments)};b.prototype._updatePop=function(b,a){var g,v=!1;this._linked?0<b.length&&(1===a?g=b.length-1:-1===a&&(g=0),-1<g&&(jQuery.observable(arr).remove(g),v=!0)):v=aa.apply(this,arguments);return v}};k.extendView=function(b){var a=b.prototype.init;b.prototype.init=function(){this._linked=0;a.apply(this,arguments)};b.prototype.isLinked=function(){return this.data().isLinked()};b.prototype.link=
function(b,a){var g=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Setting up data binding on view "'+this.name()+'" in underlying (internal) view collection "'+g.name()+'" for output target: '+b);g.link(b,a);return this};b.prototype.unlink=function(b,a){var g=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Removing data binding on view "'+this.name()+'" in underlying (internal) view collection "'+g.name()+'" for output target: '+b);g.unlink(b,a);return this}};k.extendOverview=
function(b){b.prototype.isLinked=function(){return this.data().isLinked()};b.prototype.link=function(b,a){this._data.link.apply(this._data,arguments);this._refresh()};b.prototype.unlink=function(b,a){this._data.unlink.apply(this._data,arguments);this._refresh()}};k.extendDocument=function(b){b.prototype.isLinked=function(){return Boolean(this._linked)};b.prototype.link=function(b,a){if(window.jQuery){this._links=this._links||{};this._linked||(this._linked=0);var v,k;a&&"object"===typeof a?a.template&&
"string"===typeof a.template&&(v=this.objectId(a.template),k=a.template):v=a;if(!this._links[v]){if(jQuery(b).length){if(!jQuery.templates[v]){if(!k)if(k=jQuery(a),k.length)k=jQuery(k[0]).html();else throw"Unable to bind document to target because template does not exist: "+a;jQuery.views.templates(v,k)}jQuery.templates[v].link(b,this._data);this._links[v]=b;this._linked++;this.debug()&&console.log('ForerunnerDB.Document: Added binding document "'+this.name()+'" to output target: '+b);return this}throw'Cannot bind view data to output target selector "'+
