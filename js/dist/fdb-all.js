...
var Core=_dereq_("../lib/Core"),CollectionGroup=_dereq_("../lib/CollectionGroup"),View=_dereq_("../lib/View"),Highchart=_dereq_("../lib/Highchart"),Persist=_dereq_("../lib/Persist"),Document=_dereq_("../lib/Document"),Overview=_dereq_("../lib/Overview");module.exports=Core;
