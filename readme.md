...
- [ForerunnerDB - A NoSQL JSON Document DB](#forerunnerdb---a-nosql-json-document-db)
  - [Version 1.3.750](#version-13750)
      - [TravisCI Build Test Status](#travisci-build-test-status)
    - [Standout Features](#standout-features)
  - [What is ForerunnerDB](#what-is-forerunnerdb)
  - [What is ForerunnerDB's Primary Use Case?](#what-is-forerunnerdbs-primary-use-case)
  - [Download](#download)
    - [NPM](#npm)
    - [NPM Dev Builds](#npm-dev-builds)
    - [Bower](#bower)
    - [No Package Manager](#no-package-manager)
- [How to Use](#how-to-use)
  - [Use ForerunnerDB in *Browser*](#use-forerunnerdb-in-browser)
  - [Use ForerunnerDB in *Node.js*](#use-forerunnerdb-in-nodejs)
  - [Create a Database](#create-a-database)
  - [Collections (Tables)](#collections-tables)
    - [Auto-Creation](#auto-creation)
    - [Specifying a Primary Key Up-Front](#specifying-a-primary-key-up-front)
    - [Capped Collections](#capped-collections)
  - [Inserting Documents](#inserting-documents)
    - [Inserting Special Objects](#inserting-special-objects)
      - [Supported Instance Types and Usage](#supported-instance-types-and-usage)
        - [Date](#date)
        - [RegExp](#regexp)
      - [Adding Custom Types to the Serialiser](#adding-custom-types-to-the-serialiser)
  - [Searching the Collection](#searching-the-collection)
    ...
    - [Query Operators](#query-operators)
      ...
      - [$distinct](#distinct)
        - [Usage](#usage-10)
      - [$count](#count)
        - [Select Documents Where The "arr" Array Field Has Only 1 Item](#select-documents-where-the-arr-array-field-has-only-1-item)
        - [Select Documents Where The "arr" Array Field Has More Than 1 Item](#select-documents-where-the-arr-array-field-has-more-than-1-item)
      - [$or](#or)
        - [Usage](#usage-11)
      - [$and](#and)
        - [Usage](#usage-12)
    ...
    - [Projection](#projection)
      ...
      - [$near](#near)
        - [Usage](#usage-17)
    - [Ordering / Sorting Results](#ordering--sorting-results)
    - [Limiting Return Fields](#limiting-return-fields)
      - [Usage](#usage-18)
    - [Pagination / Paging Through Results](#pagination--paging-through-results)
      - [Usage](#usage-19)
    - [Skipping Records in a Query](#skipping-records-in-a-query)
      - [Usage](#usage-20)
    - [Finding and Returning Sub-Documents](#finding-and-returning-sub-documents)
    - [Subqueries and Subquery Syntax](#subqueries-and-subquery-syntax)
  ...
  - [Get Data Item By Reference](#get-data-item-by-reference)
  - [Primary Keys](#primary-keys)
  - [Removing Documents](#removing-documents)
    - [Joins](#joins)
      - [Advanced Joins Using $where](#advanced-joins-using-where)
      - [Placing Results $as: "$root"](#placing-results-as-root)
  - [Triggers](#triggers)
    - [Example 1: Cancel Operation Before Insert Trigger](#example-1-cancel-operation-before-insert-trigger)
    - [Example 2: Modify a Document Before Update](#example-2-modify-a-document-before-update)
    - [Enabling / Disabling Triggers](#enabling--disabling-triggers)
      - [Enabling a Trigger](#enabling-a-trigger)
        - [Enable a Trigger via Trigger ID](#enable-a-trigger-via-trigger-id)
        - [Enable a Trigger via Type](#enable-a-trigger-via-type)
        - [Enable a Trigger via Type and Phase](#enable-a-trigger-via-type-and-phase)
        - [Enable a Trigger via ID, Type and Phase](#enable-a-trigger-via-id-type-and-phase)
      - [Disabling a Trigger](#disabling-a-trigger)
        - [Disable a Trigger via Trigger ID](#disable-a-trigger-via-trigger-id)
        - [Disable a Trigger via Type](#disable-a-trigger-via-type)
        - [Disable a Trigger via Type and Phase](#disable-a-trigger-via-type-and-phase)
        - [Disable a Trigger via ID, Type and Phase](#disable-a-trigger-via-id-type-and-phase)
    - [Trigger Recursion Protection](#trigger-recursion-protection)
  - [Events](#events)
    - [insert](#insert)
    - [update](#update)
    - [remove](#remove)
  ...
  - [Indices & Performance](#indices-&-performance)
    - [Index Types (Choosing the Type of Index to Use)](#index-types-choosing-the-type-of-index-to-use)
      - [Example of Creating a B-Tree Index](#example-of-creating-a-b-tree-index)
      - [Example of Creating a Geo-Spatial 2d Index](#example-of-creating-a-geo-spatial-2d-index)
      - [Example of Creating a Hash Table Index](#example-of-creating-a-hash-table-index)
  - [Geo-Spatial (2d) Queries](#geo-spatial-2d-queries)
  - [Data Persistence (Save and Load Between Pages)](#data-persistence-save-and-load-between-pages)
    - [Data Persistence In Browser](#data-persistence-in-browser)
      - [Manually Specifying Storage Engine](#manually-specifying-storage-engine)
        - [IndexedDB](#indexeddb)
        - [WebSQL](#websql)
        - [LocalStorage](#localstorage)
    - [Data Persistence In Node.js](#data-persistence-in-nodejs)
    - [Both Browser and Node.js](#both-browser-and-nodejs)
      - [Plugins](#plugins)
      - [Data Compression and Encryption](#data-compression-and-encryption)
        - [Compression](#compression)
        - [Encryption](#encryption)
  - [Storing Arbitrary Key/Value Data](#storing-arbitrary-keyvalue-data)
  - [Collection Groups](#collection-groups)
    - [Adding and Removing Collections From a Group](#adding-and-removing-collections-from-a-group)
  - [Grid / Table Output](#grid--table-output)
      - [Prerequisites](#prerequisites)
      - [Grid Template](#grid-template)
      - [Creating a Grid](#creating-a-grid)
      - [Auto-Sorting Tools](#auto-sorting-tools)
  - [Views](#views)
      - [Instantiating a View](#instantiating-a-view)
      - [Specify an Underlying Data Source](#specify-an-underlying-data-source)
      - [Setting a View's Query](#setting-a-views-query)
  - [Overviews](#overviews)
  - [Data Binding](#data-binding)
    ...
    - [HTML](#html-1)
    - [JS](#js-1)
  - [Bespoke / Runtime Templates](#bespoke--runtime-templates)
  - [Wrapping Data](#wrapping-data)
  - [Highcharts: Charts & Visualisations](#highcharts-charts-&-visualisations)
    - [Prerequisites](#prerequisites-2)
    - [Usage](#usage-21)
      - [collection.pieChart()](#collectionpiechart)
      - [collection.lineChart()](#collectionlinechart)
      - [Other Chart Types](#other-chart-types)
    - [Removing a Chart](#removing-a-chart)
- [Special Considerations](#special-considerations)
  - [Queries](#queries)
    - [The Dollar Symbol](#the-dollar-symbol)
    - [The Double-Slash](#the-double-slash)
- [Differences Between ForerunnerDB and MongoDB](#differences-between-forerunnerdb-and-mongodb)
  - [find](#find)
  - [update](#update-1)
- [License](#license)
- [Browser Compatibility](#browser-compatibility)
- [Distribution Files](#distribution-files)
- [Chrome Extension: ForerunnerDB Explorer](#chrome-extension-forerunnerdb-explorer)
- [Development](#development)
  - [Unit Tests](#unit-tests)
  - [Building / Compiling](#building--compiling)
    - [Development Process](#development-process)
    - [Notes on the Chain Reactor System](#notes-on-the-chain-reactor-system)
    - [Notes on View Data Propagation and Synchronisation](#notes-on-view-data-propagation-and-synchronisation)
  - [Contributing to This Project](#contributing-to-this-project)
- [iOS Version](#ios-version)
- [Future Updates](#future-updates)
    - [Future Updates](#future-updates-1)
      - [Query operators still to implement](#query-operators-still-to-implement)
      - [Scheduled Features - Version 1.3](#scheduled-features---version-13)
      - [Scheduled Features - Version 1.4](#scheduled-features---version-14)
      - [Scheduled Features - Version 1.5](#scheduled-features---version-15)
      - [Scheduled Features - Version 1.6](#scheduled-features---version-16)
      - [Version 2.0](#version-20)
- [Breaking Changes](#breaking-changes)
  - [Since Version 1.3.669](#since-version-13669)
  - [Since Version 1.3.36](#since-version-1336)
  - [Since Version 1.3.10](#since-version-1310)
- [ForerunnerDB Built-In JSON REST API Server](#forerunnerdb-built-in-json-rest-api-server)
    - [Using the REST API](#using-the-rest-api)
        - [Accessing all collection's documents:](#accessing-all-collections-documents)
        - [Accessing an individual document in a collection by id:](#accessing-an-individual-document-in-a-collection-by-id)
        - [Creating a new document:](#creating-a-new-document)
        - [Replacing a document by id:](#replacing-a-document-by-id)
        - [Updating a document by id:](#updating-a-document-by-id)
        - [Deleting a document by id:](#deleting-a-document-by-id)
    - [Creating Your Own Routes](#creating-your-own-routes)
      - [Serving Static Content](#serving-static-content)
      - [Customising Further](#customising-further)
      - [Routes That ForerunnerDB Uses](#routes-that-forerunnerdb-uses)
      - [Default Middleware](#default-middleware)
- [AngularJS and Ionic Support](#angularjs-and-ionic-support)
- [Ionic Example App](#ionic-example-app)
