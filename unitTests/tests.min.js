...
test("Collection.upsert() :: Insert on upsert call",function(){var a=user.findById("1");ok(!a,"Failed!");a=user.upsert(singleUserObject);ok("insert"===a.op,"Failed!");a=user.findById("1");ok(a,"Failed!")});test("Collection.upsert() :: Update on upsert call",function(){var a=user.findById("1");ok(a,"Failed!");a=JSON.parse(JSON.stringify(singleUserObject));a.updated=!0;a=user.upsert(a);ok("update"===a.op,"Failed!");a=user.findById("1");ok(!0===a.updated,"Failed!")});
