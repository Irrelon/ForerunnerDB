...
name:"hello"});var a=$("#testTarget").find("#2342");ok(1===a.length,"Insert single document");user.remove({_id:"2342"});a=$("#testTarget").find("#2342");ok(0===a.length,"Remove single document");viewDown();domDown();dbDown()});test("Bind - View.on() :: Insert from CollectionGroup via Collection Interface",function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("insert",function(){ok(!0,"Collection insert")});userView.on("insert",function(){ok(!0,"View insert")});userGroup.on("insert",function(){ok(!0,
"Group insert")});userGroupView.on("insert",function(){ok(!0,"View from group insert")});userGroupView.bind("#testTarget",{template:function(a,b){b('<li id="'+a._id+'">'+a.name+"</li>")}});user.insert({_id:"2342",name:"hello"});var a=$("#testTarget").find("#2342");ok(1===a.length,"Insert single document");domDown();viewGroupDown();viewDown();dbDown()});test("Bind - View.on() :: Update from CollectionGroup via Collection Interface",function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("update",
function(){ok(!0,"Collection update")});userView.on("update",function(){ok(!0,"View update")});userGroup.on("update",function(){ok(!0,"Group update")});userGroupView.on("update",function(){ok(!0,"View from group update")});userGroupView.bind("#testTarget",{template:function(a,b){b('<li id="'+a._id+'">'+a.name+"</li>")}});user.insert({_id:"2342",name:"hello"});var a=$("#testTarget").find("#2342").text();ok("hello"===a,"Insert single document");user.update({_id:"2342"},{name:"hello2"});a=$("#testTarget").find("#2342").text();
ok("hello2"===a,"Update single document");viewGroupDown();viewDown();dbDown()});test("Bind - View.on() :: Remove from CollectionGroup via Collection Interface",function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("remove",function(){ok(!0,"Collection remove")});userView.on("remove",function(){ok(!0,"View remove")});userGroup.on("remove",function(){ok(!0,"Group remove")});userGroupView.on("remove",function(){ok(!0,"View from group remove")});userGroupView.bind("#testTarget",{template:function(a,
b){b('<li id="'+a._id+'">'+a.name+"</li>")}});user.insert({_id:"2342",name:"hello"});var a=$("#testTarget").find("#2342");ok(1===a.length,"Insert single document");user.remove({_id:"2342"});a=$("#testTarget").find("#2342");ok(0===a.length,"Remove single document");domDown();viewGroupDown();viewDown();dbDown()});test("Bind - View.on() :: Insert from CollectionGroup via CollectionGroup Interface",function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("insert",function(){ok(!0,"Collection insert")});
userView.on("insert",function(){ok(!0,"View insert")});userGroup.on("insert",function(){ok(!0,"Group insert")});userGroupView.on("insert",function(){ok(!0,"View from group insert")});userGroupView.bind("#testTarget",{template:function(a,b){b('<li id="'+a._id+'">'+a.name+"</li>")}});userGroup.insert({_id:"2342",name:"hello"});var a=$("#testTarget").find("#2342");ok(1===a.length,"Insert single document");domDown();viewGroupDown();viewDown();dbDown()});test("Bind - View.on() :: Update from CollectionGroup via CollectionGroup Interface",
function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("update",function(){ok(!0,"Collection update")});userView.on("update",function(){ok(!0,"View update")});userGroup.on("update",function(){ok(!0,"Group update")});userGroupView.on("update",function(){ok(!0,"View from group update")});userGroupView.bind("#testTarget",{template:function(a,b){b('<li id="'+a._id+'">'+a.name+"</li>")}});userGroup.insert({_id:"2342",name:"hello"});var a=$("#testTarget").find("#2342").text();ok("hello"===a,
"Insert single document");userGroup.update({_id:"2342"},{name:"hello2"});a=$("#testTarget").find("#2342").text();ok("hello2"===a,"Update single document");viewGroupDown();viewDown();dbDown()});test("Bind - View.on() :: Remove from CollectionGroup via CollectionGroup Interface",function(){dbUp();dataUp();viewUp();viewGroupUp();domUp();user.on("remove",function(){ok(!0,"Collection remove")});userView.on("remove",function(){ok(!0,"View remove")});userGroup.on("remove",function(){ok(!0,"Group remove")});
