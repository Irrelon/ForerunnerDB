...
a?(this._db=a,this):this._db};e.prototype.setData=function(a){if(a){var b=this._data;this._data=[];this._data=this._data.concat(a);this.emit("setData",this._data,b)}return this};e.prototype.truncate=function(){this.emit("truncate",this._data);this._data.length=0;return this};e.prototype.upsert=function(a){var b={},c;if(a instanceof Array){b=[];for(c=0;c<a.length;c++)b.push(this.upsert(a[c]));return b}a[this._primaryKey]?(c={},c[this._primaryKey]=a[this._primaryKey],this.count(c)?b.op="update":b.op=
"insert"):b.op="insert";switch(b.op){case "insert":b.result=this.insert(a);break;case "update":b.result=this.update(c,a)}return b};e.prototype.update=function(a,b){var c=this,d=this.find(a,{decouple:!1}),f,p=function(d){return c._updateObject(d,b,a)};d.length&&(f=d.filter(p),f.length&&this._onUpdate(f));return f||[]};e.prototype.updateById=function(a,b){var c={};c[this._primaryKey]=a;return this.update(c,b)};e.prototype._updateObject=function(a,b,c,d){d=d||"";"."===d.substr(0,1)&&(d=d.substr(1,d.length-
1));var f=!1,p=!1,g,e,k,h,l;for(h in b)if(b.hasOwnProperty(h)){g=!1;if("$"===h.substr(0,1))switch(h){case "$inc":g=!0;for(l in b[h])if(b[h].hasOwnProperty(l))if("number"===typeof a[l])a[l]+=b[h][l],f=!0;else throw"Cannot increment field that is not a number! ("+l+")!";break;case "$push":g=!0;for(l in b[h])if(b[h].hasOwnProperty(l))if(a[l]instanceof Array)a[l].push(b[h][l]),f=!0;else throw"Cannot push to a key that is not an array! ("+l+")!";break;case "$pull":for(l in g=!0,b[h])if(b[h].hasOwnProperty(l))if(a[l]instanceof
