...
$(this);a.off.apply(a,arguments);return this};h.prototype.setData=function(a){a&&(this._data=[],this._data=this._data.concat(a),this._onUpdate(this._data));return this};h.prototype.truncate=function(){this._onRemove(this._data);this._data.length=0;return this};h.prototype.upsert=function(a){var b={},c;if(a instanceof Array){b=[];for(c=0;c<a.length;c++)b.push(this.upsert(a[c]));return b}a[this._primaryKey]?(c={},c[this._primaryKey]=a[this._primaryKey],this.count(c)?b.op="update":b.op="insert"):b.op=
"insert";switch(b.op){case "insert":b.result=this.insert(a);break;case "update":b.result=this.update(c,a)}return b};h.prototype.update=function(a,b){var c=this,e=this.find(a,{decouple:!1}),d,f=function(d){return c._updateObject(d,b,a)};e.length&&(d=e.filter(f),d.length&&this._onUpdate(d));return d||[]};h.prototype.updateById=function(a,b){var c={};c[this._primaryKey]=a;return this.update(c,b)};h.prototype._updateObject=function(a,b,c,e){e=e||"";"."===e.substr(0,1)&&(e=e.substr(1,e.length-1));var d=
!1,f=!1,g,h,m,k,n;for(k in b)if(b.hasOwnProperty(k)){g=!1;if("$"===k.substr(0,1))switch(k){case "$inc":g=!0;for(n in b[k])if(b[k].hasOwnProperty(n))if("number"===typeof a[n])a[n]+=b[k][n],d=!0;else throw"Cannot increment field that is not a number! ("+n+")!";break;case "$push":g=!0;for(n in b[k])if(b[k].hasOwnProperty(n))if(a[n]instanceof Array)a[n].push(b[k][n]),d=!0;else throw"Cannot push to a key that is not an array! ("+n+")!";break;case "$pull":for(n in g=!0,b[k])if(b[k].hasOwnProperty(n))if(a[n]instanceof
