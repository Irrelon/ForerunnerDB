				...
				if (data.fdb) {
					switch (data.fdb.type) {
						...
						case 'module':
							switch (data.fdb.moduleData.module) {
								default:
									...
									getCall("fdb.db('" + dbNode.fdb.id + "')." + data.fdb.moduleData.module + "s()", function (result, isException) {
										var moduleNodes = [];
						...
						case 'collection':
							...
							getCall("fdb.db('" + dbNode.fdb.id + "')." + moduleNode.fdb.moduleData.module + "('" + data.fdb.id + "').find()", function (result, isException) {
